...
$title 			= __( "I've earned a rank! ", 'bimber' ) . $data['rank_name'];;
...
<div class="g1-mycred-notice-overlay">
				...
				(function () {
					...
					window.fbAsyncInit = function() {
						...
						window.apiShareOnFB_<?php echo esc_html( $item_id ); ?> = function() {
							var shareTitle 		    = '<?php echo esc_html( $data['rank_name'] )?>';
							var shareDescription	= '<?php echo esc_html__( 'I\'ve got a new rank!', 'bimber' );?>';
							var shareImage	        = '<?php echo esc_url( $img_url )?>';
