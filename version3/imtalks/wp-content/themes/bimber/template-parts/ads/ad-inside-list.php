...
set_query_var( 'plugin_required_notice_slot_id', esc_html__( 'Inside list collection', 'bimber' ) );
...
<li class="g1-collection-item">
	...
	<?php if ( bimber_can_use_plugin( 'ad-ace/ad-ace.php' ) ) : ?>
		...
		<?php if (  adace_is_ad_slot( 'bimber_inside_list' ) ) : ?>

			<div class="g1-advertisement g1-advertisement-inside-list">

				<?php echo bimber_sanitize_ad( adace_get_ad_slot( 'bimber_inside_list', $bimber_ad_offset + 1 ) ); ?>
