 ...
 */
function g1_socials_get_snapcode( $username = '', $user_id = '', $useravatar = '' ) {
	...
	?>
	<div class="snapcode">
		<a class="snapcode-avatar-wrapper" href="<?php echo( esc_url( $user_snapcode_url ) ); ?>" target="_blank" rel="nofollow">
			<img class="snapcode-avatar" src="<?php echo( esc_url( $useravatar ) ); ?>" />
			<img class="snapcode-bar" width="<?php echo( esc_html( $snapcode_size ) ); ?>" height="<?php echo( esc_html( $snapcode_size ) ); ?>" src="<?php echo( esc_url( $user_snapcode ) ); ?>" alt="<?php esc_html_e( 'User snapcode.', 'g1_socials' ); ?>">
		</a>
		<h3 class="g1-delta g1-delta-1st snapcode-username"><a href="<?php echo( esc_url( $user_snapcode_url ) ); ?>" target="_blank" rel="nofollow"><?php echo ( esc_html( $username ) ); ?></a></h3>
		<a href="<?php echo( esc_url( $user_snapcode_url ) ); ?>" target="_blank" rel="nofollow" class="snapcode-userid g1-typography-s"><?php echo ( esc_html( $user_id ) ); ?></a>
	</div>
	<?php
