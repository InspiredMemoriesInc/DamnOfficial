...
function hexToRgb(a) { var b = /^#?([a-f\d])([a-f\d])([a-f\d])$/i;
    a = a.replace(b, function(a, b, c, d) { return b + b + c + c + d + d }); var c = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(a); return c ? { r: parseInt(c[1], 16), g: parseInt(c[2], 16), b: parseInt(c[3], 16) } : null }

function clamp(a, b, c) { return Math.min(Math.max(a, b), c) }

function isInArray(a, b) { return b.indexOf(a) > -1 }

function parseBool(a, b) { return b = b || {},
        function(a) { return "false" !== a && ("true" === a || (b.force ? !!a : a)) }(b.ignoreCase && "string" == typeof a ? a.toLowerCase() : a) }

function imgCoverEffect(a, b) { "use strict";

    function c() { if (b.watchResize === !0 && requestAnimationFrame(c), j || (j = k ? a.width / a.height : a.naturalWidth / a.naturalHeight), g = d.clientWidth, h = d.clientHeight, i = g / h, g !== e || h !== f) { if (i >= j ? (a.width = g, a.height = a.width / j) : (a.width = h * j, a.height = h), e = g, f = h, "left" === String(b.alignX).toLowerCase()) a.style.left = 0;
            else if ("center" === String(b.alignX).toLowerCase()) a.style.left = (g - a.width) / 2 + "px";
            else { if ("right" !== String(b.alignX).toLowerCase()) throw new Error('From imgCoverEffect(): Unsupported horizontal align value. Property "alignX" can only be set to one of the following values: "left", "center", or "right".');
                a.style.left = g - a.width + "px" } if ("top" === String(b.alignY).toLowerCase()) a.style.top = 0;
            else if ("center" === String(b.alignY).toLowerCase()) a.style.top = (h - a.height) / 2 + "px";
            else { if ("bottom" !== String(b.alignY).toLowerCase()) throw new Error('From imgCoverEffect(): Unsupported vertical align value. Property "alignY" can only be set to one of the following values: "top", "center", or "bottom".');
                a.style.top = h - a.height + "px" } } } if (b.watchResize = b.watchResize !== !1, b.alignX = b.alignX || "left", b.alignY = b.alignY || "top", "boolean" != typeof b.watchResize) throw new Error('From imgCoverEffect(): "watchResize" property must be set to a Boolean when the option is specified.'); if (!a.parentNode) throw new Error("From imgCoverEffect(): passed HTMLImageElement has no parent DOM element."); var d = a.parentNode,
        e = 0,
        f = 0,
        g = 0,
        h = 0,
        i = 0,
        j = 0,
        k = void 0 === a.naturalWidth;
    d.style.overflow = "hidden", d.style.position = "relative", a.style.position = "absolute", a.style.top = 0, a.style.left = 0, a.style.zIndex = -1, !k && a.naturalWidth && a.naturalHeight || k && a.width && a.height ? c() : a.addEventListener ? a.addEventListener("load", c, !1) : a.attachEvent && a.attachEvent("onload", c) }

function randomInt(a, b) { return Math.floor(Math.random() * (b - a + 1) + a) }

function randomFloat(a, b) { return (Math.random() * (b - a) + a).toFixed(1) }

function isFloat(a) { return a === +a && a !== (0 | a) }

function shuffleArray(a) { for (var b = a.length - 1; 0 < b; b--) { var c = Math.floor(Math.random() * (b + 1)),
            d = a[b];
        a[b] = a[c], a[c] = d } return a }

function centerArray(a) { for (var b = [], c = Math.ceil(a.length / 2), d = c - 1; 0 <= d;) b.push(a[d--]), c < a.length && b.push(a[c++]); return b }
this.createjs = this.createjs || {},
    function() { "use strict"; var a = createjs.PreloadJS = createjs.PreloadJS || {};
        a.version = "NEXT", a.buildDate = "Thu, 10 Mar 2016 17:20:13 GMT" }(), this.createjs = this.createjs || {}, createjs.extend = function(a, b) { "use strict";
        ...
        function c() { this.constructor = a } return c.prototype = b.prototype, a.prototype = new c }, this.createjs = this.createjs || {}, createjs.promote = function(a, b) { "use strict"; var c = a.prototype,
            d = Object.getPrototypeOf && Object.getPrototypeOf(c) || c.__proto__; if (d) { c[(b += "_") + "constructor"] = d.constructor; for (var e in d) c.hasOwnProperty(e) && "function" == typeof d[e] && (c[b + e] = d[e]) } return a }, this.createjs = this.createjs || {},
    function() { "use strict";
        createjs.proxy = function(a, b) { var c = Array.prototype.slice.call(arguments, 2); return function() { return a.apply(b, Array.prototype.slice.call(arguments, 0).concat(c)) } } }(), this.createjs = this.createjs || {}, createjs.indexOf = function(a, b) { "use strict"; for (var c = 0, d = a.length; d > c; c++)
            if (b === a[c]) return c;
    ...
    function() { "use strict";
        ...
        a.initialize = function(a) { a.addEventListener = b.addEventListener, a.on = b.on, a.removeEventListener = a.off = b.removeEventListener, a.removeAllEventListeners = b.removeAllEventListeners, a.hasEventListener = b.hasEventListener, a.dispatchEvent = b.dispatchEvent, a._dispatchEvent = b._dispatchEvent, a.willTrigger = b.willTrigger }, b.addEventListener = function(a, b, c) { var d;
            d = c ? this._captureListeners = this._captureListeners || {} : this._listeners = this._listeners || {}; var e = d[a]; return e && this.removeEventListener(a, b, c), e = d[a], e ? e.push(b) : d[a] = [b], b }, b.on = function(a, b, c, d, e, f) { return b.handleEvent && (c = c || b, b = b.handleEvent), c = c || this, this.addEventListener(a, function(a) { b.call(c, a, e), d && a.remove() }, f) }, b.removeEventListener = function(a, b, c) { var d = c ? this._captureListeners : this._listeners; if (d) { var e = d[a]; if (e)
                ...
                b = b.parent } return !1 }, b.toString = function() { return "[EventDispatcher]" }, b._dispatchEvent = function(a, b) { var c, d = 1 == b ? this._captureListeners : this._listeners; if (a && d) { var e = d[a.type]; if (!e || !(c = e.length)) return; try { a.currentTarget = this } catch (a) {} try { a.eventPhase = b } catch (a) {}
                a.removed = !1, e = e.slice(); for (var f = 0; c > f && !a.immediatePropagationStopped; f++) { var g = e[f];
                    g.handleEvent ? g.handleEvent(a) : g(a), a.removed && (this.off(a.type, g, 1 == b), a.removed = !1) } } }, createjs.EventDispatcher = a }(), this.createjs = this.createjs || {},
    function() { "use strict";

        function a(a, b) { this.Event_constructor("progress"), this.loaded = a, this.total = null == b ? 1 : b, this.progress = 0 == b ? 0 : this.loaded / this.total } var b = createjs.extend(a, createjs.Event);
        b.clone = function() { return new createjs.ProgressEvent(this.loaded, this.total) }, createjs.ProgressEvent = createjs.promote(a, "Event") }(window),
    function() {
        function a(b, d) {
            function f(a) { if (f[a] !== q) return f[a]; var b; if ("bug-string-char-index" == a) b = "a" != "a" [0];
                            ...
                            (c = function() { return 1 }).toJSON = c; try { k = "0" === i(0) && "0" === i(new g) && '""' == i(new h) && i(s) === q && i(q) === q && i() === q && "1" === i(c) && "[1]" == i([c]) && "[null]" == i([q]) && "null" == i(null) && "[null,null,null]" == i([q, s, null]) && i({ a: [c, !0, !1, null, "\0\b\n\f\r\t"] }) == e && "1" === i(null, c) && "[\n 1,\n 2\n]" == i([1, 2], null, 1) && '"-271821-04-20T00:00:00.000Z"' == i(new j(-864e13)) && '"+275760-09-13T00:00:00.000Z"' == i(new j(864e13)) && '"-000001-01-01T00:00:00.000Z"' == i(new j(-621987552e5)) && '"1969-12-31T23:59:59.999Z"' == i(new j(-1)) } catch (a) { k = !1 } }
                        b = k } if ("json-parse" == a) { var l = d.parse; if ("function" == typeof l) try { if (0 === l("0") && !l(!1)) { c = l(e); var m = 5 == c.a.length && 1 === c.a[0]; if (m) { try { m = !l('"\t"') } catch (a) {} if (m) try { m = 1 !== l("01") } catch (a) {}
                                    if (m) try { m = 1 !== l("1.") } catch (a) {} } } } catch (a) { m = !1 }
                        b = m } } return f[a] = !!b }
            b || (b = e.Object()), d || (d = e.Object()); var g = b.Number || e.Number,
                ...
                m = b.Math || e.Math,
                n = b.JSON || e.JSON; "object" == typeof n && n && (d.stringify = n.stringify, d.parse = n.parse); var o, p, q, r = i.prototype,
                s = r.toString,
                t = new j(-0xc782b5b800cec); try { t = -109252 == t.getUTCFullYear() && 0 === t.getUTCMonth() && 1 === t.getUTCDate() && 10 == t.getUTCHours() && 37 == t.getUTCMinutes() && 6 == t.getUTCSeconds() && 708 == t.getUTCMilliseconds() } catch (a) {} if (!f("json")) { var u = "[object Function]",
                    v = "[object Date]",
                    w = "[object Number]",
                    x = "[object String]",
                    y = "[object Array]",
                    z = "[object Boolean]",
                    A = f("bug-string-char-index"); if (!t) var B = m.floor,
                    C = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334],
                    D = function(a, b) { return C[b] + 365 * (a - 1970) + B((a - 1969 + (b = +(b > 1))) / 4) - B((a - 1901 + b) / 100) + B((a - 1601 + b) / 400) }; if ((o = r.hasOwnProperty) || (o = function(a) { var b, c = {}; return (c.__proto__ = null, c.__proto__ = { toString: 1 }, c).toString != s ? o = function(a) { var b = this.__proto__,
                        ...
                        (d = function() { this.valueOf = 0 }).prototype.valueOf = 0, e = new d; for (f in e) o.call(e, f) && g++; return d = e = null, g ? p = 2 == g ? function(a, b) { var c, d = {},
                                e = s.call(a) == u; for (c in a) e && "prototype" == c || o.call(d, c) || !(d[c] = 1) || !o.call(a, c) || b(c) } : function(a, b) { var c, d, e = s.call(a) == u; for (c in a) e && "prototype" == c || !o.call(a, c) || (d = "constructor" === c) || b(c);
                            (d || o.call(a, c = "constructor")) && b(c) } : (e = ["valueOf", "toString", "toLocaleString", "propertyIsEnumerable", "isPrototypeOf", "hasOwnProperty", "constructor"], p = function(a, b) { var d, f, g = s.call(a) == u,
                                h = !g && "function" != typeof a.constructor && c[typeof a.hasOwnProperty] && a.hasOwnProperty || o; for (d in a) g && "prototype" == d || !h.call(a, d) || b(d); for (f = e.length; d = e[--f]; h.call(a, d) && b(d)); }), p(a, b) }, !f("json-stringify")) { var E = { 92: "\\\\", 34: '\\"', 8: "\\b", 12: "\\f", 10: "\\n", 13: "\\r", 9: "\\t" },
                        F = "000000",
                        G = function(a, b) { return (F + (b || 0)).slice(-a) },
                        H = "\\u00",
                        I = function(a) { for (var b = '"', c = 0, d = a.length, e = !A || d > 10, f = e && (A ? a.split("") : a); d > c; c++) { var g = a.charCodeAt(c); switch (g) {
                                    case 8:
                                    case 9:
                                    case 10:
                                    case 12:
                                    ...
                                    case 92:
                                        b += E[g]; break;
                                    default:
                                        if (32 > g) { b += H + G(2, g.toString(16)); break }
                                        b += e ? f[c] : a.charAt(c) } } return b + '"' },
                        J = function(a, b, c, d, e, f, g) { var h, i, j, k, m, n, r, t, u, A, C, E, F, H, K, L; try { h = b[a] } catch (a) {} if ("object" == typeof h && h)
                                if (i = s.call(h), i != v || o.call(h, "toJSON")) "function" == typeof h.toJSON && (i != w && i != x && i != y || o.call(h, "toJSON")) && (h = h.toJSON(a));
                                else if (h > -1 / 0 && 1 / 0 > h) { if (D) { for (m = B(h / 864e5), j = B(m / 365.2425) + 1970 - 1; D(j + 1, 0) <= m; j++); for (k = B((m - D(j, 0)) / 30.42); D(j, k + 1) <= m; k++);
                                    m = 1 + m - D(j, k), n = (h % 864e5 + 864e5) % 864e5, r = B(n / 36e5) % 24, t = B(n / 6e4) % 60, u = B(n / 1e3) % 60, A = n % 1e3 } else j = h.getUTCFullYear(), k = h.getUTCMonth(), m = h.getUTCDate(), r = h.getUTCHours(), t = h.getUTCMinutes(), u = h.getUTCSeconds(), A = h.getUTCMilliseconds();
                                h = (0 >= j || j >= 1e4 ? (0 > j ? "-" : "+") + G(6, 0 > j ? -j : j) : G(4, j)) + "-" + G(2, k + 1) + "-" + G(2, m) + "T" + G(2, r) + ":" + G(2, t) + ":" + G(2, u) + "." + G(3, A) + "Z" } else h = null; if (c && (h = c.call(b, a, h)), null === h) return "null"; if (i = s.call(h), i == z) return "" + h; if (i == w) return h > -1 / 0 && 1 / 0 > h ? "" + h : "null"; if (i == x) return I("" + h); if ("object" == typeof h) { for (H = g.length; H--;)
                                    if (g[H] === h) throw l();
                                if (g.push(h), C = [], K = f, f += e, i == y) { for (F = 0, H = h.length; H > F; F++) E = J(F, h, c, d, e, f, g), C.push(E === q ? "null" : E);
                                    L = C.length ? e ? "[\n" + f + C.join(",\n" + f) + "\n" + K + "]" : "[" + C.join(",") + "]" : "[]" } else p(d || h, function(a) { var b = J(a, h, c, d, e, f, g);
                                    b !== q && C.push(I(a) + ":" + (e ? " " : "") + b) }), L = C.length ? e ? "{\n" + f + C.join(",\n" + f) + "\n" + K + "}" : "{" + C.join(",") + "}" : "{}"; return g.pop(), L } };
                    d.stringify = function(a, b, d) { var e, f, g, h; if (c[typeof b] && b)
                            if ((h = s.call(b)) == u) f = b;
                            else if (h == y) { g = {}; for (var i, j = 0, k = b.length; k > j; i = b[j++], h = s.call(i), (h == x || h == w) && (g[i] = 1)); } if (d)
                            if ((h = s.call(d)) == w) { if ((d -= d % 1) > 0)
                                    for (e = "", d > 10 && (d = 10); e.length < d; e += " "); } else h == x && (e = d.length <= 10 ? d : d.slice(0, 10));
                        return J("", (i = {}, i[""] = a, i), f, g, e, "", []) } } if (!f("json-parse")) { var K, L, M = h.fromCharCode,
                        N = { 92: "\\", 34: '"', 47: "/", 98: "\b", 116: "\t", 110: "\n", 102: "\f", 114: "\r" },
                        O = function() { throw K = L = null, k() },
                        P = function() { for (var a, b, c, d, e, f = L, g = f.length; g > K;) switch (e = f.charCodeAt(K)) {
                                case 9:
                                case 10:
                                case 13:
                                case 32:
                                ...
                                case 34:
                                    for (a = "@", K++; g > K;)
                                        ...
                                        case 117:
                                            ...
                                            a += M("0x" + f.slice(b, K)); break;
                                        default:
                                            O() } else { if (34 == e) break; for (e = f.charCodeAt(K), b = K; e >= 32 && 92 != e && 34 != e;) e = f.charCodeAt(++K);
                                        a += f.slice(b, K) }
                                    if (34 == f.charCodeAt(K)) return K++, a;
                                    O();
                                default:
                                    if (b = K, 45 == e && (d = !0, e = f.charCodeAt(++K)), e >= 48 && 57 >= e) { for (48 == e && (e = f.charCodeAt(K + 1), e >= 48 && 57 >= e) && O(), d = !1; g > K && (e = f.charCodeAt(K), e >= 48 && 57 >= e); K++); if (46 == f.charCodeAt(K)) { for (c = ++K; g > c && (e = f.charCodeAt(c), e >= 48 && 57 >= e); c++);
                                            c == K && O(), K = c } if (e = f.charCodeAt(K), 101 == e || 69 == e) { for (e = f.charCodeAt(++K), (43 == e || 45 == e) && K++, c = K; g > c && (e = f.charCodeAt(c), e >= 48 && 57 >= e); c++);
                                            c == K && O(), K = c } return +f.slice(b, K) } if (d && O(), "true" == f.slice(K, K + 4)) return K += 4, !0; if ("false" == f.slice(K, K + 5)) return K += 5, !1; if ("null" == f.slice(K, K + 4)) return K += 4, null;
                                    O() }
                            return "$" },
                        Q = function(a) { var b, c; if ("$" == a && O(), "string" == typeof a) { if ("@" == (A ? a.charAt(0) : a[0])) return a.slice(1); if ("[" == a) { for (b = []; a = P(), "]" != a; c || (c = !0)) c && ("," == a ? (a = P(), "]" == a && O()) : O()), "," == a && O(), b.push(Q(a)); return b } if ("{" == a) { for (b = {}; a = P(), "}" != a; c || (c = !0)) c && ("," == a ? (a = P(), "}" == a && O()) : O()), ("," == a || "string" != typeof a || "@" != (A ? a.charAt(0) : a[0]) || ":" != P()) && O(), b[a.slice(1)] = Q(P()); return b }
                                O() } return a },
                        R = function(a, b, c) { var d = S(a, b, c);
                            d === q ? delete a[b] : a[b] = d },
                        S = function(a, b, c) { var d, e = a[b]; if ("object" == typeof e && e)
                                if (s.call(e) == y)
                                    for (d = e.length; d--;) R(e, d, c);
                                else p(e, function(a) { R(e, a, c) });
                            return c.call(a, b, e) };
                    d.parse = function(a, b) { var c, d; return K = 0, L = "" + a, c = Q(P()), "$" != P() && O(), K = L = null, b && s.call(b) == u ? S((d = {}, d[""] = c, d), "", b) : c } } } return d.runInContext = a, d } var b = "function" == typeof define && define.amd,
            c = { function: !0, object: !0 },
            d = c[typeof exports] && exports && !exports.nodeType && exports,
            e = c[typeof window] && window || this,
            f = d && c[typeof module] && module && !module.nodeType && "object" == typeof global && global; if (!f || f.global !== f && f.window !== f && f.self !== f || (e = f), d && !b) a(e, d);
        else { var g = e.JSON,
                h = e.JSON3,
                i = !1,
                j = a(e, e.JSON3 = { noConflict: function() { return i || (i = !0, e.JSON = g, e.JSON3 = h, g = h = null), j } });
            e.JSON = { parse: j.parse, stringify: j.stringify } }
        b && define(function() { return j }) }.call(this),
    function() { var a = {};
    ...
    function() { var a = {};
        a.ABSOLUTE_PATT = /^(?:\w+:)?\/{2}/i, a.RELATIVE_PATT = /^[.\/]*?\//i, a.EXTENSION_PATT = /\/?[^\/]+\.(\w{1,5})$/i, a.parseURI = function(b) { var c = { absolute: !1, relative: !1, protocol: null, hostname: null, port: null, pathname: null, search: null, hash: null, host: null }; if (null == b) return c; var d = createjs.Elements.a();
            d.href = b; for (var e in c) e in d && (c[e] = d[e]); var f = b.indexOf("?");
            f > -1 && (b = b.substr(0, f)); var g; return a.ABSOLUTE_PATT.test(b) ? c.absolute = !0 : a.RELATIVE_PATT.test(b) && (c.relative = !0), (g = b.match(a.EXTENSION_PATT)) && (c.extension = g[1].toLowerCase()), c }, a.formatQueryString = function(a, b) { if (null == a) throw new Error("You must specify data."); var c = []; for (var d in a) c.push(d + "=" + escape(a[d])); return b && (c = c.concat(b)), c.join("&") }, a.buildURI = function(a, b) { if (null == b) return a; var c = [],
                d = a.indexOf("?"); if (-1 != d) { var e = a.slice(d + 1);
                c = c.concat(e.split("&")) } return -1 != d ? a.slice(0, d) + "?" + this.formatQueryString(b, c) : a + "?" + this.formatQueryString(b, c) }, a.isCrossDomain = function(a) { var b = createjs.Elements.a();
            b.href = a.src; var c = createjs.Elements.a();
            c.href = location.href; var d = "" != b.hostname && (b.port != c.port || b.protocol != c.protocol || b.hostname != c.hostname); return d }, a.isLocal = function(a) { var b = createjs.Elements.a(); return b.href = a.src, "" == b.hostname && "file:" == b.protocol }, createjs.URLUtils = a }(),
    function() { var a = {};
        a.appendToHead = function(b) { a.getHead().appendChild(b) }, a.appendToBody = function(b) { a.getBody().appendChild(b) }, a.getHead = function() { return document.head || document.getElementsByTagName("head")[0] }, a.getBody = function() { return document.body || document.getElementsByTagName("body")[0] }, a.removeChild = function(a) { a.parent && a.parent.removeChild(a) }, a.isImageTag = function(a) { return a instanceof HTMLImageElement }, a.isAudioTag = function(a) { return !!window.HTMLAudioElement && a instanceof HTMLAudioElement }, a.isVideoTag = function(a) { return !!window.HTMLVideoElement && a instanceof HTMLVideoElement }, createjs.DomUtils = a }(),
    function() { var a = {};
        a.parseXML = function(a) { var b = null; try { if (window.DOMParser) { var c = new DOMParser;
                    b = c.parseFromString(a, "text/xml") } } catch (a) {} if (!b) try { b = new ActiveXObject("Microsoft.XMLDOM"), b.async = !1, b.loadXML(a) } catch (a) { b = null }
            return b }, a.parseJSON = function(a) { if (null == a) return null; try { return JSON.parse(a) } catch (a) { throw a } }, createjs.DataUtils = a }(), this.createjs = this.createjs || {},
    function() { "use strict";
    ...
    function() { var a = {};
        a.isBinary = function(a) { switch (a) {
                case createjs.AbstractLoader.IMAGE:
                case createjs.AbstractLoader.BINARY:
                    return !0;
                default:
                    return !1 } }, a.isText = function(a) { switch (a) {
    ...
    function() { "use strict";
        ...
        c.POST = "POST", c.GET = "GET", c.BINARY = "binary", c.CSS = "css", c.IMAGE = "image", c.JAVASCRIPT = "javascript", c.JSON = "json", c.JSONP = "jsonp", c.MANIFEST = "manifest", c.SOUND = "sound", c.VIDEO = "video", c.SPRITESHEET = "spritesheet", c.SVG = "svg", c.TEXT = "text", c.XML = "xml", b.getItem = function() { return this._item }, b.getResult = function(a) { return a ? this._rawResult : this._result }, b.getTag = function() { return this._tag }, b.setTag = function(a) { this._tag = a }, b.load = function() { this._createRequest(), this._request.on("complete", this, this), this._request.on("progress", this, this), this._request.on("loadStart", this, this), this._request.on("abort", this, this), this._request.on("timeout", this, this), this._request.on("error", this, this); var a = new createjs.Event("initialize");
            a.loader = this._request, this.dispatchEvent(a), this._request.load() }, b.cancel = function() { this.canceled = !0, this.destroy() }, b.destroy = function() { this._request && (this._request.removeAllEventListeners(), this._request.destroy()), this._request = null, this._item = null, this._rawResult = null, this._result = null, this._loadItems = null, this.removeAllEventListeners() }, b.getLoadedItems = function() { return this._loadedItems }, b._createRequest = function() { this._request = this._preferXHR ? new createjs.XHRRequest(this._item) : new createjs.TagRequest(this._item, this._tag || this._createTag(), this._tagSrcAttribute) }, b._createTag = function() { return null }, b._sendLoadStart = function() { this._isCanceled() || this.dispatchEvent("loadstart") }, b._sendProgress = function(a) { if (!this._isCanceled()) { var b = null; "number" == typeof a ? (this.progress = a, b = new createjs.ProgressEvent(this.progress)) : (b = a, this.progress = a.loaded / a.total, b.progress = this.progress, (isNaN(this.progress) || 1 / 0 == this.progress) && (this.progress = 0)), this.hasEventListener("progress") && this.dispatchEvent(b) } }, b._sendComplete = function() { if (!this._isCanceled()) { this.loaded = !0; var a = new createjs.Event("complete");
                a.rawResult = this._rawResult, null != this._result && (a.result = this._result), this.dispatchEvent(a) } }, b._sendError = function(a) {!this._isCanceled() && this.hasEventListener("error") && (null == a && (a = new createjs.ErrorEvent("PRELOAD_ERROR_EMPTY")), this.dispatchEvent(a)) }, b._isCanceled = function() { return !(null != window.createjs && !this.canceled) }, b.resultFormatter = null, b.handleEvent = function(a) { switch (a.type) {
                case "complete":
    ...
    function() {
        ...
        a.ACTIVEX_VERSIONS = ["Msxml2.XMLHTTP.6.0", "Msxml2.XMLHTTP.5.0", "Msxml2.XMLHTTP.4.0", "MSXML2.XMLHTTP.3.0", "MSXML2.XMLHTTP", "Microsoft.XMLHTTP"], b.getResult = function(a) { return a && this._rawResponse ? this._rawResponse : this._response }, b.cancel = function() { this.canceled = !0, this._clean(), this._request.abort() }, b.load = function() { if (null == this._request) return void this._handleError();
            null != this._request.addEventListener ? (this._request.addEventListener("loadstart", this._handleLoadStartProxy, !1), this._request.addEventListener("progress", this._handleProgressProxy, !1), this._request.addEventListener("abort", this._handleAbortProxy, !1), this._request.addEventListener("error", this._handleErrorProxy, !1), this._request.addEventListener("timeout", this._handleTimeoutProxy, !1), this._request.addEventListener("load", this._handleLoadProxy, !1), this._request.addEventListener("readystatechange", this._handleReadyStateChangeProxy, !1)) : (this._request.onloadstart = this._handleLoadStartProxy, this._request.onprogress = this._handleProgressProxy, this._request.onabort = this._handleAbortProxy, this._request.onerror = this._handleErrorProxy, this._request.ontimeout = this._handleTimeoutProxy, this._request.onload = this._handleLoadProxy, this._request.onreadystatechange = this._handleReadyStateChangeProxy), 1 == this._xhrLevel && (this._loadTimeout = setTimeout(createjs.proxy(this._handleTimeout, this), this._item.loadTimeout)); try { this._item.values ? this._request.send(createjs.URLUtils.formatQueryString(this._item.values)) : this._request.send() } catch (a) { this.dispatchEvent(new createjs.ErrorEvent("XHR_SEND", null, a)) } }, b.setResponseType = function(a) { "blob" === a && (a = window.URL ? "blob" : "arraybuffer", this._responseType = a), this._request.responseType = a }, b.getAllResponseHeaders = function() { return this._request.getAllResponseHeaders instanceof Function ? this._request.getAllResponseHeaders() : null }, b.getResponseHeader = function(a) { return this._request.getResponseHeader instanceof Function ? this._request.getResponseHeader(a) : null }, b._handleProgress = function(a) { if (a && !(a.loaded > 0 && 0 == a.total)) { var b = new createjs.ProgressEvent(a.loaded, a.total);
                this.dispatchEvent(b) } }, b._handleLoadStart = function() { clearTimeout(this._loadTimeout), this.dispatchEvent("loadstart") }, b._handleAbort = function(a) { this._clean(), this.dispatchEvent(new createjs.ErrorEvent("XHR_ABORTED", null, a)) }, b._handleError = function(a) { this._clean(), this.dispatchEvent(new createjs.ErrorEvent(a.message)) }, b._handleReadyStateChange = function() { 4 == this._request.readyState && this._handleLoad() }, b._handleLoad = function() {
            if (!this.loaded) {
                this.loaded = !0;
                var a = this._checkError();
                if (a) return void this._handleError(a);
                if (this._response = this._getResponse(), "arraybuffer" === this._responseType) try { this._response = new Blob([this._response]) } catch (a) { if (window.BlobBuilder = window.BlobBuilder || window.WebKitBlobBuilder || window.MozBlobBuilder || window.MSBlobBuilder, "TypeError" === a.name && window.BlobBuilder) { var b = new BlobBuilder;
                        b.append(this._response), this._response = b.getBlob() } }
                this._clean(), this.dispatchEvent(new createjs.Event("complete"))
            }
        }, b._handleTimeout = function(a) { this._clean(), this.dispatchEvent(new createjs.ErrorEvent("PRELOAD_TIMEOUT", null, a)) }, b._checkError = function() { var a = parseInt(this._request.status); return a >= 400 && 599 >= a ? new Error(a) : null }, b._getResponse = function() { if (null != this._response) return this._response; if (null != this._request.response) return this._request.response; try { if (null != this._request.responseText) return this._request.responseText } catch (a) {} try { if (null != this._request.responseXML) return this._request.responseXML } catch (a) {} return null }, b._createXHR = function(a) { var b = createjs.URLUtils.isCrossDomain(a),
                c = {},
            ...
            else { for (var e = 0, f = s.ACTIVEX_VERSIONS.length; f > e; e++) { var g = s.ACTIVEX_VERSIONS[e]; try { d = new ActiveXObject(g); break } catch (a) {} } if (null == d) return !1 }
            null == a.mimeType && createjs.RequestUtils.isText(a.type) && (a.mimeType = "text/plain; charset=utf-8"), a.mimeType && d.overrideMimeType && d.overrideMimeType(a.mimeType), this._xhrLevel = "string" == typeof d.responseType ? 2 : 1; var h = null; if (h = a.method == createjs.AbstractLoader.GET ? createjs.URLUtils.buildURI(a.src, a.values) : a.src, d.open(a.method || createjs.AbstractLoader.GET, h, !0), b && d instanceof XMLHttpRequest && 1 == this._xhrLevel && (c.Origin = location.origin), a.values && a.method == createjs.AbstractLoader.POST && (c["Content-Type"] = "application/x-www-form-urlencoded"), b || c["X-Requested-With"] || (c["X-Requested-With"] = "XMLHttpRequest"), a.headers)
    ...
    function() { "use strict";
        ...
        b.init = function(a, b, c) { this.useXHR = !0, this.preferXHR = !0, this._preferXHR = !0, this.setPreferXHR(a), this._paused = !1, this._basePath = b, this._crossOrigin = c, this._loadStartWasDispatched = !1, this._currentlyLoadingScript = null, this._currentLoads = [], this._loadQueue = [], this._loadQueueBackup = [], this._loadItemsById = {}, this._loadItemsBySrc = {}, this._loadedResults = {}, this._loadedRawResults = {}, this._numItems = 0, this._numItemsLoaded = 0, this._scriptOrder = [], this._loadedScripts = [], this._lastProgress = NaN }, c.loadTimeout = 8e3, c.LOAD_TIMEOUT = 0, c.BINARY = createjs.AbstractLoader.BINARY, c.CSS = createjs.AbstractLoader.CSS, c.IMAGE = createjs.AbstractLoader.IMAGE, c.JAVASCRIPT = createjs.AbstractLoader.JAVASCRIPT, c.JSON = createjs.AbstractLoader.JSON, c.JSONP = createjs.AbstractLoader.JSONP, c.MANIFEST = createjs.AbstractLoader.MANIFEST, c.SOUND = createjs.AbstractLoader.SOUND, c.VIDEO = createjs.AbstractLoader.VIDEO, c.SVG = createjs.AbstractLoader.SVG, c.TEXT = createjs.AbstractLoader.TEXT, c.XML = createjs.AbstractLoader.XML, c.POST = createjs.AbstractLoader.POST, c.GET = createjs.AbstractLoader.GET, b.registerLoader = function(a) { if (!a || !a.canLoadItem) throw new Error("loader is of an incorrect type."); if (-1 != this._availableLoaders.indexOf(a)) throw new Error("loader already exists.");
            ...
            this._addItem(a, null, c), this.setPaused(b === !1) }, b.loadManifest = function(a, b, d) { var e = null,
            ...
            this._scriptOrder.length = 0, this._loadedScripts.length = 0, this.loadStartWasDispatched = !1, this._itemCount = 0, this._lastProgress = NaN }, b._addItem = function(a, b, c) { var d = this._createLoadItem(a, b, c); if (null != d) { var e = this._createLoader(d);
                ...
                f = c || this._basePath; if (d.src instanceof Object) { if (!d.type) return null; if (b) { e = b; var g = createjs.URLUtils.parseURI(b);
                    null == f || g.absolute || g.relative || (e = f + e) } else null != f && (e = f) } else { var h = createjs.URLUtils.parseURI(d.src);
                h.extension && (d.ext = h.extension), null == d.type && (d.type = createjs.RequestUtils.getTypeByExtension(d.ext)); var i = d.src; if (!h.absolute && !h.relative)
                    if (b) { e = b; var g = createjs.URLUtils.parseURI(b);
            ...
            this._lastProgress != a && (this._sendProgress(a), this._lastProgress = a) }, b._disposeItem = function(a) { delete this._loadedResults[a.id], delete this._loadedRawResults[a.id], delete this._loadItemsById[a.id], delete this._loadItemsBySrc[a.src] }, b._sendFileProgress = function(a, b) { if (!this._isCanceled() && !this._paused && this.hasEventListener("fileprogress")) { var c = new createjs.Event("fileprogress");
                c.progress = b, c.loaded = b, c.total = 1, c.item = a, this.dispatchEvent(c) } }, b._sendFileComplete = function(a, b) { if (!this._isCanceled() && !this._paused) { var c = new createjs.Event("fileload");
                c.loader = b, c.item = a, c.result = this._loadedResults[a.id], c.rawResult = this._loadedRawResults[a.id], a.completeHandler && a.completeHandler(c), this.hasEventListener("fileload") && this.dispatchEvent(c) } }, b._sendFileStart = function(a) { var b = new createjs.Event("filestart");
            b.item = a, this.hasEventListener("filestart") && this.dispatchEvent(b) }, b.toString = function() { return "[PreloadJS LoadQueue]" }, createjs.LoadQueue = createjs.promote(a, "AbstractLoader") }(), this.createjs = this.createjs || {},
    function() { "use strict";
    ...
    function() { "use strict";
        ...
        c.canLoadItem = function(a) { return a.type == createjs.AbstractLoader.CSS }, b._formatResult = function(a) { if (this._preferXHR) { var b = a.getTag(); if (b.styleSheet) b.styleSheet.cssText = a.getResult(!0);
                else { var c = createjs.Elements.text(a.getResult(!0));
    ...
    function() { "use strict";
        ...
        c.canLoadItem = function(a) { return a.type == createjs.AbstractLoader.IMAGE }, b.load = function() { if ("" != this._tag.src && this._tag.complete) return void this._sendComplete(); var a = this._item.crossOrigin;
            1 == a && (a = "Anonymous"), null == a || createjs.URLUtils.isLocal(this._item.src) || (this._tag.crossOrigin = a), this.AbstractLoader_load() }, b._updateXHR = function(a) { a.loader.mimeType = "text/plain; charset=x-user-defined-binary", a.loader.setResponseType && a.loader.setResponseType("blob") }, b._formatResult = function() { return this._formatImage }, b._formatImage = function(a, b) { var c = this._tag,
            ...
            c.complete ? a(c) : (c.onload = createjs.proxy(function() { a(this._tag) }, this), c.onerror = createjs.proxy(function() { b(this._tag) }, this)) }, b._cleanUpURL = function(a) { var b = window.URL || window.webkitURL;
            b.revokeObjectURL(a.target.src) }, createjs.ImageLoader = createjs.promote(a, "AbstractLoader") }(), this.createjs = this.createjs || {},
    function() { "use strict";

        function a(a, b) { this.AbstractLoader_constructor(a, b, createjs.AbstractLoader.JAVASCRIPT), this.resultFormatter = this._formatResult, this._tagSrcAttribute = "src", this.setTag(createjs.Elements.script()) } var b = createjs.extend(a, createjs.AbstractLoader),
            c = a;
    ...
    function() { "use strict";
        ...
        function a(a) { this.AbstractLoader_constructor(a, !0, createjs.AbstractLoader.JSON), this.resultFormatter = this._formatResult } var b = createjs.extend(a, createjs.AbstractLoader),
            c = a;
        c.canLoadItem = function(a) { return a.type == createjs.AbstractLoader.JSON }, b._formatResult = function(a) { var b = null; try { b = createjs.DataUtils.parseJSON(a.getResult(!0)) } catch (a) { var c = new createjs.ErrorEvent("JSON_FORMAT", null, a); return this._sendError(c), a } return b }, createjs.JSONLoader = createjs.promote(a, "AbstractLoader") }(), this.createjs = this.createjs || {},
    function() { "use strict";

        function a(a) { this.AbstractLoader_constructor(a, !1, createjs.AbstractLoader.JSONP), this.setTag(createjs.Elements.script()), this.getTag().type = "text/javascript" } var b = createjs.extend(a, createjs.AbstractLoader),
            c = a;
        c.canLoadItem = function(a) { return a.type == createjs.AbstractLoader.JSONP }, b.cancel = function() { this.AbstractLoader_cancel(), this._dispose() }, b.load = function() { if (null == this._item.callback) throw new Error("callback is required for loading JSONP requests."); if (null != window[this._item.callback]) throw new Error("JSONP callback '" + this._item.callback + "' already exists on window. You need to specify a different callback or re-name the current one.");
            window[this._item.callback] = createjs.proxy(this._handleLoad, this), createjs.DomUtils.appendToBody(this._tag), this._loadTimeout = setTimeout(createjs.proxy(this._handleTimeout, this), this._item.loadTimeout), this._tag.src = this._item.src }, b._handleLoad = function(a) { this._result = this._rawResult = a, this._sendComplete(), this._dispose() }, b._handleTimeout = function() { this._dispose(), this.dispatchEvent(new createjs.ErrorEvent("timeout")) }, b._dispose = function() { createjs.DomUtils.removeChild(this._tag), delete window[this._item.callback], clearTimeout(this._loadTimeout) }, createjs.JSONPLoader = createjs.promote(a, "AbstractLoader") }(), this.createjs = this.createjs || {},
    function() { "use strict";
        ...
        c.MANIFEST_PROGRESS = .25, c.canLoadItem = function(a) { return a.type == createjs.AbstractLoader.MANIFEST }, b.load = function() { this.AbstractLoader_load() }, b._createRequest = function() { var a = this._item.callback;
            this._request = null != a ? new createjs.JSONPLoader(this._item) : new createjs.JSONLoader(this._item) }, b.handleEvent = function(a) { switch (a.type) {
                case "complete":
            ...
            this.AbstractLoader_handleEvent(a) }, b.destroy = function() { this.AbstractLoader_destroy(), this._manifestQueue.close() }, b._loadManifest = function(a) { if (a && a.manifest) { var b = this._manifestQueue = new createjs.LoadQueue;
                ...
                b.loadManifest(a) } else this._sendComplete() }, b._handleManifestFileLoad = function(a) { a.target = null, this.dispatchEvent(a) }, b._handleManifestComplete = function() { this._loadedItems = this._manifestQueue.getItems(!0), this._sendComplete() }, b._handleManifestProgress = function(a) { this.progress = a.progress * (1 - c.MANIFEST_PROGRESS) + c.MANIFEST_PROGRESS, this._sendProgress(this.progress) }, b._handleManifestError = function(a) { var b = new createjs.Event("fileerror");
            b.item = a.data, this.dispatchEvent(b) }, createjs.ManifestLoader = createjs.promote(a, "AbstractLoader") }(), this.createjs = this.createjs || {},
    function() { "use strict";

        function a(a, b) { this.AbstractMediaLoader_constructor(a, b, createjs.AbstractLoader.SOUND), createjs.DomUtils.isAudioTag(a) ? this._tag = a : createjs.DomUtils.isAudioTag(a.src) ? this._tag = a : createjs.DomUtils.isAudioTag(a.tag) && (this._tag = createjs.DomUtils.isAudioTag(a) ? a : a.src), null != this._tag && (this._preferXHR = !1) } var b = createjs.extend(a, createjs.AbstractMediaLoader),
            c = a;
        c.canLoadItem = function(a) { return a.type == createjs.AbstractLoader.SOUND }, b._createTag = function(a) { var b = createjs.Elements.audio(); return b.autoplay = !1, b.preload = "none", b.src = a, b }, createjs.SoundLoader = createjs.promote(a, "AbstractMediaLoader") }(), this.createjs = this.createjs || {},
    function() { "use strict";

        function a(a, b) { this.AbstractMediaLoader_constructor(a, b, createjs.AbstractLoader.VIDEO), createjs.DomUtils.isVideoTag(a) || createjs.DomUtils.isVideoTag(a.src) ? (this.setTag(createjs.DomUtils.isVideoTag(a) ? a : a.src), this._preferXHR = !1) : this.setTag(this._createTag()) } var b = createjs.extend(a, createjs.AbstractMediaLoader),
            c = a;
        b._createTag = function() { return createjs.Elements.video() }, c.canLoadItem = function(a) { return a.type == createjs.AbstractLoader.VIDEO }, createjs.VideoLoader = createjs.promote(a, "AbstractMediaLoader") }(), this.createjs = this.createjs || {},
    function() { "use strict";
        ...
        c.SPRITESHEET_PROGRESS = .25, c.canLoadItem = function(a) { return a.type == createjs.AbstractLoader.SPRITESHEET }, b.destroy = function() { this.AbstractLoader_destroy(), this._manifestQueue.close() }, b._createRequest = function() { var a = this._item.callback;
            ...
            this.AbstractLoader_handleEvent(a) }, b._loadManifest = function(a) { if (a && a.images) { var b = this._manifestQueue = new createjs.LoadQueue(this._preferXHR, this._item.path, this._item.crossOrigin);
                ...
                c[d] = b } }, b._handleManifestComplete = function() { this._result = new createjs.SpriteSheet(this._result), this._loadedItems = this._manifestQueue.getItems(!0), this._sendComplete() }, b._handleManifestProgress = function(a) { this.progress = a.progress * (1 - c.SPRITESHEET_PROGRESS) + c.SPRITESHEET_PROGRESS, this._sendProgress(this.progress) }, b._handleManifestError = function(a) { var b = new createjs.Event("fileerror");
    ...
    function() { "use strict";
        ...
        function a(a, b) { this.AbstractLoader_constructor(a, b, createjs.AbstractLoader.SVG), this.resultFormatter = this._formatResult, this._tagSrcAttribute = "data", b ? this.setTag(createjs.Elements.svg()) : (this.setTag(createjs.Elements.object()), this.getTag().type = "image/svg+xml") } var b = createjs.extend(a, createjs.AbstractLoader),
            c = a;
        c.canLoadItem = function(a) { return a.type == createjs.AbstractLoader.SVG }, b._formatResult = function(a) { var b = createjs.DataUtils.parseXML(a.getResult(!0)),
    ...
    function() { "use strict";
        ...
        function a(a) { this.AbstractLoader_constructor(a, !0, createjs.AbstractLoader.XML), this.resultFormatter = this._formatResult } var b = createjs.extend(a, createjs.AbstractLoader),
            c = a;
        c.canLoadItem = function(a) { return a.type == createjs.AbstractLoader.XML }, b._formatResult = function(a) { return createjs.DataUtils.parseXML(a.getResult(!0)) }, createjs.XMLLoader = createjs.promote(a, "AbstractLoader") }(), this.createjs = this.createjs || {},
    function() { var a = createjs.SoundJS = createjs.SoundJS || {};
        a.version = "NEXT", a.buildDate = "Fri, 04 Dec 2015 17:24:04 GMT" }(), this.createjs = this.createjs || {}, createjs.extend = function(a, b) { "use strict";
        ...
        a.ABSOLUTE_PATT = /^(?:\w+:)?\/{2}/i, a.RELATIVE_PATT = /^[.\/]*?\//i, a.EXTENSION_PATT = /\/?[^\/]+\.(\w{1,5})$/i, a.parseURI = function(b) { var c = { absolute: !1, relative: !1 }; if (null == b) return c; var d = b.indexOf("?");
            ...
            c.href = location.href; var d = "" != b.hostname && (b.port != c.port || b.protocol != c.protocol || b.hostname != c.hostname); return d }, a.isLocal = function(a) { var b = document.createElement("a"); return b.href = a.src, "" == b.hostname && "file:" == b.protocol }, a.isBinary = function(a) { switch (a) {
                ...
                case createjs.AbstractLoader.BINARY:
                    return !0;
                default:
                    return !1 } }, a.isImageTag = function(a) { return a instanceof HTMLImageElement }, a.isAudioTag = function(a) { return !!window.HTMLAudioElement && a instanceof HTMLAudioElement }, a.isVideoTag = function(a) { return !!window.HTMLVideoElement && a instanceof HTMLVideoElement }, a.isText = function(a) { switch (a) {
                case createjs.AbstractLoader.TEXT:
                case createjs.AbstractLoader.JSON:
                case createjs.AbstractLoader.MANIFEST:
                case createjs.AbstractLoader.XML:
    ...
    function() { "use strict";
        ...
        a.ACTIVEX_VERSIONS = ["Msxml2.XMLHTTP.6.0", "Msxml2.XMLHTTP.5.0", "Msxml2.XMLHTTP.4.0", "MSXML2.XMLHTTP.3.0", "MSXML2.XMLHTTP", "Microsoft.XMLHTTP"], b.getResult = function(a) { return a && this._rawResponse ? this._rawResponse : this._response }, b.cancel = function() { this.canceled = !0, this._clean(), this._request.abort() }, b.load = function() { if (null == this._request) return void this._handleError();
            null != this._request.addEventListener ? (this._request.addEventListener("loadstart", this._handleLoadStartProxy, !1), this._request.addEventListener("progress", this._handleProgressProxy, !1), this._request.addEventListener("abort", this._handleAbortProxy, !1), this._request.addEventListener("error", this._handleErrorProxy, !1), this._request.addEventListener("timeout", this._handleTimeoutProxy, !1), this._request.addEventListener("load", this._handleLoadProxy, !1), this._request.addEventListener("readystatechange", this._handleReadyStateChangeProxy, !1)) : (this._request.onloadstart = this._handleLoadStartProxy, this._request.onprogress = this._handleProgressProxy, this._request.onabort = this._handleAbortProxy, this._request.onerror = this._handleErrorProxy, this._request.ontimeout = this._handleTimeoutProxy, this._request.onload = this._handleLoadProxy, this._request.onreadystatechange = this._handleReadyStateChangeProxy), 1 == this._xhrLevel && (this._loadTimeout = setTimeout(createjs.proxy(this._handleTimeout, this), this._item.loadTimeout)); try { this._item.values && this._item.method != createjs.AbstractLoader.GET ? this._item.method == createjs.AbstractLoader.POST && this._request.send(createjs.RequestUtils.formatQueryString(this._item.values)) : this._request.send() } catch (a) { this.dispatchEvent(new createjs.ErrorEvent("XHR_SEND", null, a)) } }, b.setResponseType = function(a) { "blob" === a && (a = window.URL ? "blob" : "arraybuffer", this._responseType = a), this._request.responseType = a }, b.getAllResponseHeaders = function() { return this._request.getAllResponseHeaders instanceof Function ? this._request.getAllResponseHeaders() : null }, b.getResponseHeader = function(a) { return this._request.getResponseHeader instanceof Function ? this._request.getResponseHeader(a) : null }, b._handleProgress = function(a) { if (a && !(a.loaded > 0 && 0 == a.total)) { var b = new createjs.ProgressEvent(a.loaded, a.total);
                this.dispatchEvent(b) } }, b._handleLoadStart = function() { clearTimeout(this._loadTimeout), this.dispatchEvent("loadstart") }, b._handleAbort = function(a) { this._clean(), this.dispatchEvent(new createjs.ErrorEvent("XHR_ABORTED", null, a)) }, b._handleError = function(a) { this._clean(), this.dispatchEvent(new createjs.ErrorEvent(a.message)) }, b._handleReadyStateChange = function() { 4 == this._request.readyState && this._handleLoad() }, b._handleLoad = function() { if (!this.loaded) { this.loaded = !0; var a = this._checkError(); if (a) return void this._handleError(a); if (this._response = this._getResponse(), "arraybuffer" === this._responseType) try { this._response = new Blob([this._response]) } catch (a) { if (window.BlobBuilder = window.BlobBuilder || window.WebKitBlobBuilder || window.MozBlobBuilder || window.MSBlobBuilder, "TypeError" === a.name && window.BlobBuilder) { var b = new BlobBuilder;
                        b.append(this._response), this._response = b.getBlob() } }
            ...
            null == a.mimeType && createjs.RequestUtils.isText(a.type) && (a.mimeType = "text/plain; charset=utf-8"), a.mimeType && d.overrideMimeType && d.overrideMimeType(a.mimeType), this._xhrLevel = "string" == typeof d.responseType ? 2 : 1; var h = null; if (h = a.method == createjs.AbstractLoader.GET ? createjs.RequestUtils.buildPath(a.src, a.values) : a.src, d.open(a.method || createjs.AbstractLoader.GET, h, !0), b && d instanceof XMLHttpRequest && 1 == this._xhrLevel && (c.Origin = location.origin), a.values && a.method == createjs.AbstractLoader.POST && (c["Content-Type"] = "application/x-www-form-urlencoded"), b || c["X-Requested-With"] || (c["X-Requested-With"] = "XMLHttpRequest"), a.headers)
    ...
    function() { "use strict";
        ...
        c.INTERRUPT_ANY = "any", c.INTERRUPT_EARLY = "early", c.INTERRUPT_LATE = "late", c.INTERRUPT_NONE = "none", c.PLAY_INITED = "playInited", c.PLAY_SUCCEEDED = "playSucceeded", c.PLAY_INTERRUPTED = "playInterrupted", c.PLAY_FINISHED = "playFinished", c.PLAY_FAILED = "playFailed", c.SUPPORTED_EXTENSIONS = ["mp3", "ogg", "opus", "mpeg", "wav", "m4a", "mp4", "aiff", "wma", "mid"], c.EXTENSION_MAP = { m4a: "mp4" }, c.FILE_PATTERN = /^(?:(\w+:)\/{2}(\w+(?:\.\w+)*\/?))?([\/.]*?(?:[^?]+)?\/)?((?:[^\/?]+)\.(\w+))(?:\?(\S+)?)?$/, c.defaultInterruptBehavior = c.INTERRUPT_NONE, c.alternateExtensions = [], c.activePlugin = null, c._masterVolume = 1, Object.defineProperty(c, "volume", { get: function() { return this._masterVolume }, set: function(a) { if (null == Number(a)) return !1; if (a = Math.max(0, Math.min(1, a)), c._masterVolume = a, !this.activePlugin || !this.activePlugin.setVolume || !this.activePlugin.setVolume(a))
                ...
                for (var d = 0, e = c._preloadHash[b].length; e > d; d++) { var f = c._preloadHash[b][d]; if (c._preloadHash[b][d] = !1, c.hasEventListener("fileerror")) { var a = new createjs.Event("fileerror");
                        a.src = f.src, a.id = f.id, a.data = f.data, a.sprite = f.sprite, c.dispatchEvent(a) } } }, c._registerPlugin = function(a) { return !!a.isSupported() && (c.activePlugin = new a, !0) }, c.registerPlugins = function(a) { c._pluginsRegistered = !0; for (var b = 0, d = a.length; d > b; b++)
                if (c._registerPlugin(a[b])) return !0;
            return !1 }, c.initializeDefaultPlugins = function() { return null != c.activePlugin || !c._pluginsRegistered && !!c.registerPlugins([createjs.WebAudioPlugin, createjs.HTMLAudioPlugin]) }, c.isReady = function() { return null != c.activePlugin }, c.getCapabilities = function() { return null == c.activePlugin ? null : c.activePlugin._capabilities }, c.getCapability = function(a) { return null == c.activePlugin ? null : c.activePlugin._capabilities[a] }, c.initLoad = function(a) { return c._registerSound(a) }, c._registerSound = function(a) { if (!c.initializeDefaultPlugins()) return !1; var d; if (a.src instanceof Object ? (d = c._parseSrc(a.src), d.src = a.path + d.src) : d = c._parsePath(a.src), null == d) return !1;
            ...
            if (!b.src) return !1; var f = b.src.lastIndexOf("/"); return b.name = -1 != f ? b.src.slice(f + 1) : b.src, b }, c.play = function(a, b, d, e, f, g, h, i, j) { var k;
            k = createjs.PlayPropsConfig.create(b instanceof Object || b instanceof createjs.PlayPropsConfig ? b : { interrupt: b, delay: d, offset: e, loop: f, volume: g, pan: h, startTime: i, duration: j }); var l = c.createInstance(a, k.startTime, k.duration),
            ...
            c > -1 && this._instances.splice(c, 1) }, createjs.Sound = a, b.channels = {}, b.create = function(a, c) { var d = b.get(a); return null == d && (b.channels[a] = new b(a, c), !0) }, b.removeSrc = function(a) { var c = b.get(a); return null != c && (c._removeAll(), delete b.channels[a], !0) }, b.removeAll = function() { for (var a in b.channels) b.channels[a]._removeAll();
            b.channels = {} }, b.add = function(a, c) { var d = b.get(a.src); return null != d && d._add(a, c) }, b.remove = function(a) { var c = b.get(a.src); return null != c && (c._remove(a), !0) }, b.maxPerChannel = function() { return d.maxDefault }, b.get = function(a) { return b.channels[a] }; var d = b.prototype;
        d.constructor = b, d.src = null, d.max = null, d.maxDefault = 100, d.length = 0, d.init = function(a, b) { this.src = a, this.max = b || this.maxDefault, -1 == this.max && (this.max = this.maxDefault), this._instances = [] }, d._get = function(a) { return this._instances[a] }, d._add = function(a, b) { return !!this._getSlot(b, a) && (this._instances.push(a), this.length++, !0) }, d._remove = function(a) { var b = createjs.indexOf(this._instances, a); return -1 != b && (this._instances.splice(b, 1), this.length--, !0) }, d._removeAll = function() { for (var a = this.length - 1; a >= 0; a--) this._instances[a].stop() }, d._getSlot = function(b) { var c, d; if (b != a.INTERRUPT_NONE && (d = this._get(0), null == d)) return !0; for (var e = 0, f = this.max; f > e; e++) { if (c = this._get(e), null == c) return !0; if (c.playState == a.PLAY_FINISHED || c.playState == a.PLAY_INTERRUPTED || c.playState == a.PLAY_FAILED) { d = c; break }
                b != a.INTERRUPT_NONE && (b == a.INTERRUPT_EARLY && c.getPosition() < d.getPosition() || b == a.INTERRUPT_LATE && c.getPosition() > d.getPosition()) && (d = c) } return null != d && (d._interrupt(), this._remove(d), !0) }, d.toString = function() { return "[Sound SoundChannel]" } }(), this.createjs = this.createjs || {},
    function() {
        "use strict";
    ...
    function() { "use strict"; var a = function() { this._capabilities = null, this._loaders = {}, this._audioSources = {}, this._soundInstances = {}, this._volume = 1, this._loaderClass, this._soundInstanceClass },
            b = a.prototype;
        a._capabilities = null, a.isSupported = function() { return !0 }, b.register = function(a) { var b = this._loaders[a.src]; return b && !b.canceled ? this._loaders[a.src] : (this._audioSources[a.src] = !0, this._soundInstances[a.src] = [], b = new this._loaderClass(a), b.on("complete", this._handlePreloadComplete, this), this._loaders[a.src] = b, b) }, b.preload = function(a) { a.on("error", this._handlePreloadError, this), a.load() }, b.isPreloadStarted = function(a) { return null != this._audioSources[a] }, b.isPreloadComplete = function(a) { return !(null == this._audioSources[a] || 1 == this._audioSources[a]) }, b.removeSound = function(a) { if (this._soundInstances[a]) { for (var b = this._soundInstances[a].length; b--;) { var c = this._soundInstances[a][b];
                    c.destroy() }
                delete this._soundInstances[a], delete this._audioSources[a], this._loaders[a] && this._loaders[a].destroy(), delete this._loaders[a] } }, b.removeAllSounds = function() { for (var a in this._audioSources) this.removeSound(a) }, b.create = function(a, b, c) { this.isPreloadStarted(a) || this.preload(this.register(a)); var d = new this._soundInstanceClass(a, b, c, this._audioSources[a]); return this._soundInstances[a].push(d), d }, b.setVolume = function(a) { return this._volume = a, this._updateVolume(), !0 }, b.getVolume = function() { return this._volume }, b.setMute = function() { return this._updateVolume(), !0 }, b.toString = function() { return "[AbstractPlugin]" }, b._handlePreloadComplete = function(a) { var b = a.target.getItem().src;
            this._audioSources[b] = a.result; for (var c = 0, d = this._soundInstances[b].length; d > c; c++) { var e = this._soundInstances[b][c];
                e.setPlaybackResource(this._audioSources[b]) } }, b._handlePreloadError = function() {}, b._updateVolume = function() {}, createjs.AbstractPlugin = a }(), this.createjs = this.createjs || {},
    function() { "use strict";
        ...
        a.context = null, b.toString = function() { return "[WebAudioLoader]" }, b._createRequest = function() { this._request = new createjs.XHRRequest(this._item, !1), this._request.setResponseType("arraybuffer") }, b._sendComplete = function() { a.context.decodeAudioData(this._rawResult, createjs.proxy(this._handleAudioDecoded, this), createjs.proxy(this._sendError, this)) }, b._handleAudioDecoded = function(a) { this._result = a, this.AbstractLoader__sendComplete() }, createjs.WebAudioLoader = createjs.promote(a, "AbstractLoader") }(), this.createjs = this.createjs || {},
    function() { "use strict";
    ...
    function() { "use strict";
        ...
        function a() { this.AbstractPlugin_constructor(), this._panningModel = c._panningModel, this.context = c.context, this.dynamicsCompressorNode = this.context.createDynamicsCompressor(), this.dynamicsCompressorNode.connect(this.context.destination), this.gainNode = this.context.createGain(), this.gainNode.connect(this.dynamicsCompressorNode), createjs.WebAudioSoundInstance.destinationNode = this.gainNode, this._capabilities = c._capabilities, this._loaderClass = createjs.WebAudioLoader, this._soundInstanceClass = createjs.WebAudioSoundInstance, this._addPropsToClasses() } var b = createjs.extend(a, createjs.AbstractPlugin),
            c = a;
        c._capabilities = null, c._panningModel = "equalpower", c.context = null, c._scratchBuffer = null, c._unlocked = !1, c.isSupported = function() { var a = createjs.BrowserDetect.isIOS || createjs.BrowserDetect.isAndroid || createjs.BrowserDetect.isBlackberry; return !("file:" == location.protocol && !a && !this._isFileXHRSupported()) && (c._generateCapabilities(), null != c.context) }, c.playEmptySound = function() { if (null != c.context) { var a = c.context.createBufferSource();
                a.buffer = c._scratchBuffer, a.connect(c.context.destination), a.start(0, 0, 0) } }, c._isFileXHRSupported = function() { var a = !0,
                b = new XMLHttpRequest; try { b.open("GET", "WebAudioPluginTest.fail", !1) } catch (b) { return a = !1 }
            b.onerror = function() { a = !1 }, b.onload = function() { a = 404 == this.status || 200 == this.status || 0 == this.status && "" != this.response }; try { b.send() } catch (b) { a = !1 } return a }, c._generateCapabilities = function() { if (null == c._capabilities) { var a = document.createElement("audio"); if (null == a.canPlayType) return null; if (null == c.context)
    ...
    function() { "use strict";
        ...
        b.setMasterVolume = function() { this._updateVolume() }, b.setMasterMute = function() { this._updateVolume() }, b.toString = function() { return "[HTMLAudioSoundInstance]" }, b._removeLooping = function() { null != this._playbackResource && (this._playbackResource.loop = !1, this._playbackResource.removeEventListener(createjs.HTMLAudioPlugin._AUDIO_SEEKED, this._loopHandler, !1)) }, b._addLooping = function() { null == this._playbackResource || this._audioSpriteStopTime || (this._playbackResource.addEventListener(createjs.HTMLAudioPlugin._AUDIO_SEEKED, this._loopHandler, !1), this._playbackResource.loop = !0) }, b._handleCleanUp = function() { var a = this._playbackResource; if (null != a) { a.pause(), a.loop = !1, a.removeEventListener(createjs.HTMLAudioPlugin._AUDIO_ENDED, this._endedHandler, !1), a.removeEventListener(createjs.HTMLAudioPlugin._AUDIO_READY, this._readyHandler, !1), a.removeEventListener(createjs.HTMLAudioPlugin._AUDIO_STALLED, this._stalledHandler, !1), a.removeEventListener(createjs.HTMLAudioPlugin._AUDIO_SEEKED, this._loopHandler, !1), a.removeEventListener(createjs.HTMLAudioPlugin._TIME_UPDATE, this._audioSpriteEndHandler, !1); try { a.currentTime = this._startTime } catch (a) {}
                createjs.HTMLAudioTagPool.set(this.src, a), this._playbackResource = null } }, b._beginPlaying = function(a) { return this._playbackResource = createjs.HTMLAudioTagPool.get(this.src), this.AbstractSoundInstance__beginPlaying(a) }, b._handleSoundReady = function() { if (4 !== this._playbackResource.readyState) { var a = this._playbackResource; return a.addEventListener(createjs.HTMLAudioPlugin._AUDIO_READY, this._readyHandler, !1), a.addEventListener(createjs.HTMLAudioPlugin._AUDIO_STALLED, this._stalledHandler, !1), a.preload = "auto", void a.load() }
            this._updateVolume(), this._playbackResource.currentTime = .001 * (this._startTime + this._position), this._audioSpriteStopTime ? this._playbackResource.addEventListener(createjs.HTMLAudioPlugin._TIME_UPDATE, this._audioSpriteEndHandler, !1) : (this._playbackResource.addEventListener(createjs.HTMLAudioPlugin._AUDIO_ENDED, this._endedHandler, !1), 0 != this._loop && (this._playbackResource.addEventListener(createjs.HTMLAudioPlugin._AUDIO_SEEKED, this._loopHandler, !1), this._playbackResource.loop = !0)), this._playbackResource.play() }, b._handleTagReady = function() { this._playbackResource.removeEventListener(createjs.HTMLAudioPlugin._AUDIO_READY, this._readyHandler, !1), this._playbackResource.removeEventListener(createjs.HTMLAudioPlugin._AUDIO_STALLED, this._stalledHandler, !1), this._handleSoundReady() }, b._pause = function() { this._playbackResource.pause() }, b._resume = function() { this._playbackResource.play() }, b._updateVolume = function() { if (null != this._playbackResource) { var a = this._muted || createjs.Sound._masterMute ? 0 : this._volume * createjs.Sound._masterVolume;
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
        ...
        _gsScope._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function(a, b, c) { var d = function(a) { var b, c = [],
                ...
                return d.version = "1.19.0", q.constructor = d, q.kill()._gc = q._forcingPlayhead = q._hasPause = !1, q.to = function(a, b, d, e) { var f = d.repeat && l.TweenMax || c; return b ? this.add(new f(a, b, d), e) : this.set(a, d, e) }, q.from = function(a, b, d, e) { return this.add((d.repeat && l.TweenMax || c).from(a, b, d), e) }, q.fromTo = function(a, b, d, e, f) { var g = e.repeat && l.TweenMax || c; return b ? this.add(g.fromTo(a, b, d, e), f) : this.set(a, e, f) }, q.staggerTo = function(a, b, e, f, g, i, j, k) { var l, o, q = new d({ onComplete: i, onCompleteParams: j, callbackScope: k, smoothChildTiming: this.smoothChildTiming }),
                    ...
                    return d.startAt = c, d.immediateRender = 0 != d.immediateRender && 0 != c.immediateRender, this.staggerTo(a, b, d, e, f, g, h, i)
                }, q.call = function(a, b, d, e) { return this.add(c.delayedCall(0, a, b, d), e) }, q.set = function(a, b, d) { return d = this._parseTimeOrLabel(d, 0, !0), null == b.immediateRender && (b.immediateRender = d === this._time && !this._paused), this.add(new c(a, 0, b), d) }, d.exportRoot = function(a, b) { a = a || {}, null == a.smoothChildTiming && (a.smoothChildTiming = !0); var e, f, g = new d(a),
                        ...
                        for (var c = this._first, d = this._time; c;) c._startTime === d && "isPause" === c.data && (c._rawPrevTime = 0), c = c._next; return a.prototype.paused.apply(this, arguments) }, q.usesFrames = function() { for (var b = this._timeline; b._timeline;) b = b._timeline; return b === a._rootFramesTimeline }, q.rawTime = function() { return this._paused ? this._totalTime : (this._timeline.rawTime() - this._startTime) * this._timeScale }, d
            }, !0), _gsScope._gsDefine("TimelineMax", ["TimelineLite", "TweenLite", "easing.Ease"], function(a, b, c) { var d = function(b) { a.call(this, b), this._repeat = this.vars.repeat || 0, this._repeatDelay = this.vars.repeatDelay || 0, this._cycle = 0, this._yoyo = this.vars.yoyo === !0, this._dirty = !0 },
                    e = 1e-10,
                    f = b._internals,
                    g = f.lazyTweens,
                    h = f.lazyRender,
            ...
            function() { var a = 180 / Math.PI,
                    ...
                    p = _gsScope._gsDefine.plugin({ propName: "bezier", priority: -1, version: "1.3.7", API: 2, global: !0, init: function(a, b, c) { this._target = a, b instanceof Array && (b = { values: b }), this._func = {}, this._mod = {}, this._props = [], this._timeRes = null == b.timeResolution ? 6 : parseInt(b.timeResolution, 10); var d, e, f, g, h, i = b.values || [],
                            ...
                            this._autoRotate = n ? n instanceof Array ? n : [
                                ...
                                for (this._initialRotations = [], n[0] instanceof Array || (this._autoRotate = n = [n]), f = n.length; --f > -1;) { for (g = 0; 3 > g; g++) d = n[f][g], this._func[d] = "function" == typeof a[d] && a[d.indexOf("set") || "function" != typeof a["get" + d.substr(3)] ? d : "get" + d.substr(3)];
                ...
                p.bezierThrough = l, p.cubicToQuadratic = i, p._autoCSS = !0, p.quadraticToCubic = function(a, b, c) { return new g(a, (2 * b + a) / 3, (2 * b + c) / 3, c) }, p._cssRegister = function() { var a = f.CSSPlugin; if (a) { var b = a._internals,
                        ...
                        b._registerComplexSpecialProp("bezier", { parser: function(a, b, f, g, h, i) { b instanceof Array && (b = { values: b }), i = new p; var j, k, l, m = b.values,
                                    ...
                                    ["x", "y", "rotation", j, !1]
                                ]), q.autoRotate && (g._transform || g._enableTransforms(!1), l.autoRotate = g._target._gsTransform, l.proxy.rotation = l.autoRotate.rotation || 0, g._overwriteProps.push("rotation")), i._onInitTween(l.proxy, q, g._tween), h } }) } }, q._mod = function(a) { for (var b, c = this._overwriteProps, d = c.length; --d > -1;) b = a[c[d]], b && "function" == typeof b && (this._mod[c[d]] = b) }, q._kill = function(a) { var b, c, d = this._props; for (b in this._beziers)
                        if (b in a)
                            for (delete this._beziers[b], delete this._func[b], c = d.length; --c > -1;) d[c] === b && d.splice(c, 1);
                    if (d = this._autoRotate)
                        for (c = d.length; --c > -1;) a[d[c][2]] && d.splice(c, 1); return this._super._kill.call(this, a) } }(), _gsScope._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], function(a, b) {
                ...
                var k, l, m, n, o, p, q, r, s = /(?:\-|\.|\b)(\d|\.|e\-)+/g,
                    ...
                    T = function() { var a = S.indexOf("Android"),
                            b = O("a"); return m = -1 !== S.indexOf("Safari") && -1 === S.indexOf("Chrome") && (-1 === a || Number(S.substr(a + 8, 1)) > 3), o = m && Number(S.substr(S.indexOf("Version/") + 8, 1)) < 6, n = -1 !== S.indexOf("Firefox"), (/MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(S) || /Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(S)) && (p = parseFloat(RegExp.$1)), !!b && (b.style.cssText = "top:1px;opacity:.55;", /^0.55/.test(b.style.opacity)) }(),
                ...
                var za, Aa = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","),
                    ...
                    Fa = R.Transform = function() { this.perspective = parseFloat(g.defaultTransformPerspective) || 0, this.force3D = !(g.defaultForce3D === !1 || !Ea) && (g.defaultForce3D || "auto") },
                ...
                j = Fa.prototype, j.x = j.y = j.z = j.skewX = j.skewY = j.rotation = j.rotationX = j.rotationY = j.zOrigin = j.xPercent = j.yPercent = j.xOffset = j.yOffset = 0, j.scaleX = j.scaleY = j.scaleZ = 1, xa("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin", { parser: function(a, b, c, d, f, h, i) { if (d._lastParsedTransform === i) return f;
                        d._lastParsedTransform = i; var j; "function" == typeof i[c] && (j = i[c], i[c] = b); var k, l, m, n, o, p, s, t, u, v = a._gsTransform,
                            w = a.style,
                            x = 1e-6,
                            y = Aa.length,
                            z = i,
                    ...
                    this._target = q = a, this._tween = h, this._vars = b, r = j, k = b.autoRound, c = !1, d = b.suffixMap || g.suffixMap, e = Z(a, ""), f = this._overwriteProps; var n, p, s, t, u, v, w, x, z, A = a.style; if (l && "" === A.zIndex && (n = $(a, "zIndex", e), ("auto" === n || "" === n) && this._addLazySet(A, "zIndex", 0)), "string" == typeof b && (t = A.cssText, n = ba(a, e), A.cssText = t + ";" + b, n = ca(a, n, ba(a)).difs, !T && y.test(b) && (n.opacity = parseFloat(RegExp.$1)), b = n, A.cssText = t), b.className ? this._firstPT = p = i.className.parse(a, b.className, "className", this, null, null, b) : this._firstPT = p = this.parse(a, b, null), this._transformType) { for (z = 3 === this._transformType, Ba ? m && (l = !0, "" === A.zIndex && (w = $(a, "zIndex", e), ("auto" === w || "" === w) && this._addLazySet(A, "zIndex", 0)), o && this._addLazySet(A, "WebkitBackfaceVisibility", this._vars.WebkitBackfaceVisibility || (z ? "visible" : "hidden"))) : A.zoom = 1, s = p; s && s._next;) s = s._next;
                        ...
                        if (a || this._tween._time !== this._tween._duration && 0 !== this._tween._time || this._tween._rawPrevTime === -1e-6)
                            ...
                            for (; e;) { if (2 !== e.type)
                                ...
                                e = e._next } }, j._enableTransforms = function(a) {
        ...
        if (!d.TweenLite) {
            ...
            g._init = function() { var a, b, c, d, e, f, g = this.vars,
                ...
                if ((o(b) || G(b)) && "number" != typeof b[0])
                    ...
                    if (this._targets) { for (d = this._targets.length; --d > -1;)
                    ...
                    if (h) {
                        if (j = a || h, k = a !== e && "all" !== e && a !== h && ("object" != typeof a || !a._tempKill), c && (F.onOverwrite || this.vars.onOverwrite)) { for (f in j) h[f] && (l || (l = []), l.push(f)); if ((l || !a) && !Z(this, c, b, l)) return !1 }
...
! function(jQuery, ytp) {
    jQuery.mbYTPlayer = {
        ...
        buildPlayer: function(options) { return this.each(function() { var YTPlayer = this,
                ...
                YTPlayer.canGoFullScreen = !(jQuery.browser.msie || jQuery.browser.opera || isIframe()), YTPlayer.canGoFullScreen || (YTPlayer.opt.realfullscreen = !1), $YTPlayer.attr("id") || $YTPlayer.attr("id", "video_" + (new Date).getTime()); var playerID = "mbYTP_" + YTPlayer.id;
                YTPlayer.isAlone = !1, YTPlayer.hasFocus = !0; var videoID = this.opt.videoURL ? getYTPVideoID(this.opt.videoURL).videoID : !!$YTPlayer.attr("href") && getYTPVideoID($YTPlayer.attr("href")).videoID,
                ...
                YTPlayer.videoID = videoID, YTPlayer.playlistID = playlistID, YTPlayer.opt.showAnnotations = YTPlayer.opt.showAnnotations ? "0" : "3"; var playerVars = { modestbranding: 1, autoplay: 0, controls: 0, showinfo: 0, rel: 0, enablejsapi: 1, version: 3, playerapiid: playerID, origin: "*", allowfullscreen: !0, wmode: "transparent", iv_load_policy: YTPlayer.opt.showAnnotations }; if (document.createElement("video").canPlayType && jQuery.extend(playerVars, { html5: 1 }), jQuery.browser.msie && jQuery.browser.version < 9 && (this.opt.opacity = 1), YTPlayer.isSelf = "self" == YTPlayer.opt.containment, YTPlayer.defaultOpt.containment = YTPlayer.opt.containment = jQuery("self" == YTPlayer.opt.containment ? this : YTPlayer.opt.containment), YTPlayer.isBackground = YTPlayer.opt.containment.is("body"), !YTPlayer.isBackground || !ytp.backgroundIsInited) { var isPlayer = YTPlayer.opt.containment.is(jQuery(this));
                    YTPlayer.canPlayOnMobile = isPlayer && 0 === jQuery(this).children().length, YTPlayer.isPlayer = !1, isPlayer ? YTPlayer.isPlayer = !0 : $YTPlayer.hide(); var overlay = jQuery("<div/>").css({ position: "absolute", top: 0, left: 0, width: "100%", height: "100%" }).addClass("YTPOverlay");
                    YTPlayer.isPlayer && overlay.on("click", function() { $YTPlayer.YTPTogglePlay() }); var wrapper = jQuery("<div/>").addClass("mbYTP_wrapper").attr("id", "wrapper_" + playerID);
                    wrapper.css({ position: "absolute", zIndex: 0, minWidth: "100%", minHeight: "100%", left: 0, top: 0, overflow: "hidden", opacity: 0 }); var playerBox = jQuery("<div/>").attr("id", playerID).addClass("playerBox"); if (playerBox.css({ position: "absolute", zIndex: 0, width: "100%", height: "100%", top: 0, left: 0, overflow: "hidden" }), wrapper.append(playerBox), YTPlayer.opt.containment.children().not("script, style").each(function() { "static" == jQuery(this).css("position") && jQuery(this).css("position", "relative") }), YTPlayer.isBackground ? (jQuery("body").css({ boxSizing: "border-box" }), wrapper.css({ position: "fixed", top: 0, left: 0, zIndex: 0 }), $YTPlayer.hide()) : "static" == YTPlayer.opt.containment.css("position") && YTPlayer.opt.containment.css({ position: "relative" }), YTPlayer.opt.containment.prepend(wrapper), YTPlayer.wrapper = wrapper, playerBox.css({ opacity: 1 }), jQuery.browser.mobile || (playerBox.after(overlay), YTPlayer.overlay = overlay), YTPlayer.isBackground || overlay.on("mouseenter", function() { YTPlayer.controlBar.length && YTPlayer.controlBar.addClass("visible") }).on("mouseleave", function() { YTPlayer.controlBar.length && YTPlayer.controlBar.removeClass("visible") }), ytp.YTAPIReady) setTimeout(function() { jQuery(document).trigger("YTAPIReady") }, 100);
                    ...
                    jQuery(document).on("YTAPIReady", function() { YTPlayer.isBackground && ytp.backgroundIsInited || YTPlayer.isInit || (YTPlayer.isBackground && (ytp.backgroundIsInited = !0), YTPlayer.opt.autoPlay = "undefined" == typeof YTPlayer.opt.autoPlay ? !!YTPlayer.isBackground : YTPlayer.opt.autoPlay, YTPlayer.opt.vol = YTPlayer.opt.vol ? YTPlayer.opt.vol : 100, jQuery.mbYTPlayer.getDataFromAPI(YTPlayer), jQuery(YTPlayer).on("YTPChanged", function() { if (!YTPlayer.isInit) { if (YTPlayer.isInit = !0, jQuery.browser.mobile && YTPlayer.canPlayOnMobile) { if (YTPlayer.opt.containment.outerWidth() > jQuery(window).width()) { YTPlayer.opt.containment.css({ maxWidth: "100%" }); var h = .563 * YTPlayer.opt.containment.outerWidth();
                                        YTPlayer.opt.containment.css({ maxHeight: h }) } return void new YT.Player(playerID, { videoId: YTPlayer.videoID.toString(), width: "100%", height: h, playerVars: playerVars, events: { onReady: function(a) { YTPlayer.player = a.target, playerBox.css({ opacity: 1 }), YTPlayer.wrapper.css({ opacity: 1 }) } } }) }
                                new YT.Player(playerID, { videoId: YTPlayer.videoID.toString(), playerVars: playerVars, events: { onReady: function(a) { YTPlayer.player = a.target, YTPlayer.isReady || (YTPlayer.isReady = !(YTPlayer.isPlayer && !YTPlayer.opt.autoPlay), YTPlayer.playerEl = YTPlayer.player.getIframe(), jQuery(YTPlayer.playerEl).unselectable(), $YTPlayer.optimizeDisplay(), YTPlayer.videoID = videoID, jQuery(window).off("resize.YTP_" + YTPlayer.id).on("resize.YTP_" + YTPlayer.id, function() { $YTPlayer.optimizeDisplay() }), jQuery.mbYTPlayer.checkForState(YTPlayer)) }, onStateChange: function(event) { if ("function" == typeof event.target.getPlayerState) { var state = event.target.getPlayerState(); if (YTPlayer.preventTrigger) return void(YTPlayer.preventTrigger = !1);
                                                ...
                                                YTPEvent.time = YTPlayer.currentTime, YTPlayer.canTrigger && jQuery(YTPlayer).trigger(YTPEvent) } }, onPlaybackQualityChange: function(a) { var b = a.target.getPlaybackQuality(),
        ...
        getDataFromAPI: function(a) { if (a.videoData = jQuery.mbStorage.get("YTPlayer_data_" + a.videoID), jQuery(a).off("YTPData.YTPlayer").on("YTPData.YTPlayer", function() { if (a.hasData && a.isPlayer && !a.opt.autoPlay) { var b = a.videoData.thumb_max || a.videoData.thumb_high || a.videoData.thumb_medium;
                        a.opt.containment.css({ background: "rgba(0,0,0,0.5) url(" + b + ") center center", backgroundSize: "cover" }), a.opt.backgroundUrl = b } }), a.videoData) setTimeout(function() { a.opt.ratio = "auto" == a.opt.ratio ? "16/9" : a.opt.ratio, a.dataReceived = !0, jQuery(a).trigger("YTPChanged"); var b = jQuery.Event("YTPData");
                b.prop = {}; for (var c in a.videoData) b.prop[c] = a.videoData[c];
                jQuery(a).trigger(b) }, 500), a.hasData = !0;
                ...
                a.dataReceived = !0, jQuery(a).trigger("YTPChanged"), c(b.items[0].snippet), a.hasData = !0; var d = jQuery.Event("YTPData");
                d.prop = {}; for (var e in a.videoData) d.prop[e] = a.videoData[e];
                jQuery(a).trigger(d) });
            else { if (setTimeout(function() { jQuery(a).trigger("YTPChanged") }, 50), a.isPlayer && !a.opt.autoPlay) { var b = jQuery.mbYTPlayer.locationProtocol + "//i.ytimg.com/vi/" + a.videoID + "/hqdefault.jpg";
                    a.opt.containment.css({ background: "rgba(0,0,0,0.5) url(" + b + ") center center", backgroundSize: "cover" }), a.opt.backgroundUrl = b }
                a.videoData = null, a.opt.ratio = "auto" == a.opt.ratio ? "16/9" : a.opt.ratio }!a.isPlayer || a.opt.autoPlay || jQuery.browser.mobile || (a.loading = jQuery("<div/>").addClass("loading").html("Loading").hide(), jQuery(a).append(a.loading), a.loading.fadeIn()) },
        ...
        playlist: function(a, b, c, d) { var e = this,
                f = e.get(0); return f.isPlayList = !0, b && (a = jQuery.shuffle(a)), f.videoID || (f.videos = a, f.videoCounter = 0, f.videoLength = a.length, jQuery(f).data("property", a[0]), jQuery(f).mb_YTPlayer()), "function" == typeof c && jQuery(f).one("YTPChanged", function() { c(f) }), jQuery(f).on("YTPEnd", function() { d = "undefined" == typeof d || d, jQuery(f).playNext(d) }), e },
        ...
        changeMovie: function(a) { var b = this,
                c = b.get(0);
            c.opt.startAt = 0, c.opt.stopAt = 0, c.opt.mask = !1, c.opt.mute = !0, c.hasData = !1, c.hasChanged = !0, c.player.loopTime = void 0, a && jQuery.extend(c.opt, a), c.videoID = getYTPVideoID(c.opt.videoURL).videoID, "true" == c.opt.loop && (c.opt.loop = 9999), jQuery(c.playerEl).CSSAnimate({ opacity: 0 }, 200, function() { var a = jQuery.Event("YTPChangeMovie");
        ...
        playerDestroy: function() { var a = this.get(0);
            ytp.YTAPIReady = !0, ytp.backgroundIsInited = !1, a.isInit = !1, a.videoID = null; var b = a.wrapper; return b.remove(), jQuery("#controlBar_" + a.id).remove(), clearInterval(a.checkForStartAt), clearInterval(a.getState), this },
        ...
        play: function() { var a = this.get(0); if (!a.isReady) return this;
            a.player.playVideo(), a.wrapper.CSSAnimate({ opacity: a.isAlone ? 1 : a.opt.opacity }, 2e3), jQuery(a.playerEl).CSSAnimate({ opacity: 1 }, 1e3); var b = jQuery("#controlBar_" + a.id),
                c = b.find(".mb_YTPPlaypause"); return c.html(jQuery.mbYTPlayer.controls.pause), a.state = 1, jQuery(a).css("background-image", "none"), this },
        ...
        mute: function() { var a = this.get(0); if (!a.isMute) { a.player.mute(), a.isMute = !0, a.player.setVolume(0), a.volumeBar && a.volumeBar.length && a.volumeBar.width() > 10 && a.volumeBar.updateSliderVal(0); var b = jQuery("#controlBar_" + a.id),
                ...
                c.html(jQuery.mbYTPlayer.controls.unmute), jQuery(a).addClass("isMuted"), a.volumeBar && a.volumeBar.length && a.volumeBar.addClass("muted"); var d = jQuery.Event("YTPMuted"); return d.time = a.currentTime, a.canTrigger && jQuery(a).trigger(d), this } },
        unmute: function() { var a = this.get(0); if (a.isMute) { a.player.unMute(), a.isMute = !1, a.player.setVolume(a.opt.vol), a.volumeBar && a.volumeBar.length && a.volumeBar.updateSliderVal(a.opt.vol > 10 ? a.opt.vol : 10); var b = jQuery("#controlBar_" + a.id),
                    c = b.find(".mb_YTPMuteUnmute");
                c.html(jQuery.mbYTPlayer.controls.mute), jQuery(a).removeClass("isMuted"), a.volumeBar && a.volumeBar.length && a.volumeBar.removeClass("muted"); var d = jQuery.Event("YTPUnmuted"); return d.time = a.currentTime, a.canTrigger && jQuery(a).trigger(d), this } },
        ...
        addMask: function(a) { var b = this.get(0),
                c = b.overlay;
            a || (a = b.actualMask); var d = jQuery("<img/>").attr("src", a).on("load", function() { c.CSSAnimate({ opacity: 0 }, 500, function() { b.hasMask = !0, d.remove(), c.css({ backgroundImage: "url(" + a + ")", backgroundRepeat: "no-repeat", backgroundPosition: "center center", backgroundSize: "cover" }), c.CSSAnimate({ opacity: 1 }, 500) }) }); return this },
        removeMask: function() { var a = this.get(0),
                b = a.overlay; return b.CSSAnimate({ opacity: 0 }, 500, function() { a.hasMask = !1, b.css({ backgroundImage: "", backgroundRepeat: "", backgroundPosition: "", backgroundSize: "" }), b.CSSAnimate({ opacity: 1 }, 500) }), this },
        applyMask: function(a) { var b = jQuery(a); if (b.off("YTPTime.mask"), a.opt.mask)
                ...
                else if ("object" == typeof a.opt.mask) { for (var c in a.opt.mask) a.opt.mask[c] && jQuery("<img/>").attr("src", a.opt.mask[c]);
        ...
        checkForState: function(YTPlayer) { var interval = YTPlayer.opt.showControls ? 100 : 400; return clearInterval(YTPlayer.getState), jQuery.contains(document, YTPlayer) ? (jQuery.mbYTPlayer.checkForStart(YTPlayer), void(YTPlayer.getState = setInterval(function() { var prog = jQuery(YTPlayer).YTPManageProgress(),
                    $YTPlayer = jQuery(YTPlayer),
                    data = YTPlayer.opt,
        ...
        checkForStart: function(a) { var b = jQuery(a); if (!jQuery.contains(document, a)) return void jQuery(a).YTPPlayerDestroy(); if (a.preventTrigger = !0, a.state = 2, jQuery(a).YTPPause(), jQuery(a).muteYTPVolume(), jQuery("#controlBar_" + a.id).remove(), a.controlBar = !1, a.opt.showControls && jQuery.mbYTPlayer.buildControls(a), a.opt.addRaster) { var c = "dot" == a.opt.addRaster ? "raster-dot" : "raster";
                a.overlay.addClass(a.isRetina ? c + " retina" : c) } else a.overlay.removeClass(function(a, b) { var c = b.split(" "),
                    d = []; return jQuery.each(c, function(a, b) { /raster.*/.test(b) && d.push(b) }), d.push("retina"), d.join(" ") }); var d = a.opt.startAt ? a.opt.startAt : 1;
            a.player.playVideo(), a.player.seekTo(d, !0), a.checkForStartAt = setInterval(function() { jQuery(a).YTPMute(); var c = a.player.getVideoLoadedFraction() >= d / a.player.getDuration(); if (a.player.getDuration() > 0 && a.player.getCurrentTime() >= d && c) { clearInterval(a.checkForStartAt), "function" == typeof a.opt.onReady && a.opt.onReady(a), a.isReady = !0; var e = jQuery.Event("YTPReady"); if (e.time = a.currentTime, jQuery(a).trigger(e), a.preventTrigger = !0, a.state = 2, jQuery(a).YTPPause(), a.opt.mute || jQuery(a).YTPUnmute(), a.canTrigger = !0, a.opt.autoPlay) { var f = jQuery.Event("YTPStart");
                    ...
                    a.isPlayer && !a.opt.autoPlay && a.loading && a.loading.length && (a.loading.html("Ready"), setTimeout(function() { a.loading.fadeOut() }, 100)), a.controlBar && a.controlBar.length && a.controlBar.slideDown(1e3) } else jQuery.browser.safari && (a.player.playVideo(), d >= 0 && a.player.seekTo(d, !0)) }, 1) },
        setAlign: function(a) { var b = this;
            b.optimizeDisplay(a) },
    ...
    }, jQuery.fn.optimizeDisplay = function(a) { var b = this.get(0),
            c = jQuery(b.playerEl),
            d = {};
        b.opt.align = a || b.opt.align, b.opt.align = "undefined " != typeof b.opt.align ? b.opt.align : "center,center"; var e = b.opt.align.split(","); if (b.opt.optimizeDisplay) { var f = {},
                g = b.wrapper;
            f.width = g.outerWidth(), f.height = g.outerHeight(), d.width = f.width, d.height = "16/9" == b.opt.ratio ? Math.ceil(f.width * (9 / 16)) : Math.ceil(.75 * f.width), d.width = f.width, d.height = "16/9" == b.opt.ratio ? Math.ceil(f.width * (9 / 16)) : Math.ceil(.75 * f.width), d.marginTop = -((d.height - f.height) / 2), d.marginLeft = 0; var h = d.height < f.height;
            h && (d.height = f.height, d.width = "16/9" == b.opt.ratio ? Math.floor(f.height * (16 / 9)) : Math.floor(f.height * (4 / 3)), d.marginTop = 0, d.marginLeft = -((d.width - f.width) / 2)); for (var i in e) { var j = e[i].trim(); switch (j) {
                    case "top":
                        d.marginTop = h ? -((d.height - f.height) / 2) : 0; break;
                    case "bottom":
                        d.marginTop = h ? 0 : -(d.height - f.height); break;
                    case "left":
                        d.marginLeft = 0; break;
                    case "right":
                        d.marginLeft = h ? -(d.width - f.width) : 0 } } } else d.width = "100%", d.height = "100%", d.marginTop = 0, d.marginLeft = 0;
        c.css({ width: d.width, height: d.height, marginTop: d.marginTop, marginLeft: d.marginLeft }) }, jQuery.shuffle = function(a) { for (var b = a.slice(), c = b.length, d = c; d--;) { var e = parseInt(Math.random() * c),
                f = b[d];
...
}(jQuery, ytp), jQuery.support.CSStransition = function() { var a = document.body || document.documentElement,
        b = a.style; return void 0 !== b.transition || void 0 !== b.WebkitTransition || void 0 !== b.MozTransition || void 0 !== b.MsTransition || void 0 !== b.OTransition }(), jQuery.CSS = { name: "mb.CSSAnimate", author: "Matteo Bicocchi", version: "2.0.0", transitionEnd: "transitionEnd", sfx: "", filters: { blur: { min: 0, max: 100, unit: "px" }, brightness: { min: 0, max: 400, unit: "%" }, contrast: { min: 0, max: 400, unit: "%" }, grayscale: { min: 0, max: 100, unit: "%" }, hueRotate: { min: 0, max: 360, unit: "deg" }, invert: { min: 0, max: 100, unit: "%" }, saturate: { min: 0, max: 400, unit: "%" }, sepia: { min: 0, max: 100, unit: "%" } }, normalizeCss: function(a) { var b = jQuery.extend(!0, {}, a);
        jQuery.browser.webkit || jQuery.browser.opera ? jQuery.CSS.sfx = "-webkit-" : jQuery.browser.mozilla ? jQuery.CSS.sfx = "-moz-" : jQuery.browser.msie && (jQuery.CSS.sfx = "-ms-"); for (var c in b) { "transform" === c && (b[jQuery.CSS.sfx + "transform"] = b[c], delete b[c]), "transform-origin" === c && (b[jQuery.CSS.sfx + "transform-origin"] = a[c], delete b[c]), "filter" !== c || jQuery.browser.mozilla || (b[jQuery.CSS.sfx + "filter"] = a[c], delete b[c]), "blur" === c && setFilter(b, "blur", a[c]), "brightness" === c && setFilter(b, "brightness", a[c]), "contrast" === c && setFilter(b, "contrast", a[c]), "grayscale" === c && setFilter(b, "grayscale", a[c]), "hueRotate" === c && setFilter(b, "hueRotate", a[c]), "invert" === c && setFilter(b, "invert", a[c]), "saturate" === c && setFilter(b, "saturate", a[c]), "sepia" === c && setFilter(b, "sepia", a[c]); var d = ""; "x" === c && (d = jQuery.CSS.sfx + "transform", b[d] = b[d] || "", b[d] += " translateX(" + setUnit(a[c], "px") + ")", delete b[c]), "y" === c && (d = jQuery.CSS.sfx + "transform", b[d] = b[d] || "", b[d] += " translateY(" + setUnit(a[c], "px") + ")", delete b[c]), "z" === c && (d = jQuery.CSS.sfx + "transform", b[d] = b[d] || "", b[d] += " translateZ(" + setUnit(a[c], "px") + ")", delete b[c]), "rotate" === c && (d = jQuery.CSS.sfx + "transform", b[d] = b[d] || "", b[d] += " rotate(" + setUnit(a[c], "deg") + ")", delete b[c]), "rotateX" === c && (d = jQuery.CSS.sfx + "transform", b[d] = b[d] || "", b[d] += " rotateX(" + setUnit(a[c], "deg") + ")", delete b[c]), "rotateY" === c && (d = jQuery.CSS.sfx + "transform", b[d] = b[d] || "", b[d] += " rotateY(" + setUnit(a[c], "deg") + ")", delete b[c]), "rotateZ" === c && (d = jQuery.CSS.sfx + "transform", b[d] = b[d] || "", b[d] += " rotateZ(" + setUnit(a[c], "deg") + ")", delete b[c]), "scale" === c && (d = jQuery.CSS.sfx + "transform", b[d] = b[d] || "", b[d] += " scale(" + setUnit(a[c], "") + ")", delete b[c]), "scaleX" === c && (d = jQuery.CSS.sfx + "transform", b[d] = b[d] || "", b[d] += " scaleX(" + setUnit(a[c], "") + ")", delete b[c]), "scaleY" === c && (d = jQuery.CSS.sfx + "transform", b[d] = b[d] || "", b[d] += " scaleY(" + setUnit(a[c], "") + ")", delete b[c]), "scaleZ" === c && (d = jQuery.CSS.sfx + "transform", b[d] = b[d] || "", b[d] += " scaleZ(" + setUnit(a[c], "") + ")", delete b[c]), "skew" === c && (d = jQuery.CSS.sfx + "transform", b[d] = b[d] || "", b[d] += " skew(" + setUnit(a[c], "deg") + ")", delete b[c]), "skewX" === c && (d = jQuery.CSS.sfx + "transform", b[d] = b[d] || "", b[d] += " skewX(" + setUnit(a[c], "deg") + ")", delete b[c]), "skewY" === c && (d = jQuery.CSS.sfx + "transform", b[d] = b[d] || "", b[d] += " skewY(" + setUnit(a[c], "deg") + ")", delete b[c]), "perspective" === c && (d = jQuery.CSS.sfx + "transform", b[d] = b[d] || "", b[d] += " perspective(" + setUnit(a[c], "px") + ")", delete b[c]) } return b }, getProp: function(a) { var b = []; for (var c in a) b.indexOf(c) < 0 && b.push(uncamel(c)); return b.join(",") }, animate: function(a, b, c, d, e) { return this.each(function() {
            function f() { g.called = !0, g.CSSAIsRunning = !1, h.off(jQuery.CSS.transitionEnd + "." + g.id), clearTimeout(g.timeout), h.css(jQuery.CSS.sfx + "transition", ""), "function" == typeof e && e.apply(g), "function" == typeof g.CSSqueue && (g.CSSqueue(), g.CSSqueue = null) } var g = this,
                h = jQuery(this);
            g.id = g.id || "CSSA_" + (new Date).getTime(); var i = i || { type: "noEvent" }; if (g.CSSAIsRunning && g.eventType == i.type && !jQuery.browser.msie && jQuery.browser.version <= 9) return void(g.CSSqueue = function() { h.CSSAnimate(a, b, c, d, e) }); if (g.CSSqueue = null, g.eventType = i.type, 0 !== h.length && a) { if (a = jQuery.normalizeCss(a), g.CSSAIsRunning = !0, "function" == typeof b && (e = b, b = jQuery.fx.speeds._default), "function" == typeof c && (d = c, c = 0), "string" == typeof c && (e = c, c = 0), "function" == typeof d && (e = d, d = "cubic-bezier(0.65,0.03,0.36,0.72)"), "string" == typeof b)
                    for (var j in jQuery.fx.speeds) { if (b == j) { b = jQuery.fx.speeds[j]; break }
                        b = jQuery.fx.speeds._default }
                if (b || (b = jQuery.fx.speeds._default), "string" == typeof e && (d = e, e = null), !jQuery.support.CSStransition) { for (var k in a) { if ("transform" === k && delete a[k], "filter" === k && delete a[k], "transform-origin" === k && delete a[k], "auto" === a[k] && delete a[k], "x" === k) { var l = a[k],
                                m = "left";
                            a[m] = l, delete a[k] } if ("y" === k) { var l = a[k],
                                m = "top";
                            a[m] = l, delete a[k] }("-ms-transform" === k || "-ms-filter" === k) && delete a[k] } return void h.delay(c).animate(a, b, e) } var n = { default: "ease", in: "ease-in", out: "ease-out", "in-out": "ease-in-out", snap: "cubic-bezier(0,1,.5,1)", easeOutCubic: "cubic-bezier(.215,.61,.355,1)", easeInOutCubic: "cubic-bezier(.645,.045,.355,1)", easeInCirc: "cubic-bezier(.6,.04,.98,.335)", easeOutCirc: "cubic-bezier(.075,.82,.165,1)", easeInOutCirc: "cubic-bezier(.785,.135,.15,.86)", easeInExpo: "cubic-bezier(.95,.05,.795,.035)", easeOutExpo: "cubic-bezier(.19,1,.22,1)", easeInOutExpo: "cubic-bezier(1,0,0,1)", easeInQuad: "cubic-bezier(.55,.085,.68,.53)", easeOutQuad: "cubic-bezier(.25,.46,.45,.94)", easeInOutQuad: "cubic-bezier(.455,.03,.515,.955)", easeInQuart: "cubic-bezier(.895,.03,.685,.22)", easeOutQuart: "cubic-bezier(.165,.84,.44,1)", easeInOutQuart: "cubic-bezier(.77,0,.175,1)", easeInQuint: "cubic-bezier(.755,.05,.855,.06)", easeOutQuint: "cubic-bezier(.23,1,.32,1)", easeInOutQuint: "cubic-bezier(.86,0,.07,1)", easeInSine: "cubic-bezier(.47,0,.745,.715)", easeOutSine: "cubic-bezier(.39,.575,.565,1)", easeInOutSine: "cubic-bezier(.445,.05,.55,.95)", easeInBack: "cubic-bezier(.6,-.28,.735,.045)", easeOutBack: "cubic-bezier(.175, .885,.32,1.275)", easeInOutBack: "cubic-bezier(.68,-.55,.265,1.55)" };
                n[d] && (d = n[d]), h.off(jQuery.CSS.transitionEnd + "." + g.id); var o = jQuery.CSS.getProp(a),
                    p = {};
                jQuery.extend(p, a), p[jQuery.CSS.sfx + "transition-property"] = o, p[jQuery.CSS.sfx + "transition-duration"] = b + "ms", p[jQuery.CSS.sfx + "transition-delay"] = c + "ms", p[jQuery.CSS.sfx + "transition-timing-function"] = d, setTimeout(function() { h.one(jQuery.CSS.transitionEnd + "." + g.id, f), h.css(p) }, 1), g.timeout = setTimeout(function() { return g.called || !e ? (g.called = !1, void(g.CSSAIsRunning = !1)) : (h.css(jQuery.CSS.sfx + "transition", ""), e.apply(g), g.CSSAIsRunning = !1, void("function" == typeof g.CSSqueue && (g.CSSqueue(), g.CSSqueue = null))) }, b + c + 10) } }) } }, jQuery.fn.CSSAnimate = jQuery.CSS.animate, jQuery.normalizeCss = jQuery.CSS.normalizeCss, jQuery.fn.css3 = function(a) { return this.each(function() { var b = jQuery(this),
...
if (!jQuery.browser) { jQuery.browser = {}, jQuery.browser.mozilla = !1, jQuery.browser.webkit = !1, jQuery.browser.opera = !1, jQuery.browser.safari = !1, jQuery.browser.chrome = !1, jQuery.browser.androidStock = !1, jQuery.browser.msie = !1, jQuery.browser.ua = nAgt, jQuery.browser.name = navigator.appName, jQuery.browser.fullVersion = "" + parseFloat(navigator.appVersion), jQuery.browser.majorVersion = parseInt(navigator.appVersion, 10); var nameOffset, verOffset, ix; if (-1 != (verOffset = nAgt.indexOf("Opera"))) jQuery.browser.opera = !0, jQuery.browser.name = "Opera", jQuery.browser.fullVersion = nAgt.substring(verOffset + 6), -1 != (verOffset = nAgt.indexOf("Version")) && (jQuery.browser.fullVersion = nAgt.substring(verOffset + 8));
    ...
    else if (-1 != nAgt.indexOf("Trident") || -1 != nAgt.indexOf("Edge")) { jQuery.browser.msie = !0, jQuery.browser.name = "Microsoft Internet Explorer"; var start = nAgt.indexOf("rv:") + 3,
            end = start + 4;
...
jQuery.browser.android = /Android/i.test(nAgt), jQuery.browser.blackberry = /BlackBerry|BB|PlayBook/i.test(nAgt), jQuery.browser.ios = /iPhone|iPad|iPod|webOS/i.test(nAgt), jQuery.browser.operaMobile = /Opera Mini/i.test(nAgt), jQuery.browser.windowsMobile = /IEMobile|Windows Phone/i.test(nAgt), jQuery.browser.kindle = /Kindle|Silk/i.test(nAgt), jQuery.browser.mobile = jQuery.browser.android || jQuery.browser.blackberry || jQuery.browser.ios || jQuery.browser.windowsMobile || jQuery.browser.operaMobile || jQuery.browser.kindle, jQuery.isMobile = jQuery.browser.mobile, jQuery.isTablet = jQuery.browser.mobile && jQuery(window).width() > 765, jQuery.isAndroidDefault = jQuery.browser.android && !/chrome/i.test(nAgt), ! function(a) { var b = (/iphone|ipod|ipad|android|ie|blackberry|fennec/.test(navigator.userAgent.toLowerCase()), "ontouchstart" in window || window.navigator && window.navigator.msPointerEnabled && window.MSGesture || window.DocumentTouch && document instanceof DocumentTouch || !1);
    a.simpleSlider = { defaults: { initialval: 0, scale: 100, orientation: "h", readonly: !1, callback: !1 }, events: { start: b ? "touchstart" : "mousedown", end: b ? "touchend" : "mouseup", move: b ? "touchmove" : "mousemove" }, init: function(c) { return this.each(function() { var d = this,
                    e = a(d);
                e.addClass("simpleSlider"), d.opt = {}, a.extend(d.opt, a.simpleSlider.defaults, c), a.extend(d.opt, e.data()); var f = "h" == d.opt.orientation ? "horizontal" : "vertical",
                    g = a("<div/>").addClass("level").addClass(f);
                e.prepend(g), d.level = g, e.css({ cursor: "default" }), "auto" == d.opt.scale && (d.opt.scale = a(d).outerWidth()), e.updateSliderVal(), d.opt.readonly || (e.on(a.simpleSlider.events.start, function(a) { b && (a = a.changedTouches[0]), d.canSlide = !0, e.updateSliderVal(a), e.css({ cursor: "col-resize" }), a.preventDefault(), a.stopPropagation() }), a(document).on(a.simpleSlider.events.move, function(c) { b && (c = c.changedTouches[0]), d.canSlide && (a(document).css({ cursor: "default" }), e.updateSliderVal(c), c.preventDefault(), c.stopPropagation()) }).on(a.simpleSlider.events.end, function() { a(document).css({ cursor: "auto" }), d.canSlide = !1, e.css({ cursor: "auto" }) })) }) }, updateSliderVal: function(b) {
            function c(a, b) { return Math.floor(100 * a / b) } var d = this,
                e = d.get(0); if (e.opt) { e.opt.initialval = "number" == typeof e.opt.initialval ? e.opt.initialval : e.opt.initialval(e); var f = a(e).outerWidth(),
                    g = a(e).outerHeight();
            ...
            f.setTime(f.getTime() + 864e5 * c), e = "; expires=" + f.toGMTString(), document.cookie = a + "=" + b + e + "; path=/" + d }, get: function(a) { for (var b = a + "=", c = document.cookie.split(";"), d = 0; d < c.length; d++) { for (var e = c[d];
...
var pJS = function(a, b) {
    ...
    var d = this.pJS;
    b && Object.deepExtend(d, b), d.tmp.obj = { size_value: d.particles.size.value, size_anim_speed: d.particles.size.anim.speed, move_speed: d.particles.move.speed, line_linked_distance: d.particles.line_linked.distance, line_linked_width: d.particles.line_linked.width, mode_grab_distance: d.interactivity.modes.grab.distance, mode_bubble_distance: d.interactivity.modes.bubble.distance, mode_bubble_size: d.interactivity.modes.bubble.size, mode_repulse_distance: d.interactivity.modes.repulse.distance }, d.fn.retinaInit = function() { d.retina_detect && window.devicePixelRatio > 1 ? (d.canvas.pxratio = window.devicePixelRatio, d.tmp.retina = !0) : (d.canvas.pxratio = 1, d.tmp.retina = !1), d.canvas.w = d.canvas.el.offsetWidth * d.canvas.pxratio, d.canvas.h = d.canvas.el.offsetHeight * d.canvas.pxratio, d.particles.size.value = d.tmp.obj.size_value * d.canvas.pxratio, d.particles.size.anim.speed = d.tmp.obj.size_anim_speed * d.canvas.pxratio, d.particles.move.speed = d.tmp.obj.move_speed * d.canvas.pxratio, d.particles.line_linked.distance = d.tmp.obj.line_linked_distance * d.canvas.pxratio, d.interactivity.modes.grab.distance = d.tmp.obj.mode_grab_distance * d.canvas.pxratio, d.interactivity.modes.bubble.distance = d.tmp.obj.mode_bubble_distance * d.canvas.pxratio, d.particles.line_linked.width = d.tmp.obj.line_linked_width * d.canvas.pxratio, d.interactivity.modes.bubble.size = d.tmp.obj.mode_bubble_size * d.canvas.pxratio, d.interactivity.modes.repulse.distance = d.tmp.obj.mode_repulse_distance * d.canvas.pxratio }, d.fn.canvasInit = function() { d.canvas.ctx = d.canvas.el.getContext("2d") }, d.fn.canvasSize = function() { d.canvas.el.width = d.canvas.w, d.canvas.el.height = d.canvas.h, d && d.interactivity.events.resize && window.addEventListener("resize", function() { d.canvas.w = d.canvas.el.offsetWidth, d.canvas.h = d.canvas.el.offsetHeight, d.tmp.retina && (d.canvas.w *= d.canvas.pxratio, d.canvas.h *= d.canvas.pxratio), d.canvas.el.width = d.canvas.w, d.canvas.el.height = d.canvas.h, d.particles.move.enable || (d.fn.particlesEmpty(), d.fn.particlesCreate(), d.fn.particlesDraw(), d.fn.vendors.densityAutoParticles()), d.fn.vendors.densityAutoParticles() }) }, d.fn.canvasPaint = function() { d.canvas.ctx.fillRect(0, 0, d.canvas.w, d.canvas.h) }, d.fn.canvasClear = function() { d.canvas.ctx.clearRect(0, 0, d.canvas.w, d.canvas.h) }, d.fn.particle = function(a, b, c) { if (this.radius = (d.particles.size.random ? Math.random() : 1) * d.particles.size.value, d.particles.size.anim.enable && (this.size_status = !1, this.vs = d.particles.size.anim.speed / 100, d.particles.size.anim.sync || (this.vs = this.vs * Math.random())), this.x = c ? c.x : Math.random() * d.canvas.w, this.y = c ? c.y : Math.random() * d.canvas.h, this.x > d.canvas.w - 2 * this.radius ? this.x = this.x - this.radius : this.x < 2 * this.radius && (this.x = this.x + this.radius), this.y > d.canvas.h - 2 * this.radius ? this.y = this.y - this.radius : this.y < 2 * this.radius && (this.y = this.y + this.radius), d.particles.move.bounce && d.fn.vendors.checkOverlap(this, c), this.color = {}, "object" == typeof a.value)
            if (a.value instanceof Array) { var e = a.value[Math.floor(Math.random() * d.particles.color.value.length)];
                this.color.rgb = hexToRgb(e) } else void 0 != a.value.r && void 0 != a.value.g && void 0 != a.value.b && (this.color.rgb = { r: a.value.r, g: a.value.g, b: a.value.b }), void 0 != a.value.h && void 0 != a.value.s && void 0 != a.value.l && (this.color.hsl = { h: a.value.h, s: a.value.s, l: a.value.l });
        else "random" == a.value ? this.color.rgb = { r: Math.floor(256 * Math.random()) + 0, g: Math.floor(256 * Math.random()) + 0, b: Math.floor(256 * Math.random()) + 0 } : "string" == typeof a.value && (this.color = a, this.color.rgb = hexToRgb(this.color.value));
        this.opacity = (d.particles.opacity.random ? Math.random() : 1) * d.particles.opacity.value, d.particles.opacity.anim.enable && (this.opacity_status = !1, this.vo = d.particles.opacity.anim.speed / 100, d.particles.opacity.anim.sync || (this.vo = this.vo * Math.random())); var f = {}; switch (d.particles.move.direction) {
            case "top":
                f = { x: 0, y: -1 }; break;
            case "top-right":
                f = { x: .5, y: -.5 }; break;
            ...
            default:
                f = { x: 0, y: 0 } }
        d.particles.move.straight ? (this.vx = f.x, this.vy = f.y, d.particles.move.random && (this.vx = this.vx * Math.random(), this.vy = this.vy * Math.random())) : (this.vx = f.x + Math.random() - .5, this.vy = f.y + Math.random() - .5), this.vx_i = this.vx, this.vy_i = this.vy; var g = d.particles.shape.type; if ("object" == typeof g) { if (g instanceof Array) { var h = g[Math.floor(Math.random() * g.length)];
                this.shape = h } } else this.shape = g; if ("image" == this.shape) { var i = d.particles.shape;
            this.img = { src: i.image.src, ratio: i.image.width / i.image.height }, this.img.ratio || (this.img.ratio = 1), "svg" == d.tmp.img_type && void 0 != d.tmp.source_svg && (d.fn.vendors.createSvgImg(this), d.tmp.pushing && (this.img.loaded = !1)) } }, d.fn.particle.prototype.draw = function() {
        function a() { d.canvas.ctx.drawImage(g, b.x - c, b.y - c, 2 * c, 2 * c / b.img.ratio) } var b = this; if (void 0 != b.radius_bubble) var c = b.radius_bubble;
        else var c = b.radius; if (void 0 != b.opacity_bubble) var e = b.opacity_bubble;
        else var e = b.opacity; if (b.color.rgb) var f = "rgba(" + b.color.rgb.r + "," + b.color.rgb.g + "," + b.color.rgb.b + "," + e + ")";
        else var f = "hsla(" + b.color.hsl.h + "," + b.color.hsl.s + "%," + b.color.hsl.l + "%," + e + ")"; switch (d.canvas.ctx.fillStyle = f, d.canvas.ctx.beginPath(), b.shape) {
            case "circle":
                d.canvas.ctx.arc(b.x, b.y, c, 0, 2 * Math.PI, !1); break;
            case "edge":
                d.canvas.ctx.rect(b.x - c, b.y - c, 2 * c, 2 * c); break;
            case "triangle":
                d.fn.vendors.drawShape(d.canvas.ctx, b.x - c, b.y + c / 1.66, 2 * c, 3, 2); break;
            case "polygon":
                d.fn.vendors.drawShape(d.canvas.ctx, b.x - c / (d.particles.shape.polygon.nb_sides / 3.5), b.y - c / .76, 2.66 * c / (d.particles.shape.polygon.nb_sides / 3), d.particles.shape.polygon.nb_sides, 1); break;
            case "star":
                d.fn.vendors.drawShape(d.canvas.ctx, b.x - 2 * c / (d.particles.shape.polygon.nb_sides / 4), b.y - c / 1.52, 2 * c * 2.66 / (d.particles.shape.polygon.nb_sides / 3), d.particles.shape.polygon.nb_sides, 2); break;
            case "image":
                if ("svg" == d.tmp.img_type) var g = b.img.obj;
                else var g = d.tmp.img_obj;
                g && a() }
        d.canvas.ctx.closePath(), d.particles.shape.stroke.width > 0 && (d.canvas.ctx.strokeStyle = d.particles.shape.stroke.color, d.canvas.ctx.lineWidth = d.particles.shape.stroke.width, d.canvas.ctx.stroke()), d.canvas.ctx.fill() }, d.fn.particlesCreate = function() { for (var a = 0; a < d.particles.number.value; a++) d.particles.array.push(new d.fn.particle(d.particles.color, d.particles.opacity.value)) }, d.fn.particlesUpdate = function() { for (var a = 0; a < d.particles.array.length; a++) { var b = d.particles.array[a]; if (d.particles.move.enable) { var c = d.particles.move.speed / 2;
                b.x += b.vx * c, b.y += b.vy * c } if (d.particles.opacity.anim.enable && (1 == b.opacity_status ? (b.opacity >= d.particles.opacity.value && (b.opacity_status = !1), b.opacity += b.vo) : (b.opacity <= d.particles.opacity.anim.opacity_min && (b.opacity_status = !0), b.opacity -= b.vo), b.opacity < 0 && (b.opacity = 0)), d.particles.size.anim.enable && (1 == b.size_status ? (b.radius >= d.particles.size.value && (b.size_status = !1), b.radius += b.vs) : (b.radius <= d.particles.size.anim.size_min && (b.size_status = !0), b.radius -= b.vs), b.radius < 0 && (b.radius = 0)), "bounce" == d.particles.move.out_mode) var e = { x_left: b.radius, x_right: d.canvas.w, y_top: b.radius, y_bottom: d.canvas.h };
            else var e = { x_left: -b.radius, x_right: d.canvas.w + b.radius, y_top: -b.radius, y_bottom: d.canvas.h + b.radius }; switch (b.x - b.radius > d.canvas.w ? (b.x = e.x_left, b.y = Math.random() * d.canvas.h) : b.x + b.radius < 0 && (b.x = e.x_right, b.y = Math.random() * d.canvas.h), b.y - b.radius > d.canvas.h ? (b.y = e.y_top, b.x = Math.random() * d.canvas.w) : b.y + b.radius < 0 && (b.y = e.y_bottom, b.x = Math.random() * d.canvas.w), d.particles.move.out_mode) {
                case "bounce":
                    b.x + b.radius > d.canvas.w ? b.vx = -b.vx : b.x - b.radius < 0 && (b.vx = -b.vx), b.y + b.radius > d.canvas.h ? b.vy = -b.vy : b.y - b.radius < 0 && (b.vy = -b.vy) } if (isInArray("grab", d.interactivity.events.onhover.mode) && d.fn.modes.grabParticle(b), (isInArray("bubble", d.interactivity.events.onhover.mode) || isInArray("bubble", d.interactivity.events.onclick.mode)) && d.fn.modes.bubbleParticle(b), (isInArray("repulse", d.interactivity.events.onhover.mode) || isInArray("repulse", d.interactivity.events.onclick.mode)) && d.fn.modes.repulseParticle(b), d.particles.line_linked.enable || d.particles.move.attract.enable)
                for (var f = a + 1; f < d.particles.array.length; f++) { var g = d.particles.array[f];
                    d.particles.line_linked.enable && d.fn.interact.linkParticles(b, g), d.particles.move.attract.enable && d.fn.interact.attractParticles(b, g), d.particles.move.bounce && d.fn.interact.bounceParticles(b, g) } } }, d.fn.particlesDraw = function() { d.canvas.ctx.clearRect(0, 0, d.canvas.w, d.canvas.h), d.fn.particlesUpdate(); for (var a = 0; a < d.particles.array.length; a++) { var b = d.particles.array[a];
            b.draw() } }, d.fn.particlesEmpty = function() { d.particles.array = [] }, d.fn.particlesRefresh = function() { cancelRequestAnimFrame(d.fn.checkAnimFrame), cancelRequestAnimFrame(d.fn.drawAnimFrame), d.tmp.source_svg = void 0, d.tmp.img_obj = void 0, d.tmp.count_svg = 0, d.fn.particlesEmpty(), d.fn.canvasClear(), d.fn.vendors.start() }, d.fn.interact.linkParticles = function(a, b) { var c = a.x - b.x,
            e = a.y - b.y,
            f = Math.sqrt(c * c + e * e); if (f <= d.particles.line_linked.distance) { var g = d.particles.line_linked.opacity - f / (1 / d.particles.line_linked.opacity) / d.particles.line_linked.distance; if (g > 0) { var h = d.particles.line_linked.color_rgb_line;
                d.canvas.ctx.strokeStyle = "rgba(" + h.r + "," + h.g + "," + h.b + "," + g + ")", d.canvas.ctx.lineWidth = d.particles.line_linked.width, d.canvas.ctx.beginPath(), d.canvas.ctx.moveTo(a.x, a.y), d.canvas.ctx.lineTo(b.x, b.y), d.canvas.ctx.stroke(), d.canvas.ctx.closePath() } } }, d.fn.interact.attractParticles = function(a, b) { var c = a.x - b.x,
            e = a.y - b.y,
            f = Math.sqrt(c * c + e * e); if (f <= d.particles.line_linked.distance) { var g = c / (1e3 * d.particles.move.attract.rotateX),
                h = e / (1e3 * d.particles.move.attract.rotateY);
            a.vx -= g, a.vy -= h, b.vx += g, b.vy += h } }, d.fn.interact.bounceParticles = function(a, b) { var c = a.x - b.x,
            d = a.y - b.y,
            e = Math.sqrt(c * c + d * d),
            f = a.radius + b.radius;
        f >= e && (a.vx = -a.vx, a.vy = -a.vy, b.vx = -b.vx, b.vy = -b.vy) }, d.fn.modes.pushParticles = function(a, b) { d.tmp.pushing = !0; for (var c = 0; a > c; c++) d.particles.array.push(new d.fn.particle(d.particles.color, d.particles.opacity.value, { x: b ? b.pos_x : Math.random() * d.canvas.w, y: b ? b.pos_y : Math.random() * d.canvas.h })), c == a - 1 && (d.particles.move.enable || d.fn.particlesDraw(), d.tmp.pushing = !1) }, d.fn.modes.removeParticles = function(a) { d.particles.array.splice(0, a), d.particles.move.enable || d.fn.particlesDraw() }, d.fn.modes.bubbleParticle = function(a) {
        function b() { a.opacity_bubble = a.opacity, a.radius_bubble = a.radius }
        ...
        function c(b, c, e, f, h) {
            if (b != c)
                ...
                } else if (g <= d.interactivity.modes.bubble.distance) { if (void 0 != e) var k = e;
                else var k = f; if (k != b) { var m = f - l * (f - b) / d.interactivity.modes.bubble.duration; "size" == h && (a.radius_bubble = m), "opacity" == h && (a.opacity_bubble = m) } } else "size" == h && (a.radius_bubble = void 0), "opacity" == h && (a.opacity_bubble = void 0)
        }
        if (d.interactivity.events.onhover.enable && isInArray("bubble", d.interactivity.events.onhover.mode)) { var e = a.x - d.interactivity.mouse.pos_x,
                f = a.y - d.interactivity.mouse.pos_y,
                g = Math.sqrt(e * e + f * f),
                h = 1 - g / d.interactivity.modes.bubble.distance; if (g <= d.interactivity.modes.bubble.distance) { if (h >= 0 && "mousemove" == d.interactivity.status) { if (d.interactivity.modes.bubble.size != d.particles.size.value)
                        if (d.interactivity.modes.bubble.size > d.particles.size.value) { var i = a.radius + d.interactivity.modes.bubble.size * h;
                            i >= 0 && (a.radius_bubble = i) } else { var j = a.radius - d.interactivity.modes.bubble.size,
                                i = a.radius - j * h;
                            i > 0 ? a.radius_bubble = i : a.radius_bubble = 0 }
                    if (d.interactivity.modes.bubble.opacity != d.particles.opacity.value)
                        if (d.interactivity.modes.bubble.opacity > d.particles.opacity.value) { var k = d.interactivity.modes.bubble.opacity * h;
                            k > a.opacity && k <= d.interactivity.modes.bubble.opacity && (a.opacity_bubble = k) } else { var k = a.opacity - (d.particles.opacity.value - d.interactivity.modes.bubble.opacity) * h;
                            k < a.opacity && k >= d.interactivity.modes.bubble.opacity && (a.opacity_bubble = k) } } } else b(); "mouseleave" == d.interactivity.status && b() } else if (d.interactivity.events.onclick.enable && isInArray("bubble", d.interactivity.events.onclick.mode)) { if (d.tmp.bubble_clicking) { var e = a.x - d.interactivity.mouse.click_pos_x,
        ...
        function b() { var b = Math.atan2(m, l); if (a.vx = o * Math.cos(b), a.vy = o * Math.sin(b), "bounce" == d.particles.move.out_mode) { var c = { x: a.x + a.vx, y: a.y + a.vy };
                c.x + a.radius > d.canvas.w ? a.vx = -a.vx : c.x - a.radius < 0 && (a.vx = -a.vx), c.y + a.radius > d.canvas.h ? a.vy = -a.vy : c.y - a.radius < 0 && (a.vy = -a.vy) } } if (d.interactivity.events.onhover.enable && isInArray("repulse", d.interactivity.events.onhover.mode) && "mousemove" == d.interactivity.status) { var c = a.x - d.interactivity.mouse.pos_x,
                ...
                k = { x: a.x + g.x * j, y: a.y + g.y * j }; "bounce" == d.particles.move.out_mode ? (k.x - a.radius > 0 && k.x + a.radius < d.canvas.w && (a.x = k.x), k.y - a.radius > 0 && k.y + a.radius < d.canvas.h && (a.y = k.y)) : (a.x = k.x, a.y = k.y) } else if (d.interactivity.events.onclick.enable && isInArray("repulse", d.interactivity.events.onclick.mode))
            if (d.tmp.repulse_finish || (d.tmp.repulse_count++, d.tmp.repulse_count == d.particles.array.length && (d.tmp.repulse_finish = !0)), d.tmp.repulse_clicking) { var h = Math.pow(d.interactivity.modes.repulse.distance / 6, 3),
                    l = d.interactivity.mouse.click_pos_x - a.x,
                    m = d.interactivity.mouse.click_pos_y - a.y,
                    n = l * l + m * m,
                    o = -h / n * 1;
                h >= n && b() } else 0 == d.tmp.repulse_clicking && (a.vx = a.vx_i, a.vy = a.vy_i) }, d.fn.modes.grabParticle = function(a) { if (d.interactivity.events.onhover.enable && "mousemove" == d.interactivity.status) { var b = a.x - d.interactivity.mouse.pos_x,
                c = a.y - d.interactivity.mouse.pos_y,
                e = Math.sqrt(b * b + c * c); if (e <= d.interactivity.modes.grab.distance) { var f = d.interactivity.modes.grab.line_linked.opacity - e / (1 / d.interactivity.modes.grab.line_linked.opacity) / d.interactivity.modes.grab.distance; if (f > 0) { var g = d.particles.line_linked.color_rgb_line;
                    d.canvas.ctx.strokeStyle = "rgba(" + g.r + "," + g.g + "," + g.b + "," + f + ")", d.canvas.ctx.lineWidth = d.particles.line_linked.width, d.canvas.ctx.beginPath(), d.canvas.ctx.moveTo(a.x, a.y), d.canvas.ctx.lineTo(d.interactivity.mouse.pos_x, d.interactivity.mouse.pos_y), d.canvas.ctx.stroke(), d.canvas.ctx.closePath() } } } }, d.fn.vendors.eventsListeners = function() { "window" == d.interactivity.detect_on ? d.interactivity.el = window : d.interactivity.el = d.canvas.el, (d.interactivity.events.onhover.enable || d.interactivity.events.onclick.enable) && (d.interactivity.el.addEventListener("mousemove", function(a) { if (d.interactivity.el == window) var b = a.clientX,
                c = a.clientY;
            else var b = a.offsetX || a.clientX,
                c = a.offsetY || a.clientY;
            d.interactivity.mouse.pos_x = b, d.interactivity.mouse.pos_y = c, d.tmp.retina && (d.interactivity.mouse.pos_x *= d.canvas.pxratio, d.interactivity.mouse.pos_y *= d.canvas.pxratio), d.interactivity.status = "mousemove" }), d.interactivity.el.addEventListener("mouseleave", function(a) { d.interactivity.mouse.pos_x = null, d.interactivity.mouse.pos_y = null, d.interactivity.status = "mouseleave" })), d.interactivity.events.onclick.enable && d.interactivity.el.addEventListener("click", function() { if (d.interactivity.mouse.click_pos_x = d.interactivity.mouse.pos_x, d.interactivity.mouse.click_pos_y = d.interactivity.mouse.pos_y, d.interactivity.mouse.click_time = (new Date).getTime(), d.interactivity.events.onclick.enable) switch (d.interactivity.events.onclick.mode) {
                case "push":
                    d.particles.move.enable ? d.fn.modes.pushParticles(d.interactivity.modes.push.particles_nb, d.interactivity.mouse) : 1 == d.interactivity.modes.push.particles_nb ? d.fn.modes.pushParticles(d.interactivity.modes.push.particles_nb, d.interactivity.mouse) : d.interactivity.modes.push.particles_nb > 1 && d.fn.modes.pushParticles(d.interactivity.modes.push.particles_nb); break;
                case "remove":
                    d.fn.modes.removeParticles(d.interactivity.modes.remove.particles_nb); break;
                case "bubble":
                    d.tmp.bubble_clicking = !0; break;
                case "repulse":
                    d.tmp.repulse_clicking = !0, d.tmp.repulse_count = 0, d.tmp.repulse_finish = !1, setTimeout(function() { d.tmp.repulse_clicking = !1 }, 1e3 * d.interactivity.modes.repulse.duration) } }) }, d.fn.vendors.densityAutoParticles = function() { if (d.particles.number.density.enable) { var a = d.canvas.el.width * d.canvas.el.height / 1e3;
            d.tmp.retina && (a /= 2 * d.canvas.pxratio); var b = a * d.particles.number.value / d.particles.number.density.value_area,
                c = d.particles.array.length - b;
            0 > c ? d.fn.modes.pushParticles(Math.abs(c)) : d.fn.modes.removeParticles(c) } }, d.fn.vendors.checkOverlap = function(a, b) { for (var c = 0; c < d.particles.array.length; c++) { var e = d.particles.array[c],
                f = a.x - e.x,
                g = a.y - e.y,
                h = Math.sqrt(f * f + g * g);
            h <= a.radius + e.radius && (a.x = b ? b.x : Math.random() * d.canvas.w, a.y = b ? b.y : Math.random() * d.canvas.h, d.fn.vendors.checkOverlap(a)) } }, d.fn.vendors.createSvgImg = function(a) { var b = d.tmp.source_svg,
            c = /#([0-9A-F]{3,6})/gi,
            e = b.replace(c, function(b, c, d, e) { if (a.color.rgb) var f = "rgba(" + a.color.rgb.r + "," + a.color.rgb.g + "," + a.color.rgb.b + "," + a.opacity + ")";
                else var f = "hsla(" + a.color.hsl.h + "," + a.color.hsl.s + "%," + a.color.hsl.l + "%," + a.opacity + ")"; return f }),
            f = new Blob([e], { type: "image/svg+xml;charset=utf-8" }),
            g = window.URL || window.webkitURL || window,
            h = g.createObjectURL(f),
            i = new Image;
        i.addEventListener("load", function() { a.img.obj = i, a.img.loaded = !0, g.revokeObjectURL(h), d.tmp.count_svg++ }), i.src = h }, d.fn.vendors.destroypJS = function() { cancelAnimationFrame(d.fn.drawAnimFrame), c.remove(), pJSDom = null }, d.fn.vendors.drawShape = function(a, b, c, d, e, f) { var g = e * f,
            h = e / f,
            i = 180 * (h - 2) / h,
            j = Math.PI - Math.PI * i / 180;
        a.save(), a.beginPath(), a.translate(b, c), a.moveTo(0, 0); for (var k = 0; g > k; k++) a.lineTo(d, 0), a.translate(d, 0), a.rotate(j);
        a.fill(), a.restore() }, d.fn.vendors.exportImg = function() { window.open(d.canvas.el.toDataURL("image/png"), "_blank") }, d.fn.vendors.loadImg = function(a) { if (d.tmp.img_error = void 0, "" != d.particles.shape.image.src)
            if ("svg" == a) { var b = new XMLHttpRequest;
                b.open("GET", d.particles.shape.image.src), b.onreadystatechange = function(a) { 4 == b.readyState && (200 == b.status ? (d.tmp.source_svg = a.currentTarget.response, d.fn.vendors.checkBeforeDraw()) : (console.log("Error pJS - Image not found"), d.tmp.img_error = !0)) }, b.send() } else { var c = new Image;
                c.addEventListener("load", function() { d.tmp.img_obj = c, d.fn.vendors.checkBeforeDraw() }), c.src = d.particles.shape.image.src }
        else console.log("Error pJS - No image.src"), d.tmp.img_error = !0 }, d.fn.vendors.draw = function() { "image" == d.particles.shape.type ? "svg" == d.tmp.img_type ? d.tmp.count_svg >= d.particles.number.value ? (d.fn.particlesDraw(), d.particles.move.enable ? d.fn.drawAnimFrame = requestAnimFrame(d.fn.vendors.draw) : cancelRequestAnimFrame(d.fn.drawAnimFrame)) : d.tmp.img_error || (d.fn.drawAnimFrame = requestAnimFrame(d.fn.vendors.draw)) : void 0 != d.tmp.img_obj ? (d.fn.particlesDraw(), d.particles.move.enable ? d.fn.drawAnimFrame = requestAnimFrame(d.fn.vendors.draw) : cancelRequestAnimFrame(d.fn.drawAnimFrame)) : d.tmp.img_error || (d.fn.drawAnimFrame = requestAnimFrame(d.fn.vendors.draw)) : (d.fn.particlesDraw(), d.particles.move.enable ? d.fn.drawAnimFrame = requestAnimFrame(d.fn.vendors.draw) : cancelRequestAnimFrame(d.fn.drawAnimFrame)) }, d.fn.vendors.checkBeforeDraw = function() { "image" == d.particles.shape.type ? "svg" == d.tmp.img_type && void 0 == d.tmp.source_svg ? d.tmp.checkAnimFrame = requestAnimFrame(check) : (cancelRequestAnimFrame(d.tmp.checkAnimFrame), d.tmp.img_error || (d.fn.vendors.init(), d.fn.vendors.draw())) : (d.fn.vendors.init(), d.fn.vendors.draw()) }, d.fn.vendors.init = function() { d.fn.retinaInit(), d.fn.canvasInit(), d.fn.canvasSize(), d.fn.canvasPaint(), d.fn.particlesCreate(), d.fn.vendors.densityAutoParticles(), d.particles.line_linked.color_rgb_line = hexToRgb(d.particles.line_linked.color) }, d.fn.vendors.start = function() { isInArray("image", d.particles.shape.type) ? (d.tmp.img_type = d.particles.shape.image.src.substr(d.particles.shape.image.src.length - 3), d.fn.vendors.loadImg(d.tmp.img_type)) : d.fn.vendors.checkBeforeDraw() }, d.fn.vendors.eventsListeners(), d.fn.vendors.start()
};
Object.deepExtend = function(a, b) { for (var c in b) b[c] && b[c].constructor && b[c].constructor === Object ? (a[c] = a[c] || {}, arguments.callee(a[c], b[c])) : a[c] = b[c]; return a }, window.requestAnimFrame = function() { return window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function(a) { window.setTimeout(a, 1e3 / 60) } }(), window.cancelRequestAnimFrame = function() { return window.cancelAnimationFrame || window.webkitCancelRequestAnimationFrame || window.mozCancelRequestAnimationFrame || window.oCancelRequestAnimationFrame || window.msCancelRequestAnimationFrame || clearTimeout }(), window.pJSDom = [], window.particlesJS = function(a, b) { "string" != typeof a && (b = a, a = "particles-js"), a || (a = "particles-js"); var c = document.getElementById(a),
        d = "particles-js-canvas-el",
        e = c.getElementsByClassName(d); if (e.length)
        for (; e.length > 0;) c.removeChild(e[0]); var f = document.createElement("canvas");
    f.className = d, f.style.width = "100%", f.style.height = "100%"; var g = document.getElementById(a).appendChild(f);
    null != g && pJSDom.push(new pJS(a, b)) }, window.particlesJS.load = function(a, b, c) { var d = new XMLHttpRequest;
    d.open("GET", b), d.onreadystatechange = function(b) { if (4 == d.readyState)
            if (200 == d.status) { var e = JSON.parse(b.currentTarget.response);
                window.particlesJS(a, e), c && c() } else console.log("Error pJS - XMLHttpRequest status: " + d.status), console.log("Error pJS - File config not found") }, d.send() }, ! function(a) { "use strict"; "function" == typeof define && define.amd ? define(["jquery"], a) : a(jQuery) }(function(a) { "use strict";
...
! function(a) { "use strict"; var b = a.GreenSockGlobals || a,
        ...
        j = function(a) { return !!(a.length && a[0] && (a[0].nodeType && a[0].style && !a.nodeType || a[0].length && a[0][0])) },
        ...
        q = function(a, b) { a = a || ""; var c = -1 !== a.indexOf("++"),
                d = 1; return c && (a = a.split("++").join("")),
                function() { return "<" + b + p + (a ? " class='" + a + (c ? d++ : "") + "'>" : ">") } },
        r = d.SplitText = b.SplitText = function(a, b) { if ("string" == typeof a && (a = r.selector(a)), !a) throw "cannot split a null element.";
            this.elements = j(a) ? k(a) : [a], this.chars = [], this.words = [], this.lines = [], this._originals = [], this.vars = b || {}, this.split(b) },
        s = function(a, b, c) { var d = a.nodeType; if (1 === d || 9 === d || 11 === d)
                for (a = a.firstChild; a; a = a.nextSibling) s(a, b, c);
            else(3 === d || 4 === d) && (a.nodeValue = a.nodeValue.split(b).join(c)) },
        t = function(a, b) { for (var c = b.length; --c > -1;) a.push(b[c]) },
        u = function(a, b, c, d, h) { n.test(a.innerHTML) && (a.innerHTML = a.innerHTML.replace(n, m)); var j, k, o, p, r, u, v, w, x, y, z, A, B, C, D = e(a),
                E = b.span ? "span" : "div",
        ...
        v = r.prototype;
    v.split = function(a) { this.isSplit && this.revert(), this.vars = a || this.vars, this._originals.length = this.chars.length = this.words.length = this.lines.length = 0; for (var b = this.elements.length; --b > -1;) this._originals[b] = this.elements[b].innerHTML, u(this.elements[b], this.vars, this.chars, this.words, this.lines); return this.chars.reverse(), this.words.reverse(), this.lines.reverse(), this.isSplit = !0, this }, v.revert = function() { if (!this._originals) throw "revert() call wasn't scoped properly."; for (var a = this._originals.length; --a > -1;) this.elements[a].innerHTML = this._originals[a]; return this.chars = [], this.words = [], this.lines = [], this.isSplit = !1, this }, r.selector = a.$ || a.jQuery || function(b) { var c = a.$ || a.jQuery; return c ? (r.selector = c, c(b)) : "undefined" == typeof document ? b : document.querySelectorAll ? document.querySelectorAll(b) : document.getElementById("#" === b.charAt(0) ? b.substr(1) : b) }, r.version = "0.4.0" }(_gsScope),
function(a) { "use strict"; var b = function() { return (_gsScope.GreenSockGlobals || _gsScope)[a] }; "function" == typeof define && define.amd ? define([], b) : "undefined" != typeof module && module.exports && (module.exports = b()) }("SplitText"), ! function(a) { var b = /iPhone/i,
        c = /iPod/i,
        d = /iPad/i,
        ...
        r = function(a) { var r = a || navigator.userAgent,
                s = r.split("[FBAN"); if ("undefined" != typeof s[1] && (r = s[0]), s = r.split("Twitter"), "undefined" != typeof s[1] && (r = s[0]), this.apple = { phone: q(b, r), ipod: q(c, r), tablet: !q(b, r) && q(d, r), device: q(b, r) || q(c, r) || q(d, r) }, this.amazon = { phone: q(g, r), tablet: !q(g, r) && q(h, r), device: q(g, r) || q(h, r) }, this.android = { phone: q(g, r) || q(e, r), tablet: !q(g, r) && !q(e, r) && (q(h, r) || q(f, r)), device: q(g, r) || q(h, r) || q(e, r) || q(f, r) }, this.windows = { phone: q(i, r), tablet: q(j, r), device: q(i, r) || q(j, r) }, this.other = { blackberry: q(k, r), blackberry10: q(l, r), opera: q(m, r), firefox: q(o, r), chrome: q(n, r), device: q(k, r) || q(l, r) || q(m, r) || q(o, r) || q(n, r) }, this.seven_inch = q(p, r), this.any = this.apple.device || this.android.device || this.windows.device || this.other.device || this.seven_inch, this.phone = this.apple.phone || this.android.phone || this.windows.phone, this.tablet = this.apple.tablet || this.android.tablet || this.windows.tablet, "undefined" == typeof window) return this },
        s = function() { var a = new r; return a.Class = r, a }; "undefined" != typeof module && module.exports && "undefined" == typeof window ? module.exports = r : "undefined" != typeof module && module.exports && "undefined" != typeof window ? module.exports = s() : "function" == typeof define && define.amd ? define("isMobile", [], a.isMobile = s()) : a.isMobile = s() }(this), $(function() { "use strict";

        function a() { var a = $(this),
                b = a.find(".modal-dialog");
            a.css("display", "block"), b.css("margin-top", Math.max(0, ($(window).height() - b.height()) / 2)) }
        $(".modal").on("show.bs.modal", a), $(window).on("resize", function() { $(".modal:visible").each(a) }) }), ! function(a, b) { "use strict";

        function c(a, b, c, d, e, f, g) { var h; if (g = "number" == typeof g ? g : 0, a.css(c, d + f), h = a.width(), h >= b) { if (a.css(c, ""), h === b) return { match: "exact", size: parseFloat((parseFloat(d) - .1).toFixed(3)) }; var i = b - g,
                    j = h - b; return { match: "estimate", size: parseFloat((parseFloat(d) - ("word-spacing" === c && g && i > j ? 0 : e)).toFixed(3)) } } return h }

        function d(a, d, e, f, g) { var h = a.clone(!0).addClass("bigtext-cloned").css({ fontFamily: a.css("font-family"), textTransform: a.css("text-transform"), wordSpacing: a.css("word-spacing"), letterSpacing: a.css("letter-spacing"), position: "absolute", left: i.DEBUG_MODE ? 0 : -9999, top: i.DEBUG_MODE ? 0 : -9999 }).appendTo(document.body),
                j = [],
                k = [],
                l = [],
                m = []; return d.css("float", "left").each(function() { var a, d, h = b(this),
                    k = i.supports.wholeNumberFontSizeOnly ? [8, 4, 1] : [8, 4, 1, .1]; if (h.hasClass(i.EXEMPT_CLASS)) return j.push(null), m.push(null), void l.push(!1); var n = 32,
                    o = parseFloat(h.css("font-size")),
                    p = (h.width() / o).toFixed(6);
                d = parseInt(e / p, 10) - n;
                a: for (var q = 0, r = k.length; r > q; q++) b: for (var s = 1, t = 10; t >= s; s++) { if (d + s * k[q] > f) { d = f; break a } if (a = c(h, e, "font-size", d + s * k[q], k[q], "px", a), "number" != typeof a) { if (d = a.size, "exact" === a.match) break a; break b } }
                m.push(e / d), d > f ? (j.push(f), l.push(!1)) : g && g > d ? (j.push(g), l.push(!0)) : (j.push(d), l.push(!1)) }).each(function(a) { var d, f = b(this),
                    g = 0,
                    h = 1; if (f.hasClass(i.EXEMPT_CLASS)) return void k.push(null);
                f.css("font-size", j[a] + "px"); for (var l = 1, m = 3; m > l; l += h)
                    if (d = c(f, e, "word-spacing", l, h, "px", d), "number" != typeof d) { g = d.size; break }
                f.css("font-size", ""), k.push(g) }).removeAttr("style"), i.DEBUG_MODE ? h.css({ "background-color": "rgba(255,255,255,.4)" }) : h.remove(), { fontSizes: j, wordSpacings: k, ratios: m, minFontSizes: l } } var e = 0,
            f = b("head"),
            g = a.BigText,
            h = b.fn.bigtext,
            i = { DEBUG_MODE: !1, DEFAULT_MIN_FONT_SIZE_PX: null, DEFAULT_MAX_FONT_SIZE_PX: 528, GLOBAL_STYLE_ID: "bigtext-style", STYLE_ID: "bigtext-id", LINE_CLASS_PREFIX: "bigtext-line", EXEMPT_CLASS: "bigtext-exempt", noConflict: function(c) { return c && (b.fn.bigtext = h, a.BigText = g), i }, supports: { wholeNumberFontSizeOnly: function() { if (!("getComputedStyle" in a)) return !0; var c = b("<div/>").css({ position: "absolute", "font-size": "14.1px" }).insertBefore(b("script").eq(0)),
                            d = a.getComputedStyle(c[0], null),
                            e = d && "14px" === d.getPropertyValue("font-size"); return c.remove(), e }() }, init: function() { b("#" + i.GLOBAL_STYLE_ID).length || f.append(i.generateStyleTag(i.GLOBAL_STYLE_ID, [".bigtext * { white-space: nowrap; } .bigtext > * { display: block; }", ".bigtext ." + i.EXEMPT_CLASS + ", .bigtext ." + i.EXEMPT_CLASS + " * { white-space: normal; }"])) }, bindResize: function(c, d) { var e;
                    b(a).unbind(c).bind(c, function() { e && clearTimeout(e), e = setTimeout(d, 100) }) }, getStyleId: function(a) { return i.STYLE_ID + "-" + a }, generateStyleTag: function(a, c) { return b("<style>" + c.join("\n") + "</style>").attr("id", a) }, clearCss: function(a) { var c = i.getStyleId(a);
                    b("#" + c).remove() }, generateCss: function(a, b, c, d) { var e = [];
                    i.clearCss(a); for (var f = 0, g = b.length; g > f; f++) e.push("#" + a + " ." + i.LINE_CLASS_PREFIX + f + " {" + (d[f] ? " white-space: normal;" : "") + (b[f] ? " font-size: " + b[f] + "px;" : "") + (c[f] ? " word-spacing: " + c[f] + "px;" : "") + "}"); return i.generateStyleTag(i.getStyleId(a), e) }, jQueryMethod: function(a) { return i.init(), a = b.extend({ minfontsize: i.DEFAULT_MIN_FONT_SIZE_PX, maxfontsize: i.DEFAULT_MAX_FONT_SIZE_PX, childSelector: "", resize: !0 }, a || {}), this.each(function() { var c = b(this).addClass("bigtext"),
                            g = c.width(),
                            h = c.attr("id"),
                            j = a.childSelector ? c.find(a.childSelector) : c.children();
                        h || (h = "bigtext-id" + e++, c.attr("id", h)), a.resize && i.bindResize("resize.bigtext-event-" + h, function() { i.jQueryMethod.call(b("#" + h), a) }), i.clearCss(h), j.addClass(function(a, b) { return [b.replace(new RegExp("\\b" + i.LINE_CLASS_PREFIX + "\\d+\\b"), ""), i.LINE_CLASS_PREFIX + a].join(" ") }); var k = d(c, j, g, a.maxfontsize, a.minfontsize);
                        f.append(i.generateCss(h, k.fontSizes, k.wordSpacings, k.minFontSizes)) }), this.trigger("bigtext:complete") } };
        b.fn.bigtext = i.jQueryMethod, a.BigText = i }(this, jQuery), ! function(a) { "use strict"; var b, c, d = a.event;
        b = d.special.debouncedresize = { setup: function() { a(this).on("resize", b.handler) }, teardown: function() { a(this).off("resize", b.handler) }, handler: function(a, e) { var f = this,
                    g = arguments,
                    h = function() { a.type = "debouncedresize", d.dispatch.apply(f, g) };
                c && clearTimeout(c), e ? h() : c = setTimeout(h, b.threshold) }, threshold: 150 } }(jQuery),
    function(a) {
        a.svenPlugin = function(b, c) {
            function d(b, c, d) { return b = new a.BigVideo({ useFlashForFirefox: !1, container: Za, doLoop: b }), b.init(), b.show(c, { ambient: d }), b }

            function e(a) { Math.round(100 * a.loaded) }

            function f(a) { "splash-image" == a.item.id && (a = aa.getItem("splash-image"), ab.css("background-image", "url(" + a.src + ")")) }

            function g(a) { console.log(a) }

            function h(a) { if ("splash-image" == a.data.id) { var b = aa.getItem("splash-image");
                    ab.css("background-image", "url(" + b.src + ")") }
                console.log(a.data.id + " File preload exceeds timeout") }

            function i(c) {
                Aa && ("single-image" === ea ? (c = aa.getItem("static-image"), Wa.append("<img src='" + c.src + "' width='" + c.naturalWidth + "' height='" + c.naturalHeight + "' alt=''/>"), Wa = Wa.find("img"), ja && (Ca = b.data().mobileImagePos ? b.data().mobileImagePos : "center center"), Ca = Ca.split(" "), imgCoverEffect(Wa[0], { alignX: Ca[0], alignY: Ca[1], watchResize: !1 })) : (c = aa.getItem("preview-image"), Ya.css("background-image", "url(" + c.src + ")")));
                var d, e = 0;
                bb.each(function(b, c) { if (!ja && a(this).data().sceneVideo) 0 == e && (a(this).data().sceneImage && (d = aa.getItem(a(this)[0].id), Ya.css("background-image", "url(" + d.src + ")")), e += 1);
                    else if (a(this).data().sceneImage || ja && a(this).data().mobileImage) { d = aa.getItem(a(this)[0].id), Va.append("<div class='scene-image gpu-hack " + a(this)[0].id + " abs-fs'><img src='" + d.src + "' width='" + d.naturalWidth + "' height='" + d.naturalHeight + "' alt=''/></div>"); var g, f = Va.find("." + a(this)[0].id + " img");
                        g = ja ? a(this).data().mobileImagePos ? a(this).data().mobileImagePos : "center center" : a(this).data().sceneImagePos ? a(this).data().sceneImagePos : "center center", g = g.split(" "), imgCoverEffect(f[0], { alignX: g[0], alignY: g[1], watchResize: !1 }) } else Va.append("<div class='scene-image gpu-hack " + a(this)[0].id + " abs-fs'><div class='noimage'></div></div>") }), sa && (ob = createjs.Sound.play(nb), ob.loop = xa, ob.position = 100, ob.on("complete", l), ob.paused = !0), !Ma && ("video-bg" === ea && "youtube" === Na || !ja && 0 < da.length) ? hb.on("YTPReady", function() { 0 === na && (gb = Za.find(".mbYTP_wrapper"), j(ea)) }) : j()
            }

            function j() { a.isFunction(X.onTeaserReady) && X.onTeaserReady.call(b), a("body").addClass("set-overflow"), "video-bg" === ea && "youtube" === Na && TweenMax.set(Ya, { autoAlpha: 0 }), X.autoStart ? b.trigger("STUnMuted") : b.trigger("STMuted"), W.init() }

            function k() { if (ob.play(), "undefined" != typeof ob) { var a = Math.round(ob.duration),
                        c = Math.round(1e3 * fa[ha].totalTime().toFixed(1) / fa[ha].timeScale()),
                        d = c;
                    0 > xa && c > a && (d = c % a), ob.position = d, b.trigger("STUnMuted") } }

            function l() { _ = !0, ob.paused = !0, b.trigger("STMuted") }

            function m() { cb && db.pause(), fb && fb.YTPPause() }

            function n() { cb && db.play(), fb && fb.YTPPlay() }

            function o() { Ka && db.pause(), La && fb.YTPPause() }

            function p() { Ka && db.play(), La && fb.YTPPlay() }

            function q(b, c, d) { if (c.data().sceneImage && (c = aa.getItem(c[0].id).src, Ya.css("background-image", "url(" + c + ")")), TweenMax.set(Ya, { autoAlpha: 1 }), "html5" === d) { Ka = !0, La = !1, TweenMax.set(eb, { autoAlpha: 1 }); var e = a.grep(ca, function(a) { return a.sceneIndex == b }); - 1 == db.currentSrc().indexOf(e[0].videoURL) && cb.show(e[0].videoURL), db.off("timeupdate"), db.off("ended"), db.muted(e[0].mute), db.currentTime(e[0].startAt), Ia ? (1 < ca.length && (Ia = !1), r(), db.on("timeupdate", function() {
                        (0 != e[0].stopAt && db.currentTime() >= e[0].stopAt || 0 == e[0].stopAt && db.currentTime() >= db.duration()) && (e[0].loop ? (db.loop(!0), db.currentTime(e[0].startAt), db.play()) : (Ka = !1, db.pause())) }), db.play()) : db.one("loadeddata", function() { r(), db.on("timeupdate", function() {
                            (0 != e[0].stopAt && db.currentTime() >= e[0].stopAt || 0 == e[0].stopAt && db.currentTime() >= db.duration()) && (e[0].loop ? (db.loop(!0), db.currentTime(e[0].startAt), db.play()) : (Ka = !1, db.pause())) }), db.play() }) } else Ka = !1, La = !0, e = a.grep(da, function(a) { return a.sceneIndex == b }), e[0].videoURL == hb[0].opt.videoURL ? (r(), fb.YTPSeekTo(e[0].startAt), TweenMax.set(gb, { autoAlpha: 1 }), fb.YTPPlay()) : (e[0].autoPlay = !0, fb.changeMovie(e[0]), hb.one("YTPReady", function() { r(), a(this).YTPSeekTo(e[0].startAt), TweenMax.set(gb, { autoAlpha: 1 }), a(this).YTPPlay() })) }

            function r() { TweenMax.set(Ya, { autoAlpha: 0 }) }

            function s() { if (a.isFunction(X.onTeaserStart) && X.onTeaserStart.call(b), _a.hide(), X.freezeOnBlur && (clearInterval(Z), Z = setInterval(u, 400)), "undefined" != typeof ob && ((!ja || ja && !X.autoStart) && ua && "paused" != wa || "playing" === wa ? (k(), ob.paused = !1, b.trigger("STUnMuted"), wa = "playing") : (ob.paused = !0, b.trigger("STMuted"), wa = "paused")), "single-image" === ea && za.paused() && za.resume(), "video-bg" === ea) { var c = Qa;
                    cb && db.currentTime(c), fb && fb.YTPSeekTo(c), "youtube" === Na && TweenMax.set(gb, { autoAlpha: 1 }), n(), sa || "video-bg" !== ea || Oa || ("html5" === Na ? db.muted() ? b.trigger("STMuted") : b.trigger("STUnMuted") : hb.isMute ? b.trigger("STMuted") : b.trigger("STUnMuted")) } }

            function t() { b.trigger("STEnd"), "undefined" != typeof ob && va && l(), "video-bg" === ea && Ta && m(), a.isFunction(X.onTeaserEnd) && X.onTeaserEnd.call(b) }

            function u() { document.hasFocus() ? W.continueTeaser() : W.freezeTeaser() }

            function v(a) { za = new TimelineMax({ delay: 0 }); var b = a.totalDuration();
                ya = b + .75, Ga && (za.addLabel("imageZoomer"), a.add(za, b)), a.to(Wa, .75, { opacity: 1 }) }

            function w() { za.pause() }

            function x(a) { "single-image" === ea && a.set(Wa, { autoAlpha: 0, onComplete: w, onCompleteParams: [] }), "video-bg" === ea && a.set(Za, { autoAlpha: 0, onComplete: m, onCompleteParams: [] }) }

            function y(b, c, d, e) { var i, j, f = d.trans,
                    g = d.transDur,
                    h = b.attr("id"),
                    k = !1; if (0 != c ? (j = b.prevAll(".sven-slide:first"), i = j.attr("id")) : (j = a(".extinct"), i = "sven-nothing"), "no" == d.pursueImage) { var l = Va.find("." + h + " img, ." + h + " div"),
                        m = Va.find("." + i + " img, ." + i + " div, ." + qa + " div, ." + qa + " img");
                    i = a(".scene-image").not("." + h + ", ." + i + ", ." + qa).find("img, div"), pa = l, qa = h, e.set(i, { autoAlpha: 0 }) } else l = pa, m = a(".sven-not-found");
                ja || !d.sceneVideo && !d.sceneImage && "no" !== d.pursueVideo || (k = !0), e.addLabel(h + "-before"); var n; if (i = b.find(".bt-container"), 0 < i.length) { var o = i.data().xStart ? i.data().xStart : "-100%",
                        p = i.data().fontMax ? parseInt(i.data().fontMax) : 728;
                    i.wrapInner("<div class='bt-wrapper'></div>"), n = i.find(".bt-wrapper"), n.bigtext({ childSelector: "h1", maxfontsize: p, resize: !1 }), e.set(i, { x: o }) }
                g = "default" == g ? 1.4 : parseFloat(g), g /= 2, i = a.grep(svenTransitions.vegas, function(a) { return a.name == f }), 0 != c && a.grep(svenTransitions.vegas, function(a) { return a.name == j.data().trans }), "fade-screen" == i[0].template ? (e.to(Xa, g, { autoAlpha: 1, ease: Linear.easeNone }), x(e), e.set(j, { display: "none" }), k && e.addLabel("hideP-" + c), 0 < l.length && e.set(l, { autoAlpha: 1 })) : ("none" != f && x(e), e.set(j, { display: "none" }), k && e.addLabel("hideP-" + c)), e.set(b, { visibility: "visible" }), n = i[0].type ? i[0].type : "throughout", o = i[0].alphaDuration ? parseFloat(i[0].alphaDuration) : .95, i[0].in[0].to.ease || (i[0].in[0].to.ease = Linear.easeNone), i[0].out && !i[0].out[0].to.ease && (i[0].out[0].to.ease = Linear.easeNone), "prior" == n && (h += "-prior", e.addLabel(h + "-label")), ga[h] = new TimelineMax, ga[h + "-alpha"] = new TimelineMax, "no" == d.pursueImage && ga[h + "-alpha"].to(l, o, { autoAlpha: 1 }, 0), "fade-screen" == i[0].template && ga[h + "-alpha"].to(Xa, g, { autoAlpha: 0 }, 0), ga[h].data = {}, ga[h].data.duration = i[0].in[0].duration ? i[0].in[0].duration : "full", ga[h].fromTo(l, 1.08, i[0].in[0].from, i[0].in[0].to, 0), 0 < m.length && ga[h + "-alpha"].set(m, { autoAlpha: 0 }), "prior" == n && (g = i[0].in[0].duration ? i[0].in[0].duration : 1.5, e.add(ga[h + "-alpha"], h + "-label"), e.add(ga[h].duration(g), h + "-label")), k && e.set({}, { immediateRender: !1, onStart: z, onStartParams: [] }, "hideP-" + c), !ja && d.sceneVideo && e.set({}, { immediateRender: !1, onComplete: q, onCompleteParams: [c, b, d.videoType] }) }

            function z() { fb && (La = !1, TweenMax.set(gb, { autoAlpha: 0 })), eb && (Ka = !1, TweenMax.set(eb, { autoAlpha: 0 })), m() }

            function A(a, b, c, d, e, f, g) { e = N(a, c, d, e, !1, !1); var h, i, j, k, l, m, n; if (n = e.content0.data().staggerTime ? parseFloat(e.content0.data().staggerTime) : .08, k = e.content0.data().inEase ? U(e.content0.data().inEase) : "", l = e.content0.data().outEase ? U(e.content0.data().outEase) : Circ.easeIn, m = e.split0, i = P(e.wrapper0), "halign-left" == e.slideAlignment || "halign-center" == e.slideAlignment ? (h = i.offLeft, h = "-" + Math.ceil(.6 * h) + "px", i = Math.ceil(i.offRight + i.extWidth) + "px", j = "sequential") : (h = i.offRight, h = Math.ceil(.6 * h) + "px", i = "-" + Math.ceil(i.offLeft + i.extWidth) + "px", j = "reverse"), f.set(e.wrapper0, { x: h }), f.set(m.chars, { y: "-50%", opacity: 0 }), j = e.content0.data().inPattern ? e.content0.data().inPattern : j, m.chars = T(j, m.chars), g || (i = "0px"), e.content1) { var o, p, q, r, s, t, u, v;
                    v = e.content1.data().staggerTime ? parseFloat(e.content1.data().staggerTime) : .08, r = e.content1.data().inPattern ? e.content1.data().inPattern : "sequential", s = e.content1.data().inEase ? U(e.content1.data().inEase) : "", t = e.content1.data().outEase ? U(e.content1.data().outEase) : "", u = e.split1, o = P(e.wrapper1), p = P(e.backdrop1), "halign-left" == e.slideAlignment ? (h = p.offLeft, j = "right center", q = "left center", g = "-" + Math.ceil(h + p.extWidth) + "px", o = Math.ceil(o.offRight + o.extWidth) + "px", h = O(h, e.backdrop1), p = Math.ceil(p.offRight / p.extWidth) + 2) : (h = p.offRight, j = "left center", q = "right center", g = Math.ceil(h + p.extWidth) + "px", o = "-" + Math.ceil(o.offLeft + o.extWidth) + "px", h = O(h, e.backdrop1), p = Math.ceil(p.offLeft / p.extWidth) + 2), f.set(e.backdrop1, { x: g, transformOrigin: j, scaleX: h }), f.set(u.chars, { y: "-50%", opacity: 0 }), u.chars = T(r, u.chars) }
                f.set(d, { visibility: "visible" }), f.addLabel(e.marker), f = S(!1), f.in.staggerTo(m.chars, .2, { y: "0%", opacity: 1, ease: k }, n, 0), f.in.to(e.wrapper0, f.in.duration() + .1, { x: "0px" }, 0), e.content1 && (f.in.to(e.backdrop1, 1, { scaleX: 1, rotation: .01, x: 0 }, .18 * f.in.duration()), f.in.staggerTo(u.chars, .2, { y: "0%", opacity: 1, ease: s }, v, .8 * f.in.duration())), c.inDur && f.in.duration(parseFloat(c.inDur)), "none" != c.outDur && (f.out.to(e.wrapper0, .5, { x: i, opacity: 0, ease: l }), e.content1 && (f.out.to(e.backdrop1, .5, { scaleX: p, rotation: .01, transformOrigin: q }, "-=0.4"), f.out.to(e.wrapper1, .35, { x: o, opacity: 0, ease: t }, "-=0.3")), c.outDur && f.out.duration(parseFloat(c.outDur))), V(a, f, b, c, e.marker, d, !1) }

            function B(b, c, d, e, f, g) { f = N(b, d, e, f, !1, !1); var h, i, j, k, l, m, n, o, p; if (p = f.content0.data().staggerTime ? parseFloat(f.content0.data().staggerTime) : .08, k = f.split0, h = f.content0.data().inPattern ? f.content0.data().inPattern : "random", i = f.content0.data().inEase ? U(f.content0.data().inEase) : "", j = f.content0.data().outEase ? U(f.content0.data().outEase) : "", k.chars = T(h, k.chars), a.each(k.chars, function(b, c) { l = a(c).outerWidth(), m = a(c).outerHeight(), n = ["rect(0px, 0px, 0px, 0px)", "rect(" + m + "px, " + l + "px, " + m + "px, " + l + "px)", "rect(" + m + "px, 0px, " + m + "px, 0px)", "rect(0px, " + l + "px, 0px, " + l + "px)"], o = n[b % 4], g.set(a(c), { clip: o }) }), f.content1) { var q, r;
                    q = f.content1.data().inEase ? U(f.content1.data().inEase) : Bounce.easeOut, r = f.content1.data().outEase ? U(f.content1.data().outEase) : "", h = f.content1.hasClass("place-left") ? "left top" : f.content1.hasClass("place-right") ? "right top" : "center top", g.set(f.backdrop1, { scale: 0, transformOrigin: h }), g.set(f.content1, { opacity: 0, transformOrigin: h }) }
                g.set(e, { visibility: "visible" }), g.addLabel(f.marker); var s = S(!0);
                a.each(k.chars, function(b, c) { var d = (b + 1) * p;
                    l = a(c).outerWidth(), m = a(c).outerHeight(), s.repeat.to(a(c), 1.25, { clip: "rect(0px, " + l + "px, " + m + "px, 0px)", ease: i }, d) }), s.in.add(s.repeat), f.content1 && (s.in.to(f.backdrop1, .25, { scale: 1.2, rotation: .01, ease: Linear.easeNone }), s.in.to(f.backdrop1, .6, { scale: 1, rotation: .01, ease: q }), s.in.to(f.content1, .75, { opacity: 1 })), d.inDur && s.in.duration(parseFloat(d.inDur)), "none" != d.outDur && (s.out.add(s.repeat.tweenFromTo(0, s.repeat.duration(), { ease: j }).timeScale(2).reverse()), f.content1 && s.out.to([f.content1, f.backdrop1], .6 * s.out.duration(), { scale: 0, rotation: .01, ease: r }, "-=" + .8 * s.out.duration()), d.outDur && s.out.duration(parseFloat(d.outDur))), V(b, s, c, d, f.marker, e, !0) }

            function C(b, c, d, e, f, g) { f = N(b, d, e, f, !1, !1); var h, i, j, k, l, m, n; if (n = f.content0.data().staggerTime ? parseFloat(f.content0.data().staggerTime) : .08, k = f.split0, h = f.content0.data().inPattern ? f.content0.data().inPattern : "random", i = f.content0.data().inEase ? U(f.content0.data().inEase) : "", j = f.content0.data().outEase ? U(f.content0.data().outEase) : "", k.chars = T(h, k.chars), a.each(k.chars, function(b, c) { l = a(c).outerWidth(), g.set(a(c), { clip: "rect(0px, " + l + "px, 0px, 0px)" }) }), f.content1) { var o = f.content1.data().inEase ? f.content1.data().inEase : Bounce.easeOut,
                        p = f.content1.data().outEase ? U(f.content1.data().outEase) : "";
                    g.set(f.wrapper1, { overflow: "hidden" }), g.set([f.content1, f.backdrop1], { y: "-104%" }) }
                g.set(e, { visibility: "visible" }), g.addLabel(f.marker); var q = S(!0);
                a.each(k.chars, function(b, c) { var d = b * n;
                    l = a(c).outerWidth(), m = a(c).outerHeight(), q.repeat.to(a(c), 1.5, { clip: "rect(0px, " + l + "px, " + m + "px, 0px)", ease: i }, d) }), q.in.add(q.repeat), f.content1 && q.in.to([f.content1, f.backdrop1], .8, { y: "0%", ease: o }), d.inDur && q.in.duration(parseFloat(d.inDur)), "none" != d.outDur && (q.out.add(q.repeat.tweenFromTo(0, q.repeat.duration(), { ease: j }).timeScale(2).reverse()), f.content1 && q.out.to(f.wrapper1, .8, { opacity: 0, ease: p }, "-=1"), d.outDur && q.out.duration(parseFloat(d.outDur))), V(b, q, c, d, f.marker, e, !0) }

            function D(b, c, d, e, f, g) { f = N(b, d, e, f, !1, !1); var h, i, j, k, l, m, n; if (n = f.content0.data().staggerTime ? parseFloat(f.content0.data().staggerTime) : .04, k = f.split0, h = f.content0.data().inPattern ? f.content0.data().inPattern : "random", i = f.content0.data().inEase ? U(f.content0.data().inEase) : "", j = f.content0.data().outEase ? U(f.content0.data().outEase) : "", k.chars = T(h, k.chars), a.each(k.chars, function(b, c) { l = a(c).outerWidth(), g.set(a(c), { clip: "rect(0px, " + l + "px, 0px, 0px)", scale: 0 }) }), f.content1) { var o = f.content1.data().inEase ? f.content1.data().inEase : Bounce.easeOut,
                        p = f.content1.data().outEase ? U(f.content1.data().outEase) : "";
                    g.set(f.wrapper1, { overflow: "hidden" }), g.set([f.content1, f.backdrop1], { y: "-104%" }) }
                g.set(e, { visibility: "visible" }), g.addLabel(f.marker); var q = S(!0);
                a.each(k.chars, function(b, c) { var d = b * n;
                    l = a(c).outerWidth(), m = a(c).outerHeight(), q.repeat.to(a(c), .8, { clip: "rect(0px, " + l + "px, " + m + "px, 0px)", scale: 1, ease: i }, d) }), q.in.add(q.repeat), f.content1 && q.in.to([f.content1, f.backdrop1], .8, { y: "0%", ease: o }), d.inDur && q.in.duration(parseFloat(d.inDur)), "none" != d.outDur && (q.out.add(q.repeat.tweenFromTo(0, q.repeat.duration(), { ease: j }).timeScale(2).reverse()), f.content1 && q.out.to(f.wrapper1, .8, { opacity: 0, ease: p }, "-=1"), d.outDur && q.out.duration(parseFloat(d.outDur))), V(b, q, c, d, f.marker, e, !0) }

            function E(b, c, d, e, f, g) { f = N(b, d, e, f, !1, !1); var h, i, j, k; if (k = f.content0.data().staggerTime ? parseFloat(f.content0.data().staggerTime) : .15, j = f.split0, h = f.content0.data().inPattern ? f.content0.data().inPattern : "sequential", f.content0.data().inEase && U(f.content0.data().inEase), i = f.content0.data().outEase ? U(f.content0.data().outEase) : "", j.chars = T(h, j.chars), g.set(j.chars, { autoAlpha: 0, scale: .7 }), f.content1) { var l = f.content1.data().inEase ? f.content1.data().inEase : Bounce.easeOut,
                        m = f.content1.data().outEase ? U(f.content1.data().outEase) : "";
                    g.set(f.wrapper1, { overflow: "hidden" }), g.set([f.content1, f.backdrop1], { y: "-104%" }) }
                g.set(e, { visibility: "visible" }), g.addLabel(f.marker); var n = S(!0);
                a.each(j.chars, function(b, c) { n.repeat.addLabel("rotate-in-" + b, b * k), n.repeat.to(a(c), .35, { autoAlpha: 1, rotation: 30, transformOrigin: "center bottom", scale: 1.1 }, "rotate-in-" + b), n.repeat.to(a(c), .25, { rotation: 0, scale: 1, transformOrigin: "center bottom", ease: Back.easeIn }, "rotate-in-" + b + "+=0.35") }), n.in.add(n.repeat), f.content1 && n.in.to([f.content1, f.backdrop1], .8, { y: "0%", ease: l }), d.inDur && n.in.duration(parseFloat(d.inDur)), "none" != d.outDur && (n.out.add(n.repeat.tweenFromTo(0, n.repeat.duration(), { ease: i }).timeScale(2).reverse()), f.content1 && n.out.to(f.wrapper1, .8, { opacity: 0, ease: m }, "-=1"), d.outDur && n.out.duration(parseFloat(d.outDur))), V(b, n, c, d, f.marker, e, !0) }

            function F(b, c, d, e, f, g) { f = N(b, d, e, f, !1, !1); var k, l, m, n, o, p, h = f.content0.data().inEase ? U(f.content0.data().inEase) : SlowMo.ease.config(3, .7, !1),
                    i = f.content0.data().outEase ? U(f.content0.data().outEase) : "",
                    j = f.split0,
                    q = 1; if (f.content0.hasClass("place-left") ? p = "-" + Math.ceil(R(f.wrapper0, b) + f.wrapper0.outerWidth()) + "px" : f.content0.hasClass("place-right") ? p = Math.ceil(f.wrapper0.offset().left + f.wrapper0.outerWidth()) + "px" : (p = Math.ceil(f.wrapper0.offset().left + f.wrapper0.outerWidth()) + "px", q = 0), a(j.chars).each(function(b, c) { l = Math.ceil(a(c).outerHeight() / 4), k = Math.ceil(a(c).outerWidth() / 2); for (var d = 0; 7 > d; d++) a(c).parent().append(a(c).clone()); for (n = e.find(".sven-char-" + (b + 1)), d = 0; 2 > d; d++) o = "rect(0px, " + k * (d + 1) + "px, " + 1 * l + "px, " + k * d + "px)", m = d, g.set(n.eq(m), { x: p, opacity: q, clip: o }); for (d = 0; 2 > d; d++) o = "rect(" + 1 * l + "px, " + k * (d + 1) + "px, " + 2 * l + "px, " + k * d + "px)", m = d + 2, g.set(n.eq(m), { x: p, opacity: q, clip: o }); for (d = 0; 2 > d; d++) o = "rect(" + 2 * l + "px, " + k * (d + 1) + "px, " + 3 * l + "px, " + k * d + "px)", m = d + 4, g.set(n.eq(m), { x: p, opacity: q, clip: o }); for (d = 0; 2 > d; d++) o = "rect(" + 3 * l + "px, " + k * (d + 1) + "px, " + 4 * l + "px, " + k * d + "px)", m = d + 6, g.set(n.eq(m), { x: p, opacity: q, clip: o }) }), f.content1) { var t, r = f.content1.data().inEase ? f.content1.data().inEase : "",
                        s = f.content1.data().outEase ? U(f.content1.data().outEase) : "";
                    t = f.content1.hasClass("place-left") ? "right center" : f.content1.hasClass("place-right") ? "left center" : "center center", g.set(f.backdrop1, { scaleX: 0, transformOrigin: t }), g.set(f.content1, { opacity: 0 }) }
                g.set(e, { visibility: "visible" }), g.addLabel(f.marker); var u = S(!0);
                a(j.chars).each(function(a, b) { n = e.find(".sven-char-" + (a + 1)), u.repeat.staggerTo(n, .1, { x: 0, opacity: 1, ease: h }, .08, 1 * Math.random()) }), u.in.add(u.repeat, 0), f.content1 && (u.in.to(f.backdrop1, u.repeat.duration() - .2, { scaleX: 1, rotation: .01, ease: r }, .2), u.in.to(f.content1, .75, { opacity: 1 })), d.inDur && u.in.duration(parseFloat(d.inDur)), "none" != d.outDur && (u.out.add(u.repeat.tweenFromTo(0, u.repeat.duration(), { ease: i }).timeScale(2).reverse()), r = u.out.duration(), f.content1 && (u.out.to(f.content1, .2 * r, { opacity: 0 }, 0), u.out.to(f.backdrop1, .65 * r, { scaleX: 0, rotation: .01, ease: s }, 0)), d.outDur && u.out.duration(parseFloat(d.outDur))), V(b, u, c, d, f.marker, e, !0) }

            function G(b, c, d, e, f, g) { f = N(b, d, e, f, !1, !1); var h, i, j, k, l; if (k = f.split0, l = f.content0.data().staggerTime ? parseFloat(f.content0.data().staggerTime) : .08, h = f.content0.data().inPattern ? f.content0.data().inPattern : "random", i = f.content0.data().inEase ? U(f.content0.data().inEase) : "", j = f.content0.data().outEase ? U(f.content0.data().outEase) : "", k.chars = T(h, k.chars), f.content1) { var m = f.content1.data().inEase ? f.content1.data().inEase : Bounce.easeOut,
                        n = f.content1.data().outEase ? U(f.content1.data().outEase) : "";
                    g.set(f.wrapper1, { overflow: "hidden" }), g.set([f.content1, f.backdrop1], { y: "-104%" }) }
                g.set(e, { visibility: "visible" }), g.addLabel(f.marker); var o = S(!0);
                a.each(k.chars, function(b, c) { var d = b * l;
                    o.repeat.from(a(c), .8, { opacity: 0, ease: i }, d) }), o.in.add(o.repeat), f.content1 && o.in.to([f.content1, f.backdrop1], .8, { y: "0%", ease: m }), d.inDur && o.in.duration(parseFloat(d.inDur)), "none" != d.outDur && (f.content1 && o.out.to([f.content1, f.backdrop1], .1, { y: "-100%", ease: n }), o.out.add(o.repeat.tweenFromTo(0, o.repeat.duration(), { ease: j }).timeScale(2).reverse()), d.outDur && o.out.duration(parseFloat(d.outDur))), V(b, o, c, d, f.marker, e, !0) }

            function H(b, c, d, e, f, g) { f = N(b, d, e, f, !1, !1); var h = !!d.firstIn && parseBool(d.firstIn),
                    i = !!d.lastOut && parseBool(d.lastOut),
                    j = "default" == d.rotFreeze ? .8 : parseFloat(d.rotFreeze); "default" == d.overlapTime || parseFloat(d.overlapTime); var k, l, m, n, o = f.split0;
                n = f.content0.data().staggerTime ? parseFloat(f.content0.data().staggerTime) : .05, k = f.content0.data().inPattern ? f.content0.data().inPattern : "sequential", l = f.content0.data().inEase ? U(f.content0.data().inEase) : Sine.easeOut, m = f.content0.data().outEase ? U(f.content0.data().outEase) : Sine.easeOut; var p = o.lines.length,
                    q = f.wrapper0.outerHeight(),
                    r = q / p,
                    s = a(window).height(),
                    q = q > s ? Math.ceil((s - r) / 2) + "px" : Math.ceil((q - r) / 2) + "px";
                1 < p && g.set(o.lines, { top: q, perspective: 1e3, transformOrigin: "50% 100%" }), g.set(e, { visibility: "visible" }), g.addLabel(f.marker); var t = S(!0);
                a.each(o.lines, function(b, c) { var d = a(c).find(".s-char"),
                        e = "codfx9-" + b,
                        f = "codfx9-" + (b + 1),
                        d = T(k, d);
                    (0 < b || 0 == b && h) && a.each(d, function(b, c) { var d = e + "+=" + n;
                        t.repeat.fromTo(a(c), .4, { opacity: 0, rotationY: -90 }, { opacity: 1, rotationY: 0, ease: l }, d) }), (b != p - 1 || i && b == p - 1) && (t.repeat.set({}, {}, "+=" + j), a.each(d, function(b, c) { var d = f + "+=0.05";
                        t.repeat.to(a(c), .2, { opacity: 0, rotationY: 45, ease: m }, d) })) }), t.in.add(t.repeat), d.inDur && t.in.duration(parseFloat(d.inDur)), V(b, t, c, d, f.marker, e, !0) }

            function I(b, c, d, e, f, g, h) { f = N(b, d, e, f, !1, !1); var i;
                i = ka ? "0px" : ja ? "2px" : "20px"; var j, k, l, m, n, o = f.split0; if (m = f.content0.data().staggerTime ? parseFloat(f.content0.data().staggerTime) : .04, j = f.content0.data().inPattern ? f.content0.data().inPattern : "random", k = f.content0.data().inEase ? U(f.content0.data().inEase) : Linear.easeNone, l = f.content0.data().outEase ? U(f.content0.data().outEase) : "", o.chars = T(j, o.chars), n = f.content0.css("color"), f.content1) { var p, q, r, s;
                    q = f.split1, r = f.content1.data().staggerTime ? parseFloat(f.content1.data().staggerTime) : .04, j = f.content1.data().inPattern ? f.content1.data().inPattern : "random", p = f.content1.data().inEase ? f.content1.data().inEase : Bounce.easeOut, f.content1.data().outEase && U(f.content1.data().outEase), q.chars = T(j, q.chars), s = f.content1.css("color") }
                g.set(e, { visibility: "visible" }), g.addLabel(f.marker); var t = S(!0);
                a.each(o.chars, function(b, c) { var d = b * m;
                    t.repeat.fromTo(a(c), .8, { opacity: 0, textShadow: "0 0 " + i + " " + n, scale: 1.2, color: "transparent", ease: k }, { opacity: 1, scale: 1, color: n, textShadow: "none" }, d) }), f.content1 && (t.repeat.addLabel("blurSub", "+=0"), a.each(q.chars, function(b, c) { var d = "blurSub+=" + b * r;
                    t.repeat.fromTo(a(c), .8, { opacity: 0, textShadow: "0 0 " + i + " " + s, scale: 1.2, color: "transparent", ease: p }, { opacity: 1, scale: 1, color: s, textShadow: "none" }, d) })), t.in.add(t.repeat), d.inDur && t.in.duration(parseFloat(d.inDur)), "none" != d.outDur && (h ? t.out.to(f.content1 ? [f.wrapper0, f.wrapper1] : [f.wrapper0], .75, { autoAlpha: 0 }) : t.out.add(t.repeat.tweenFromTo(0, t.repeat.duration(), { ease: l }).timeScale(2).reverse()), d.outDur && t.out.duration(parseFloat(d.outDur))), V(b, t, c, d, f.marker, e, !0) }

            function J(b, c, d, e, f, g) { f = N(b, d, e, f, !1, !0), a.each(f.split0.lines, function(b, c) { Math.ceil(a(c).outerHeight() / 8), Math.ceil(a(c).outerWidth()); for (var d = 0; 7 > d; d++) a(this).after(a(c).clone());
                    a(this).parent().find(".sven-line-" + (b + 1)).each(function(b, c) { g.set(a(c), { clip: "rect(0px, 0px, 0px 0px)" }) }) }), f.content1 && g.set(f.wrapper1, { autoAlpha: 0 }), g.set(e, { visibility: "visible" }), g.addLabel(f.marker); var h = S(!0);
                a.each(f.split0.lines, function(b, c) { var d = Math.ceil(a(c).outerHeight() / 8),
                        e = Math.ceil(a(c).outerWidth()),
                        f = a(this).parent().find(".sven-line-" + (b + 1)),
                        g = new TimelineMax;
                    f.each(function(c, f) { var h, i = 0;
                        h = 0 == c % 2 ? "rect(" + d * c + "px, 0px, " + d * (c + 1) + "px, 0px)" : "rect(" + d * c + "px, " + e + "px, " + d * (c + 1) + "px, " + e + "px)", 4 > c ? (g.addLabel("pos-" + b + "-" + c), i = "pos-" + b + "-" + c) : i = "pos-" + b + "-" + (7 - c), g.fromTo(a(f), .6, { clip: h }, { clip: "rect(" + d * c + "px, " + e + "px, " + d * (c + 1) + "px, 0px)" }, i) }), h.repeat.add(g, 0) }), h.in.add(h.repeat), f.content1 && h.in.to(f.wrapper1, .75, { autoAlpha: 1 }), d.inDur && h.in.duration(parseFloat(d.inDur)), "none" != d.outDur && (h.out.add(h.repeat.tweenFromTo(0, h.repeat.duration()).timeScale(2).reverse()), f.content1 && h.out.to([f.wrapper1], .75, { autoAlpha: 0 }, 0), d.outDur && h.out.duration(parseFloat(d.outDur))), V(b, h, c, d, f.marker, e, !0) }

            function K(b, c, d, e, f, g) { f = N(b, d, e, f, !1, !1); var h;
                h = ka ? "0px" : ja ? "2px" : "20px"; var i, j, k, l, m;
                l = f.split0, m = f.content0.data().staggerTime ? parseFloat(f.content0.data().staggerTime) : .08, i = f.content0.data().inPattern ? f.content0.data().inPattern : "sequential", j = f.content0.data().inEase ? U(f.content0.data().inEase) : Bounce.easeOut, k = f.content0.data().outEase ? U(f.content0.data().outEase) : "", l.chars = T(i, l.chars); var o, p, q, n = []; if (g.set(l.chars, { overflow: "hidden" }), a.each(l.chars, function(b, c) { o = "sven-char-sub-" + (b + 1), p = a(c).outerWidth(), q = a(c).outerHeight(), a(c).wrapInner("<div class='" + o + "' style='width: " + p + "px; height: " + q + "px'></div>"), n.push(a(c).find("." + o)) }), g.set(n, { x: "-100%" }), f.content1) { var r, s, t, u;
                    s = f.split1, t = f.content1.data().staggerTime ? parseFloat(f.content1.data().staggerTime) : .08, i = f.content1.data().inPattern ? f.content1.data().inPattern : "sequential", r = f.content1.data().inEase ? f.content1.data().inEase : "", f.content1.data().outEase && U(f.content1.data().outEase), s.chars = T(i, s.chars), u = f.content1.css("color") }
                g.set(e, { visibility: "visible" }), g.addLabel(f.marker); var v = S(!0);
                a.each(n, function(b, c) { var d = b * m;
                    v.repeat.to(a(c), 1.25, { x: "0%", ease: j }, d) }), f.content1 && (v.repeat.addLabel("blurSub", "+=0"), a.each(s.chars, function(b, c) { var d = "blurSub+=" + b * t;
                    v.repeat.fromTo(a(c), .8, { opacity: 0, textShadow: "0 0 " + h + " " + u, scale: 1.2, rotation: .01, color: "transparent", ease: r }, { opacity: 1, scale: 1, color: u, textShadow: "none" }, d) })), v.in.add(v.repeat), d.inDur && v.in.duration(parseFloat(d.inDur)), "none" != d.outDur && (v.out.add(v.repeat.tweenFromTo(0, v.repeat.duration(), { ease: k }).timeScale(2).reverse()), d.outDur && v.out.duration(parseFloat(d.outDur))), V(b, v, c, d, f.marker, e, !0) }

            function L(b, c, d, e, f, g) { if (f = N(b, d, e, f, !0, !0), 100 > f.content0.outerHeight()) var h = Math.ceil(f.content0.outerHeight() - 1),
                    i = 1;
                else h = 99, i = Math.ceil(f.content0.outerHeight() / 100); for (var j = f.content0.outerWidth(), k = 0; k < h; k++) f.wrapper0.append(f.content0.clone());
                h = f.wrapper0.find("h1"), h.each(function(b, c) { g.set(a(c), { position: "absolute", left: 0, top: 0, x: 0, opacity: 1, clip: "rect(" + i * b + "px, " + j + "px, " + i * (b + 1) + "px, 0px)" }) }), g.set(f.wrapper0, { autoAlpha: 0 }), f.content1 && g.set(f.wrapper1, { autoAlpha: 0 }), g.set(e, { visibility: "visible" }), g.addLabel(f.marker); var l = S(!0);
                l.in.to(f.wrapper0, .75, { autoAlpha: 1 }, 0), h.each(function(b, c) { l.repeat.to(a(this), .1, { x: randomInt(-5, 5), opacity: randomFloat(.8, 1), ease: RoughEase.ease.config({ strength: 5, points: 50, template: SlowMo.ease, clamp: !1, taper: "out" }) }, 0) }), l.in.add(l.repeat, "+=0.2"), M(l.in, l.repeat, h, 1, !1, "+=0.1"), M(l.in, l.repeat, h, .5, !1, "+=0.4"), M(l.in, l.repeat, h, .5, !0, "+=3"), M(l.in, l.repeat, h, .5, !1, "+=0.4"), M(l.in, l.repeat, h, .5, !1, "+=2"), l.in.to(h, .25, { x: 0, opacity: 1, ease: RoughEase.ease.config({ strength: 5, points: 50, template: SlowMo.ease, clamp: !1, taper: "out" }) }), l.in.set(h, { x: 0, opacity: 1 }), f.content1 && l.in.to(f.wrapper1, .75, { autoAlpha: 1 }, "comingSubContent"), d.inDur && l.in.duration(parseFloat(d.inDur)), "none" != d.outDur && (l.out.to([f.content0], .75, { autoAlpha: 0 }, 0), f.content1 && l.out.to([f.wrapper1], .75, { autoAlpha: 0 }, 0), d.outDur && l.out.duration(parseFloat(d.outDur))), V(b, l, c, d, f.marker, e, !1) }

            function M(a, b, c, d, e, f) { a.to(c, .25, { x: 0, opacity: 1, ease: RoughEase.ease.config({ strength: 5, points: 50, template: SlowMo.ease, clamp: !1, taper: "out" }) }), e && a.addLabel("comingSubContent", "+=0.3"), a.add(b.tweenFromTo(0, b.duration()).timeScale(d), f) }

            function N(b, c, d, e, f, g) { var h = {};
                h.marker = b.attr("id"), c = b.find(".centered"), b = b.children(); var i;
                b.hasClass("halign-left") ? (i = "place-left", h.slideAlignment = "halign-left") : b.hasClass("halign-right") ? (i = "place-right", h.slideAlignment = "halign-right") : (i = "place-center", h.slideAlignment = "halign-center"), b = Q(d); var j = 0; return e.each(function(b, c) { a(this).append("<span class='ws-fix'> &nbsp; </span>"); var e = a(this).find(".ws-fix"),
                        k = Math.ceil(e.outerWidth());
                    e.remove(), h["content" + b] = a(this); var l = Q(a(this)),
                        m = a(this).data().align ? "place-" + a(this).data().align : i,
                        e = a(this).data().boxType ? a(this).data().boxType : "contain"; if (a(this).wrap("<div class='content-wrapper content-wrapper-" + b + "' style='position:relative;width:100%;'></div>"), h["wrapper" + b] = d.find(".content-wrapper-" + b), 0 != b && "contain" === e && a(this).css("display", "inline-block"), a(this).css({ display: "block", position: "absolute", width: Math.ceil(a(this).outerWidth() + k) + "px", height: Math.ceil(a(this).outerHeight()) + "px" }).addClass("place-left"), 0 == b && f || 1 == b && g || 1 < b) { var n;
                        a(this).removeClass("place-left").addClass(m), h["wrapper" + b].css({ height: Math.ceil(a(this).outerHeight()) + "px" }), n = Math.ceil(a(this).outerWidth()), n > j && (j = n) } else { h["split" + b] = new SplitText(a(this), { type: "words,chars,lines", wordsClass: "s-word gpu-hack sven-word-++", charsClass: "s-char sven-char-++", linesClass: "sven-line-++", position: "absolute" }), TweenMax.set(h["split" + b].chars, { force3D: !0, rotationZ: "0.01deg" }), a(this).removeClass("place-left").addClass(m), n = 0; var o, p, q = h["split" + b].lines.length;
                        a.each(h["split" + b].lines, function(b, c) { var d = a(c).children().last();
                            o = parseInt(d.css("left")) + parseInt(d.css("width")), a(c).css({ width: o + "px", right: l.padRight + "px" }).addClass(m), o > n && (n = o), b == q - 1 && (p = parseInt(a(this).css("top")) + parseInt(a(this).css("height"))) }), a(this).css({ width: n + l.horz + "px", height: p + l.padBottom + "px" }), h["wrapper" + b].css({ height: p + l.padBottom + l.marTop + l.marBottom + "px" }), n > j && (j = n + l.horz) }
                    0 < b && (a(this).after("<div class='lt-boxed content-backdrop-" + b + "'></div>"), h["backdrop" + b] = d.find(".content-backdrop-" + b), k = "full" == e ? "100%" : a(c).outerWidth() + "px", h["backdrop" + b].css({ position: "absolute", width: k, height: a(c).outerHeight() + "px", margin: a(c).css("margin") }), h["backdrop" + b].addClass(m)) }), d.css({ width: j + b.horz + "px" }), c.css({ "max-width": j + b.horz + "px" }), h }

            function O(a, b) { return b.outerWidth() > a ? 3 : Math.ceil(a / b.outerWidth()) + 2 }

            function P(a) { var b = {}; return b.offLeft = a.offset().left - Ua.offset().left, b.offRight = Ua.width() - (b.offLeft + a.outerWidth()), b.extWidth = a.outerWidth(), b.extHeight = a.outerHeight(), b }

            function Q(a) { var b = {}; return b.padTop = parseInt(a.css("padding-top")), b.padRight = parseInt(a.css("padding-right")), b.padBottom = parseInt(a.css("padding-bottom")), b.padLeft = parseInt(a.css("padding-left")), b.borTop = parseInt(a.css("border-top-width")), b.borRight = parseInt(a.css("border-right-width")), b.borBottom = parseInt(a.css("border-bottom-width")), b.borLeft = parseInt(a.css("border-left-width")), b.marTop = parseInt(a.css("margin-top")), b.marRight = parseInt(a.css("margin-right")), b.marBottom = parseInt(a.css("margin-bottom")), b.marLeft = parseInt(a.css("margin-left")), b.horz = b.padLeft + b.padRight + b.borLeft + b.borRight, b.vert = b.padTop + b.padBottom + b.borTop + b.borBottom, b }

            function R(a, b) { return b.width() - (a.offset().left + a.outerWidth()) }

            function S(a) { var b = {}; return b.in = new TimelineMax, b.out = new TimelineMax, b.full = new TimelineMax, a && (b.repeat = new TimelineMax), b }

            function T(a, b) { return "random" === a ? shuffleArray(b) : "reverse" === a ? b.reverse() : "median" === a ? centerArray(b) : "reverse-median" === a ? centerArray(b).reverse() : b }

            function U(a) { var b = a.split("."); return 2 === b.length ? window[b[0]][b[1]] : (a = a.match(/true|false|(-?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi).map(JSON.parse), window[b[0]][b[1]].config.apply(null, a)) }

            function V(c, d, e, f, g, h, i) { var j = "default" == f.freezeTime ? 1.5 : parseFloat(f.freezeTime),
                    k = f.sceneDelay ? parseFloat(f.sceneDelay) : 0;
                d.full.addLabel(g + "-beforeIn"), d.full.add(d.in, "+=" + k), d.full.addLabel(g + "-beforeFreeze"), d.full.addLabel(g + "-beforeOut", "+=" + j), "none" != f.outDur ? (d.full.add(d.out, g + "-beforeOut"), d.full.set(h, { visibility: "hidden" })) : d.full.set({}, { immediateRender: !1 }, g + "-beforeOut"), b.hasClass("animate-colors") && (h = e % X.colors.length, d.full.to($a, d.full.duration(), { backgroundColor: X.colors[h] }, 0)), i && d.full.set({}, { immediateRender: !1, onComplete: function() { d.repeat.resume() } }), f.sceneDur && d.full.duration(parseFloat(f.sceneDur)); var l = {}; if (i = d.full.timeScale(), l.in = d.in.duration() / d.in.timeScale() / i, l.out = d.out.duration() / d.out.timeScale() / i, l.full = d.full.duration() / i, l.freeze = j / i, X.showAnimationSummary && (j = "in: " + l.in.toFixed(1) + "s<br/> out: " + l.out.toFixed(1) + "s<br/> freeze: " + l.freeze.toFixed(1) + "s<br/> scene: " + l.full.toFixed(1) + "s", d.full.set(kb, { text: j }, .1), d.full.set(jb, { text: f.anim }, .1)), j = c.find(".bt-container"), 0 < j.length) { i = j.data().animate ? j.data().animate : "yes", h = j.data().xEnd ? j.data().xEnd : "0%"; var k = j.data().dur ? parseFloat(j.data().dur) : d.in.duration(),
                        m = j.data().ease ? U(j.data().ease) : Power4.easeOut; "yes" === i ? fa[ha].to(j, k, { x: h, ease: m, force3D: !0, rotationZ: "0.01deg" }, g) : fa[ha].set(j, { x: "0%" }, g) }
                fa[ha].add(d.full, g), ra = "no" == f.pursueImage ? l.full : ra + l.full, ga[g] && (fa[ha].add(ga[g + "-alpha"], g), "full" == ga[g].data.duration ? fa[ha].add(ga[g].duration(ra), "-=" + ra) : "in" == ga[g].data.duration ? fa[ha].add(ga[g].duration(l.in), g) : fa[ha].add(ga[g].duration(ga[g].data.duration), g), ra = 0), fa[ha].set({}, { immediateRender: !1, onComplete: function() { a.isFunction(X.onBeforeScene) && X.onBeforeScene.call(b, e, c, l, oa) } }, g + "-before"), d.full.set({}, { immediateRender: !1, onComplete: function() { a.isFunction(X.onBeforeIn) && X.onBeforeIn.call(b, e, c, l, oa) } }, g + "-beforeIn"), d.full.set({}, { immediateRender: !1, onComplete: function() { a.isFunction(X.onBeforeFreeze) && X.onBeforeFreeze.call(b, e, c, l, oa) } }, g + "-beforeFreeze"), "none" != f.outDur && d.full.set({}, { immediateRender: !1, onComplete: function() { a.isFunction(X.onBeforeOut) && X.onBeforeOut.call(b, e, c, l, oa) } }, g + "-beforeOut"), fa[ha].set({}, { immediateRender: !1, onComplete: function() { a.isFunction(X.onAfterScene) && X.onAfterScene.call(b, e, c, l, oa) } }, g + "-after") }
            var Z, aa, ea, ia, ma, oa, pa, wa, xa, ya, za, W = this,
                X = a.extend({}, { autoStart: !0, fullDuration: "default", preloadMethod: "xhr", preloadFiles: [], fileTimeout: 8e3, audioTimeout: 8e3, colors: ["#E7464F", "#CDAA20", "#80993B", "#07BABA", "#9B2C9D"], showAnimationSummary: !1, freezeOnBlur: !0, videoPlaybackChange: !0, onTeaserReady: function() {}, onTeaserStart: function() {}, onTeaserEnd: function() {}, onBeforeScene: function() {}, onBeforeIn: function() {}, onBeforeFreeze: function() {}, onBeforeOut: function() {}, onAfterScene: function() {} }, c),
                Y = "playing",
                $ = !0,
                _ = !1,
                ba = [],
                ...
                ha = b.attr("id"),
                ja = isMobile.any,
                ka = -1 < navigator.userAgent.toLowerCase().indexOf("firefox"),
                la = a(window).width(),
                na = 0,
                qa = "sven-default",
                ra = 0,
                sa = !!b.attr("data-enable-sound") && parseBool(b.attr("data-enable-sound")),
                ta = !!b.attr("data-sound-loop") && parseBool(b.attr("data-sound-loop")),
                ua = !b.attr("data-auto-play-sound") || parseBool(b.attr("data-auto-play-sound")),
                va = !!b.attr("data-auto-stop-sound") && parseBool(b.attr("data-auto-stop-sound")),
                Aa = !!b.attr("data-static-image") && parseBool(b.attr("data-static-image")),
                Ba = !!b.attr("data-mobile-image") && parseBool(b.attr("data-mobile-image")),
                Ca = b.data().staticImagePos ? b.data().staticImagePos : "center center",
                Da = b.data().zoomOrigin ? b.data().zoomOrigin : "center center",
                Ea = b.data().zoomType ? b.data().zoomType : "in",
                Fa = b.data().zoomDur ? parseFloat(b.data().zoomDur) : "auto",
                Ga = !!b.data().zoomScale && parseFloat(b.data().zoomScale),
                Ha = !!b.attr("data-splash-image") && parseBool(b.attr("data-splash-image")),
                Ia = !1,
                Ja = !1,
                Ka = !1,
                La = !1,
                Ma = !1,
                Na = b.data().videoType ? b.data().videoType : "html5",
                Oa = !b.attr("data-mute-video") || parseBool(b.attr("data-mute-video")),
                Pa = b.data().videoQuality ? b.data().videoQuality : "highres",
                Qa = b.data().videoStart ? parseInt(b.data().videoStart) : .01,
                Ra = b.data().videoStop ? parseInt(b.data().videoStop) : 0,
                Sa = !b.attr("data-video-loop") || parseBool(b.attr("data-video-loop")),
                Ta = !!b.attr("data-auto-stop-video") && parseBool(b.attr("data-auto-stop-video"));
            ea = b.data().staticVideo && !ja ? "video-bg" : Aa || Ba ? "single-image" : "assorted", xa = ta ? -1 : 0, ja && b.data().mobileSound && (sa = b.data().mobileSound), ja && Ba && (Aa = Ba), b.wrap("<div class='sven-wrapper'></div>");
            var Ua = b.parent();
            Ua.append("<div class='slideshow-wrapper abs-fs'><div class='slideshow-overlay abs-fs'></div></div>");
            var Va = Ua.find(".slideshow-wrapper");
            if ("single-image" === ea) { Ua.append("<div class='single-wrapper abs-fs'><div class='single-overlay abs-fs'></div><div class='single-image abs-fs'></div></div><div class='black-bg abs-fs'></div>"); var Wa = Ua.find(".single-image"),
                    Xa = Ua.find(".black-bg");
                ba.push({ id: "static-image", src: Aa, loadTimeout: X.fileTimeout }) } else "video-bg" === ea && Aa && ba.push({ id: "preview-image", src: Aa, loadTimeout: X.fileTimeout }), Ua.append("<div class='black-bg gpu-hack abs-fs'></div>"), Xa = Ua.find(".black-bg");
            Ua.append("<div class='video-wrapper abs-fs'><div class='preview-image abs-fs bg-cover'></div></div><div class='splash-wrapper abs-fs'><div class='splash-overlay abs-fs'></div><div class='splash-image abs-fs bg-cover'></div></div><div class='color-wrapper gpu-hack abs-fs'></div>");
            var Ya = Ua.find(".preview-image"),
                Za = Ua.find(".video-wrapper"),
                $a = Ua.find(".color-wrapper"),
                _a = Ua.find(".splash-wrapper"),
                ab = _a.find(".splash-image");
            X.autoStart && (Ha = !1, _a.hide()), b.hasClass("animate-colors") && $a.css({ "background-color": X.colors[0] }), Ha && ba.push({ id: "splash-image", src: Ha, loadTimeout: X.fileTimeout }), 0 < X.preloadFiles.length && a.each(X.preloadFiles, function(a, b) { ba.push({ src: b, loadTimeout: X.fileTimeout }) });
            var bb = b.find(".sven-slide");
            if (bb.each(function(b, c) { var d; if ((a(this).data().sceneImage || a(this).data().mobileImage) && (a(this).data().sceneImage && (d = a(this).data().sceneImage), ja && a(this).data().mobileImage && (d = a(this).data().mobileImage), d && ba.push({ id: a(this)[0].id, src: d, loadTimeout: X.fileTimeout })), !ja)
                        if ("html5" == a(this).data().videoType) { d = !a(this).attr("data-mute-video") || parseBool(a(this).attr("data-mute-video")); var e = a(this).data().videoStart ? parseInt(a(this).data().videoStart) : 0,
                                f = a(this).data().videoStop ? parseInt(a(this).data().videoStop) : 0,
                                g = !a(this).attr("data-video-loop") || parseBool(a(this).attr("data-video-loop"));
                            d = { videoURL: a(this).data().sceneVideo, mute: d, startAt: e, stopAt: f, loop: g, sceneIndex: b }, ca.push(d) } else if ("youtube" == a(this).data().videoType) { d = !a(this).attr("data-mute-video") || parseBool(a(this).attr("data-mute-video")); var h = a(this).data().videoQuality ? a(this).data().videoQuality : "highres",
                            e = a(this).data().videoStart ? parseInt(a(this).data().videoStart) : .01,
                            f = a(this).data().videoStop ? parseInt(a(this).data().videoStop) : 0,
                            g = !!a(this).attr("data-video-loop") && parseBool(a(this).attr("data-video-loop"));
                        d = { autoPlay: !1, showYTLogo: !1, stopMovieOnBlur: !1, showControls: !1, opacity: 1, videoURL: a(this).data().sceneVideo, containment: "." + Za[0].className.split(" ")[0], quality: h, mute: d, startAt: e, stopAt: f, loop: g, sceneIndex: b }, da.push(d) } }), !ja && (0 < ca.length || 0 < da.length || "video-bg" === ea)) { if ("video-bg" != ea && sa ? Oa = !0 : Oa || (sa = !1), "video-bg" === ea && "html5" === Na || 0 < ca.length) { var cb, db, eb; "video-bg" === ea && "html5" === Na ? (TweenMax.set(Ya, { autoAlpha: 1 }), cb = d(Sa, b.data().staticVideo, Oa), db = cb.getPlayer(), db.off("ended"), db.currentTime(Qa), db.on("loadeddata", function() { TweenMax.set(eb, { autoAlpha: 1 }), TweenMax.to(Ya, .5, { autoAlpha: 0 }), db.on("timeupdate", function() {
                            (0 != Ra && db.currentTime() >= Ra || 0 == Ra && db.currentTime() >= db.duration()) && (Sa ? (db.loop(!0), db.currentTime(Qa), db.play()) : (Ja = !0, db.pause())) }) })) : (cb = d(ca[0].loop, ca[0].videoURL, ca[0].mute), db = cb.getPlayer(), db.off("ended"), db.currentTime(ca[0].startAt), db.one("loadeddata", function() { Ia = !0 })), eb = Za.find("#big-video-wrap"), eb.append("<div class='bv-overlay abs-fs'></div>") } if ("video-bg" === ea && "youtube" === Na || 0 < da.length) { "video-bg" === ea && "youtube" === Na ? (TweenMax.set(Ya, { autoAlpha: 1 }), Za.append("<div id='bgndVideo' class='player' data-property='{showYTLogo: false, loop: " + Sa + ', stopMovieOnBlur: false, quality: "' + Pa + '",showControls: false, videoURL: "' + b.data().staticVideo + '", containment:".' + Za[0].className.split(" ")[0] + '", autoPlay: false, mute: ' + Oa + ", startAt: " + Qa + ", stopAt: " + Ra + ", opacity: 1}'>My video</div>")) : Za.append("<div id='bgndVideo' class='player' data-property=" + JSON.stringify(da[0]) + ">My video</div>"); var gb, fb = Za.find("#bgndVideo"),
                        hb = fb.YTPlayer();
                    hb.on("YTPReady", function() { gb = Za.find(".mbYTP_wrapper"), Ma = !0 }), hb.on("YTPEnd", function() { "video-bg" === ea ? Ja = !0 : La = !1 }) } }
            if (X.showAnimationSummary) { Ua.append("<div id='summary-handle'><i class='fa fa-info'></i></div><div id='summary-container'><div class='details'><h3 class='animation-name'></h3><p class='scene-info'></p><h3 class='total-duration'></h3></div></div>"); var ib = Ua.find("#summary-handle"),
                    jb = Ua.find("#summary-container .animation-name"),
                    kb = Ua.find("#summary-container .scene-info"),
                    lb = Ua.find("#summary-container .total-duration") }
            var ob, mb = sa,
                nb = "sound-" + ha;
            W.init = function() { return W.start(b, "start", X.autoStart), X.showAnimationSummary && ib.on("click", function(a) { ib.toggleClass("active") }), W }, W.start = function(b, c, d) { ia = b.clone(!0), na += 1, fa[ha] = new TimelineMax({ paused: !0, delay: .2, repeat: 0, onStart: s }), "single-image" === ea && v(fa[ha]), b = b.find(".sven-slide"); var e = b.length;
                b.each(function(b, c) { var d = a(this).data(),
                        f = d.anim;
                    (!d.sceneVideo && d.sceneImage || ja && d.sceneImage) && (d.trans = d.trans ? d.trans : "fade-in-bg"), d.alignment || (d.alignment = "center-center"), d.pursueVideo || (d.pursueVideo = "yes"), d.pursueImage || (d.pursueImage = "no"), ja && d.mobileAlignment && (d.alignment = d.mobileAlignment), d.trans || (d.trans = "none"), ja && d.mobileTrans && (d.trans = d.mobileTrans), d.freezeTime || (d.freezeTime = "default"), d.transDur || (d.transDur = "default"), f || (f = "none"); var g; if (g = "right-top top-right right-bottom bottom-right right-center center-right".split(" "), g = -1 != "left-top top-left left-bottom bottom-left left-center center-left".split(" ").indexOf(d.alignment) ? f + " halign-left" : -1 != g.indexOf(d.alignment) ? f + " halign-right" : f + " halign-center", "none" !== f) { a(this).find(".content-container").wrap("<div class='sven-scene " + g + "'><div class='centered " + d.alignment + "'></div></div>"); var h = a(this).find(".content-container"),
                            i = h.find("h1") } if (b == e - 1 && (d.outDur = "none", ma = a(this).attr("id")), y(a(this), b, d, fa[ha]), "sequenital-fall-lt" === f || "sequential-fall-lt" === f) A(a(this), b, d, h, i, fa[ha], !0);
                    else if ("fall-hide-lt" === f) A(a(this), b, d, h, i, fa[ha], !1);
                    else if ("appear-lt" === f) { var j = a(this),
                            k = h,
                            l = fa[ha],
                            m = N(j, d, k, i, !0, !0),
                            i = m.content0.data().inEase ? U(m.content0.data().inEase) : "",
                            h = m.content0.data().outEase ? U(m.content0.data().outEase) : ""; if (l.set(m.wrapper0, { opacity: 0 }), m.content1) { var n = m.content1.data().inEase ? m.content1.data().inEase : Bounce.easeOut,
                                o = m.content1.data().outEase ? U(m.content1.data().outEase) : "";
                            l.set(m.wrapper1, { overflow: "hidden" }), l.set([m.content1, m.backdrop1], { y: "-104%" }) }
                        l.set(k, { visibility: "visible" }), l.addLabel(m.marker), l = S(!0), l.repeat.to(m.wrapper0, 2.5, { delay: .8, opacity: 1, ease: i }), l.in.add(l.repeat), m.content1 && l.in.to([m.content1, m.backdrop1], .8, { y: "0%", ease: n }), d.inDur && l.in.duration(parseFloat(d.inDur)), "none" != d.outDur && (m.content1 && l.out.to([m.content1, m.backdrop1], .1, { y: "-100%", ease: o }), l.out.add(l.repeat.tweenFromTo(0, l.repeat.duration(), { ease: h }).timeScale(2).reverse()), d.outDur && l.out.duration(parseFloat(d.outDur))), V(j, l, b, d, m.marker, k, !0) } else if ("rotator-fx-1" === f) H(a(this), b, d, h, i, fa[ha]);
                    else if ("rotate-in-reveal-lt" === f) E(a(this), b, d, h, i, fa[ha]);
                    else if ("stripes-reveal-lt" === f) J(a(this), b, d, h, i, fa[ha]);
                    else if ("random-reveal-lt" === f) B(a(this), b, d, h, i, fa[ha]);
                    else if ("rainfall-reveal-lt" === f) C(a(this), b, d, h, i, fa[ha]);
                    else if ("scale-reveal-lt" === f) D(a(this), b, d, h, i, fa[ha]);
                    else if ("particles-reveal-lt" === f) F(a(this), b, d, h, i, fa[ha]);
                    else if ("scale-rotate-lt" === f) { var p, j = a(this),
                            k = h,
                            n = fa[ha],
                            i = N(j, d, k, i, !1, !1),
                            f = i.split0;
                        g = i.content0.data().staggerTime ? parseFloat(i.content0.data().staggerTime) : .05, p = i.content0.data().inPattern ? i.content0.data().inPattern : "sequential", o = i.content0.data().inEase ? U(i.content0.data().inEase) : Back.easeOut, h = i.content0.data().outEase ? U(i.content0.data().outEase) : "", f.chars = T(p, f.chars), p = Math.ceil(parseInt(i.content0.css("line-height"))), i.content1 && (l = i.content1.data().inEase ? i.content1.data().inEase : Bounce.easeOut, m = i.content1.data().outEase ? U(i.content1.data().outEase) : "", n.set(i.wrapper1, { overflow: "hidden" }), n.set([i.content1, i.backdrop1], { y: "-104%" })), n.set(k, { visibility: "visible" }), n.addLabel(i.marker), n = S(!0), n.repeat.staggerFrom(f.chars, .8, { opacity: 0, scale: 0, y: p, rotationX: 180, transformOrigin: "0% 50%", ease: o }, g), n.in.add(n.repeat), i.content1 && n.in.to([i.content1, i.backdrop1], .8, { y: "0%", ease: l }), d.inDur && n.in.duration(parseFloat(d.inDur)), "none" != d.outDur && (i.content1 && n.out.to([i.content1, i.backdrop1], .1, { y: "-100%", ease: m }), n.out.add(n.repeat.tweenFromTo(0, n.repeat.duration(), { ease: h }).timeScale(2).reverse()), d.outDur && n.out.duration(parseFloat(d.outDur))), V(j, n, b, d, i.marker, k, !0) } else if ("random-alpha-reveal-lt" === f) G(a(this), b, d, h, i, fa[ha]);
                    else if ("blur-reveal-lt" === f) I(a(this), b, d, h, i, fa[ha], !1);
                    else if ("blur-alpha-lt" === f) I(a(this), b, d, h, i, fa[ha], !0);
                    else if ("flyin-reveal-lt" === f) { var q, l = a(this),
                            m = h,
                            o = fa[ha],
                            i = N(l, d, m, i, !1, !1); if (g = i.split0, h = g.chars.slice(0), n = g.chars.slice(0), i.content0.hasClass("place-left") ? (f = "-" + Math.ceil(i.wrapper0.offset().left + i.wrapper0.outerWidth()) + "px", p = "sequential", q = "reverse") : (f = Math.ceil(R(i.wrapper0, l) + i.wrapper0.outerWidth()) + "px", p = "reverse", q = "sequential"), o.set(g.chars, { x: f, opacity: 0 }), p = i.content0.data().inPattern ? i.content0.data().inPattern : p, q = i.content0.data().outPattern ? i.content0.data().outPattern : q, g = i.content0.data().inEase ? U(i.content0.data().inEase) : Back.easeOut, f = i.content0.data().outEase ? U(i.content0.data().outEase) : Back.easeIn.config(4), h = T(p, h), n = T(q, n), i.content1) { var r, j = i.content1.data().inEase ? i.content1.data().inEase : Back.easeOut,
                                k = i.content1.data().outEase ? U(i.content1.data().outEase) : "";
                            i.content1.hasClass("place-left") ? (r = i.content1.offset().left, p = "right center", q = "-" + Math.ceil(r + i.content1.outerWidth()) + "px") : i.content1.hasClass("place-right") ? (r = R(i.content1, l), p = "left center", q = Math.ceil(r + i.content1.outerWidth()) + "px") : (r = R(i.backdrop1, l), p = "left center", q = Math.ceil(r + i.backdrop1.outerWidth()) + "px"), r = O(r, i.content1), o.set(i.backdrop1, { x: q, transformOrigin: p, scaleX: r }), o.set(i.content1, { opacity: 0 }) }
                        o.set(m, { visibility: "visible" }), o.addLabel(i.marker), o = S(!0), o.in.staggerTo(h, 1.3, { x: 0, opacity: 1, ease: g }, .15), h = o.in.duration(), i.content1 && (o.repeat.to(i.backdrop1, .5 * h, { scaleX: 1, x: 0, rotation: .01, ease: j }), o.repeat.to(i.content1, .5, { opacity: 1 }), o.in.add(o.repeat, .18 * h)), d.inDur && o.in.duration(parseFloat(d.inDur)), "none" != d.outDur && (o.out.staggerTo(n, 1, { y: "100%", opacity: 0, ease: f }, .08), i.content1 && o.out.add(o.repeat.tweenFromTo(0, o.repeat.duration(), { ease: k }).timeScale(2).reverse(), .5), d.outDur && o.out.duration(parseFloat(d.outDur))), V(l, o, b, d, i.marker, m, !0) } else "dominos-reveal-lt" === f ? K(a(this), b, d, h, i, fa[ha]) : "glitch-one-lt" === f ? L(a(this), b, d, h, i, fa[ha]) : "none" !== f && console.log("The animation you mentioned in " + c.id + " does not exist. Check data-anim spelling for errors") }); var f = b = fa[ha].totalDuration(); if ("default" != X.fullDuration && 0 < X.fullDuration && (f = X.fullDuration, fa[ha].totalDuration(f)), X.showAnimationSummary) { var g = "Teaser Duration: " + f.toFixed(1) + "s";
                    lb.html(g) } if (oa = fa[ha].timeScale(), "single-image" === ea && Ga) { var g = new TimelineMax({ delay: 0 }),
                        h = Ga;
                    b = "auto" === Fa || isNaN(Fa) ? ((b - ya) / b * f).toFixed(1) : Fa, "in" === Ea ? g.fromTo(Wa, b, { scale: 1 }, { scale: h, rotation: .01, transformOrigin: Da }) : "out" === Ea ? g.fromTo(Wa, b, { scale: h }, { scale: 1, rotation: .01, transformOrigin: Da }) : (g.fromTo(Wa, b / 2, { scale: 1 }, { scale: h, rotation: .01, transformOrigin: Da }), g.to(Wa, b / 2, { scale: 1, rotation: .01, transformOrigin: Da })), za.add(g, "imageZoomer") }
                fa[ha].set({}, { immediateRender: !1, onComplete: t }), d ? (Y = "playing", W.play(c)) : (Y = "paused", W.seek(c)) }, W.play = function(a) { "start" === a ? fa[ha].play() : fa[ha].play(a), b.trigger("STPlay") }, W.seek = function(a) { fa[ha].seek(a), b.trigger("STPause") }, W.restart = function() { fa[ha].restart() }, W.pause = function() { fa[ha].pause(), b.trigger("STPause") }, W.continueTeaser = function() { fa[ha].paused() && "playing" == Y ? (fa[ha].resume(), b.trigger("STPlay"), "video-bg" !== ea || Ja || n(), p(), "undefined" == typeof ob || "paused" === wa || _ || k()) : 1 <= fa[ha].progress() && $ && ($ = !1, "video-bg" !== ea || Ja || n(), p(), "paused" === wa || _ || "undefined" == typeof ob || (ob.paused = !1, b.trigger("STUnMuted"))) }, W.freezeTeaser = function() { fa[ha].paused() || "playing" != Y || 1 <= fa[ha].progress() ? 1 <= fa[ha].progress() && ($ = !0, "video-bg" !== ea || Ja || m(), o(), "undefined" == typeof ob || _ || (ob.paused = !0, b.trigger("STMuted"))) : (fa[ha].pause(), "video-bg" !== ea || Ja || m(), o(), b.trigger("STPause"), "undefined" == typeof ob || _ || (ob.paused = !0, b.trigger("STMuted"))) }, a.fn.svenPlugin.skipToLast = function() { return fa[ha].currentLabel() != ma && (fa[ha].seek(ma, !1).play(), "undefined" != typeof ob && ("paused" == wa || _ || k()), !0) }, a.fn.svenPlugin.togglePlay = function() { fa[ha].paused() ? (fa[ha].resume(), b.trigger("STPlay"), "video-bg" !== ea || Ja || n(), p(), "undefined" != typeof ob && "paused" !== wa && k(), Y = "playing") : 1 <= fa[ha].progress() ? ("video-bg" != ea && z(), _ = La = Ka = Ja = !1, fa[ha].restart(), b.trigger("STPlay"), Y = "playing") : (fa[ha].pause(), "video-bg" !== ea || Ja || m(), o(), b.trigger("STPause"), "undefined" != typeof ob && (ob.paused = !0, b.trigger("STMuted")), Y = "paused") }, a.fn.svenPlugin.toggleSound = function() { sa ? ob.paused ? (k(), wa = "playing") : "playFinished" != ob.playState && (ob.paused = !0, b.trigger("STMuted"), wa = "paused") : "video-bg" !== ea || Oa || ("html5" === Na ? db.muted() ? (b.trigger("STUnMuted"), db.muted(!1)) : (b.trigger("STMuted"), db.muted(!0)) : hb.isMute ? (b.trigger("STUnMuted"), fb.YTPUnmute(), hb.isMute = !1) : (b.trigger("STMuted"), fb.YTPMute(), hb.isMute = !0)) }, a.fn.svenPlugin.changeSpeed = function(a) { X.videoPlaybackChange && (cb && db.playbackRate(a), fb && fb.YTPGetPlayer().setPlaybackRate(a)), a *= oa, fa[ha].timeScale(a) }, Aa || sa || 0 < ba.length ? a(window).load(function() { "xhr" === X.preloadMethod ? (aa = new createjs.LoadQueue, aa.installPlugin(createjs.Sound)) : (aa = new createjs.LoadQueue(!1), aa.installPlugin(createjs.Sound), createjs.Sound.registerPlugins([createjs.HTMLAudioPlugin])), aa.setMaxConnections(500), createjs.Sound.alternateExtensions = ["ogg"], aa.on("progress", e), aa.on("fileload", f), aa.on("complete", i), aa.on("error", h), aa.on("fileerror", g), sa && aa.loadFile({ id: nb, src: mb, loadTimeout: X.audioTimeout }), 0 < ba.length && aa.loadManifest(ba) }) : a(window).load(function() {!Ma && ("video-bg" === ea && "youtube" === Na || !ja && 0 < da.length) ? hb.on("YTPReady", function() { 0 === na && (gb = Za.find(".mbYTP_wrapper"), j(ea)) }) : j() }), a(window).on("debouncedresize", function(c) { if (0 < na) { if (!ja || a(window).width() != la) { la = a(window).width(), c = !fa[ha].paused(); var d = fa[ha].time();
                        fa[ha].kill(), b.remove(), b = ia, Ua.prepend(b), b.find(".sven-slide").each(function(b, c) { if ((ja || !a(this).data().sceneVideo) && (a(this).data().sceneImage || a(this).data().mobileImage && ja)) { var e, d = Va.find("." + a(this)[0].id + " img");
                                e = ja ? a(this).data().mobileImagePos ? a(this).data().mobileImagePos : "center center" : a(this).data().sceneImagePos ? a(this).data().sceneImagePos : "center center", e = e.split(" "), imgCoverEffect(d[0], { alignX: e[0], alignY: e[1], watchResize: !1 }) } }), "single-image" === ea && imgCoverEffect(Wa[0], { alignX: Ca[0], alignY: Ca[1], watchResize: !1 }), W.start(b, d, c) } } else console.log("TEASER NOT YET INITIALIZED") })
        }, a.fn.svenPlugin = function(b) { var c = this; return this.each(function() { if (void 0 == a(this).data("svenPlugin")) { var d = new a.svenPlugin(c, b);
                    a(this).data("svenPlugin", d) } }) }
    }(jQuery);