...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'entry-tpl-overlay-stretched-nosidebar' ); ?> itemscope="" itemtype="<?php echo esc_attr( bimber_get_entry_microdata_itemtype() ); ?>">
	<?php
						...
						<div class="g1-column">
							<header class="entry-header">
								<div class="entry-before-title">
									...
									<?php bimber_render_entry_flags( array( 'show_collections' => false, 'show_reactions' => true ) ); ?>
								</div>
