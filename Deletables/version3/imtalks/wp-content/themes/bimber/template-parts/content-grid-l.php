...
<article <?php post_class( 'entry-tpl-grid entry-tpl-grid-l' ); ?>>
	<?php
	...
	<div class="entry-body">
		<header class="entry-header">
			...
			<?php the_title( sprintf( '<h3 class="g1-beta g1-beta-1st entry-title"><a href="%s" rel="bookmark">', esc_url( get_permalink() ) ), '</a></h3>' ); ?>
		</header>
