...
class G1_Socials_YouTube_Widget extends WP_widget {
	...
	public function widget( $args, $instance ) {
		...
		g1_socials_get_youtube( $channel_id );
		?>
			<p class="youtube-channel">
				<a href="<?php echo ( esc_url( 'https://www.youtube.com/channel/' . $channel_id ) ); ?>" rel="me" class="g1-gamma g1-gamma-1st youtube-channel" target="_blank"><?php echo wp_kses_post( $channel_name ); ?></a></p>
			<p class="youtube-link"><a href="<?php echo ( esc_url( 'https://www.youtube.com/channel/' . $channel_id ) ); ?>" rel="me" class="g1-button g1-button-s g1-button-simple" target="_blank"><?php esc_html_e( 'Subscribe', 'g1_socials' ); ?></a>
			</p>
		<?php
