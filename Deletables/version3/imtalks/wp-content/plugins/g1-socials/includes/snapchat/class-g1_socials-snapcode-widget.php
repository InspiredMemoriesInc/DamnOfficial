...
class G1_Socials_Snapcode_Widget extends WP_widget {
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo  esc_attr( $this->get_field_id( 'userid' ) ); ?>"><?php esc_html_e( 'ID:', 'g1_socials' ); ?></label>
	...
	public function widget( $args, $instance ) {
		...
		// Get snapcode.
		$user_snapcode = g1_socials_get_snapcode( $username, $userid, $useravatar );
		if ( ! $user_snapcode ) {
			return;
		}
		...
		echo( wp_kses_post( $user_snapcode ) );
