...
(function ($, ctx) {
    ...
    c.validateForm = function() {
        ...
        $form.on('submit', function(e) {
            ...
            if (ctx.config.featured_media_required && $(selectors.featuredImage).length > 0) {
                    var $featuredImage = $(selectors.postThumbnail);
                    var valid;

                    valid = $featuredImage.length > 0;

                    if (!valid) {
                        var errorMessage = 'Please upload the featured image';
...
(function ($, ctx) {
    ...
    var useFrontendImageUploader = function(callbacks) {
        ...
        $('.snax-quiz-upload .snax-plupload-browse-button').trigger('click');
    };
...
(function ($, ctx) {
        ...
        var useFrontendImageUploader = function(callbacks) {
            ...
            $('.snax-poll-upload .snax-plupload-browse-button').trigger('click');
        };
