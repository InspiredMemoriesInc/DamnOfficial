		...
		public function enqueue_scripts() {
			...
			$front_config = array(
				...
				'i18n' => array(
					...
					'duplicate_comment'	=> __( 'Duplicate comment detected; it looks as though you&#8217;ve already said that!' ),
					'comment_fail'		=> __( 'Comment Submission Failure' ),
					'see_all_replies'	=> __( 'See all replies' ),
				),
			);
